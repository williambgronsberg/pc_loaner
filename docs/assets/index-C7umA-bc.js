...
</svg>`};return(t,r)=>(fe(),ge("span",{class:"sf-icon",style:_i({width:(n.size??20)+"px",height:(n.size??20)+"px"}),innerHTML:e[n.name]},null,12,nR))}}),El=wu(rR,[["__scopeId","data-v-8bfe09d2"]]),sR={class:"admin-split"},iR={class:"sidebar"},oR={class:"sidebar-nav"},aR=["onClick"],lR={class:"sidebar-item-icon"},cR={class:"sidebar-item-label"},uR={class:"sidebar-footer"},hR={class:"sidebar-footer-text"},dR={class:"admin-content"},fR={key:0,class:"empty-state"},pR={key:1,class:"borrows-list"},gR={class:"borrow-card-info"},mR={key:0,class:"borrow-card-time"},_R={class:"borrow-card-time"},yR=["onClick"],vR={key:0,class:"empty-state"},ER={key:1,class:"borrows-list"},wR={class:"borrow-card-info"},TR={key:0,class:"borrow-card-time"},IR={class:"borrow-card-time"},AR={key:0},bR={class:"workstations-manage-list"},RR={class:"ws-name"},SR={class:"ws-status"},PR=["onClick"],CR={key:0,class:"empty-state"},kR={class:"form-group"},VR={class:"form-group"},DR={style:{display:"flex",gap:"8px"}},NR={class:"form-group"},OR={for:"new-keyboard"},xR=["placeholder"],MR={key:0,class:"form-group"},LR=vi({__name:"AdminView",setup(n){const e=At("currentView"),t=At("showToast"),r=At("loading"),{currentUser:s,logout:i}=Vm(),{workstations:a,activeBorrows:l,subscribeWorkstations:c,subscribeActiveBorrows:h,returnWorkstation:f,getHistory:g,seedDefaultWorkstations:_,addWorkstation:T,removeWorkstation:P}=km(),C=Me("borrows"),k=[{key:"borrows",label:"Utlån",icon:"📋"},{key:"history",label:"Historikk",icon:"🕐"},{key:"manage",label:"Enheter",icon:"⚙️"}],q=Lr(()=>{var Z;return((Z=s.value)==null?void 0:Z.email)??""}),B=Me([]),H=Me(null),O=Me(""),Q=Me("pc"),ce=Me(""),w=Me("");async function m(){await i(),e.value="student"}async function y(Z){if(confirm(`Returner ${Z}?`)){r.value=!0;try{await f(Z),t(`${Z} er returnert`,"success")}catch(j){console.error(j),t("Kunne ikke returnere","error")}finally{r.value=!1}}}async function I(Z=!1){r.value=!0;try{const j=await g(20,Z?H.value:null);H.value=j.lastVisible,Z?B.value.push(...j.records):B.value=j.records}catch(j){console.error(j),t("Kunne ikke laste historikk","error")}finally{r.value=!1}}async function b(){if(confirm("Sett inn standardenheter (PC 1, PC 2, PC 3)?")){r.value=!0;try{await _(),t("Standardenheter er lagt til","success")}catch(Z){console.error(Z),t("Kunne ikke sette inn enheter","error")}finally{r.value=!1}}}async function R(){if(O.value.trim()){r.value=!0;try{await T(O.value.trim(),Q.value,ce.value.trim(),w.value.trim()),t(`${O.value} er lagt til`,"success"),O.value="",ce.value="",w.value=""}catch(Z){console.error(Z),t("Kunne ikke legge til enheten","error")}finally{r.value=!1}}}async function E(Z){if(confirm(`Fjern ${Z}?`)){r.value=!0;try{await P(Z),t(`${Z} er fjernet`,"success")}catch(j){console.error(j),t("Kunne ikke fjerne enheten","error")}finally{r.value=!1}}}function qe(Z){C.value=Z,Z==="history"&&(B.value=[],H.value=null,I())}function Bt(Z){if(!Z)return"—";const j=Z.toDate?Z.toDate():new Date(Z);return`${String(j.getDate()).padStart(2,"0")}.${String(j.getMonth()+1).padStart(2,"0")} ${String(j.getHours()).padStart(2,"0")}:${String(j.getMinutes()).padStart(2,"0")}`}function Ue(Z){if(!Z)return"—";const j=Z.toDate?Z.toDate():new Date(Z);return`${String(j.getDate()).padStart(2,"0")}.${String(j.getMonth()+1).padStart(2,"0")}.${j.getFullYear()} ${String(j.getHours()).padStart(2,"0")}:${String(j.getMinutes()).padStart(2,"0")}`}return yc(()=>{c(),h()}),(Z,j)=>(fe(),ge("div",sR,[$("aside",iR,[$("div",{class:"sidebar-top"},[j[7]||(j[7]=$("div",{class:"sidebar-title"},"Admin",-1)),$("button",{class:"sidebar-close",onClick:m},[...j[6]||(j[6]=[$("span",{class:"sidebar-close-icon"},"←",-1),Vr(" Logg ut ",-1)])])]),$("nav",oR,[(fe(),ge(Xe,null,ur(k,ne=>$("button",{key:ne.key,class:gt(["sidebar-item",{active:C.value===ne.key}]),onClick:$t=>qe(ne.key)},[$("span",lR,Se(ne.icon),1),$("span",cR,Se(ne.label),1)],10,aR)),64))]),$("div",uR,[$("div",hR,Se(q.value),1)])]),$("main",dR,[hn($("section",null,[j[8]||(j[8]=$("h2",{class:"section-title"},"Utlånt utstyr",-1)),Mr(l).length===0?(fe(),ge("div",fR,"Ingen utlånt utstyr")):(fe(),ge("div",pR,[(fe(!0),ge(Xe,null,ur(Mr(l),ne=>(fe(),ge("div",{key:ne.id,class:"borrow-card"},[$("div",gR,[$("h4",null,Se(ne.workstation),1),$("p",null,"Lånt av: "+Se(ne.borrower),1),ne.controllers?(fe(),ge("div",mR,"🎮 "+Se(ne.controllers)+" kontrollere",1)):mt("",!0),$("div",_R,Se(Bt(ne.borrowedAt)),1)]),$("button",{class:"btn btn-danger btn-sm",onClick:$t=>y(ne.workstation)},"Returner",8,yR)]))),128))]))],512),[[Za,C.value==="borrows"]]),hn($("section",null,[j[9]||(j[9]=$("h2",{class:"section-title"},"Historikk",-1)),B.value.length===0?(fe(),ge("div",vR,"Ingen historikk")):(fe(),ge("div",ER,[(fe(!0),ge(Xe,null,ur(B.value,ne=>(fe(),ge("div",{key:ne.id,class:"borrow-card"},[$("div",wR,[$("h4",null,Se(ne.workstation),1),$("p",null,"Lånt av: "+Se(ne.borrower),1),ne.controllers?(fe(),ge("div",TR,"🎮 "+Se(ne.controllers)+" kontrollere",1)):mt("",!0),$("div",IR,[Vr(" Lånt: "+Se(Ue(ne.borrowedAt))+" ",1),ne.returnedAt?(fe(),ge("span",AR," | Returnert: "+Se(Ue(ne.returnedAt)),1)):mt("",!0)])]),$("span",{style:_i([{"font-size":"0.8125rem","font-weight":"600"},{color:ne.returnedAt?"var(--accent-success)":"var(--accent-error)"}])},Se(ne.returnedAt?"Returnert":"Aktiv"),5)]))),128)),B.value.length>=20?(fe(),ge("button",{key:0,class:"btn btn-secondary btn-full",onClick:j[0]||(j[0]=ne=>I(!0))},"Last flere")):mt("",!0)]))],512),[[Za,C.value==="history"]]),hn($("section",null,[j[17]||(j[17]=$("h2",{class:"section-title"},"Administrer enheter",-1)),$("div",bR,[(fe(!0),ge(Xe,null,ur(Mr(a),ne=>(fe(),ge("div",{key:ne.id,class:"ws-manage-item"},[$("div",null,[$("div",RR,[Vt(El,{name:ne.type==="playstation"?"gamecontroller":"desktopcomputer",size:16},null,8,["name"]),Vr(" "+Se(ne.name),1)]),$("div",SR,Se(ne.status==="available"?"Ledig":"Utlånt"),1)]),ne.status==="available"?(fe(),ge("button",{key:0,class:"btn-text",onClick:$t=>E(ne.name)},"Fjern",8,PR)):mt("",!0)]))),128)),Mr(a).length===0?(fe(),ge("div",CR,"Ingen enheter")):mt("",!0)]),$("button",{class:"btn btn-secondary btn-full",style:{"margin-bottom":"16px"},onClick:b}," Sett inn standardenheter (PS 1-2 + PC 1-3) "),$("form",{class:"add-form",onSubmit:Tc(R,["prevent"])},[j[15]||(j[15]=$("h3",null,"Legg til ny enhet",-1)),$("div",kR,[j[10]||(j[10]=$("label",{for:"new-name"},"Navn",-1)),hn($("input",{id:"new-name","onUpdate:modelValue":j[1]||(j[1]=ne=>O.value=ne),class:"input",placeholder:"F.eks. PC 4",required:""},null,512),[[qr,O.value]])]),$("div",VR,[j[13]||(j[13]=$("label",null,"Type",-1)),$("div",DR,[$("button",{type:"button",class:gt(["btn",Q.value==="pc"?"btn-primary":"btn-secondary"]),style:{flex:"1",gap:"6px"},onClick:j[2]||(j[2]=ne=>Q.value="pc")},[Vt(El,{name:"desktopcomputer",size:16}),j[11]||(j[11]=Vr(" PC",-1))],2),$("button",{type:"button",class:gt(["btn",Q.value==="playstation"?"btn-primary":"btn-secondary"]),style:{flex:"1",gap:"6px"},onClick:j[3]||(j[3]=ne=>Q.value="playstation")},[Vt(El,{name:"gamecontroller",size:16}),j[12]||(j[12]=Vr(" PlayStation",-1))],2)])]),$("div",NR,[$("label",OR,Se(Q.value==="playstation"?"Tilbehør":"Tastatur"),1),hn($("input",{id:"new-keyboard","onUpdate:modelValue":j[4]||(j[4]=ne=>ce.value=ne),class:"input",placeholder:Q.value==="playstation"?"F.eks. Kontroller x2, ladestasjon":"F.eks. Tastatur 4"},null,8,xR),[[qr,ce.value]])]),Q.value==="pc"?(fe(),ge("div",MR,[j[14]||(j[14]=$("label",{for:"new-mouse"},"Mus",-1)),hn($("input",{id:"new-mouse","onUpdate:modelValue":j[5]||(j[5]=ne=>w.value=ne),class:"input",placeholder:"F.eks. Mus 4"},null,512),[[qr,w.value]])])):mt("",!0),j[16]||(j[16]=$("button",{type:"submit",class:"btn btn-primary"},"Legg til",-1))],32)],512),[[Za,C.value==="manage"]])])]))}}),FR=wu(LR,[["__scopeId","data-v-4e3788de"]]),UR={id:"toast-container"},BR={key:0,id:"loading-overlay"},$R=vi({__name:"App",setup(n){const e=Me("student"),t=Me([]);let r=0;function s(a,l="info"){const c=++r;t.value.push({id:c,message:a,type:l}),setTimeout(()=>{const h=t.value.findIndex(f=>f.id===c);h!==-1&&t.value.splice(h,1)},3e3)}lo("showToast",s),lo("currentView",e);const i=Me(!1);return lo("loading",i),(a,l)=>(fe(),ge(Xe,null,[$("div",UR,[(fe(!0),ge(Xe,null,ur(t.value,c=>(fe(),ge("div",{key:c.id,class:gt(["toast",c.type])},Se(c.message),3))),128))]),i.value?(fe(),ge("div",BR,[...l[0]||(l[0]=[$("div",{class:"skeleton-box"},null,-1),$("p",null,"Laster...",-1)])])):mt("",!0),e.value==="student"?(fe(),Qs(K0,{key:1})):e.value==="login"?(fe(),Qs(tR,{key:2})):e.value==="admin"?(fe(),Qs(FR,{key:3})):mt("",!0)],64))}});Iv($R).mount("#app");
