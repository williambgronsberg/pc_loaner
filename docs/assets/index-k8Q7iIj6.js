...
*/var Ir,Op;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(w,g){function _(){}_.prototype=g.prototype,w.D=g.prototype,w.prototype=new _,w.prototype.constructor=w,w.C=function(T,A,R){for(var E=Array(arguments.length-2),$e=2;$e<arguments.length;$e++)E[$e-2]=arguments[$e];return g.prototype[A].apply(T,E)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,n),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function s(w,g,_){_||(_=0);var T=Array(16);if(typeof g=="string")for(var A=0;16>A;++A)T[A]=g.charCodeAt(_++)|g.charCodeAt(_++)<<8|g.charCodeAt(_++)<<16|g.charCodeAt(_++)<<24;else for(A=0;16>A;++A)T[A]=g[_++]|g[_++]<<8|g[_++]<<16|g[_++]<<24;g=w.g[0],_=w.g[1],A=w.g[2];var R=w.g[3],E=g+(R^_&(A^R))+T[0]+3614090360&4294967295;g=_+(E<<7&4294967295|E>>>25),E=R+(A^g&(_^A))+T[1]+3905402710&4294967295,R=g+(E<<12&4294967295|E>>>20),E=A+(_^R&(g^_))+T[2]+606105819&4294967295,A=R+(E<<17&4294967295|E>>>15),E=_+(g^A&(R^g))+T[3]+3250441966&4294967295,_=A+(E<<22&4294967295|E>>>10),E=g+(R^_&(A^R))+T[4]+4118548399&4294967295,g=_+(E<<7&4294967295|E>>>25),E=R+(A^g&(_^A))+T[5]+1200080426&4294967295,R=g+(E<<12&4294967295|E>>>20),E=A+(_^R&(g^_))+T[6]+2821735955&4294967295,A=R+(E<<17&4294967295|E>>>15),E=_+(g^A&(R^g))+T[7]+4249261313&4294967295,_=A+(E<<22&4294967295|E>>>10),E=g+(R^_&(A^R))+T[8]+1770035416&4294967295,g=_+(E<<7&4294967295|E>>>25),E=R+(A^g&(_^A))+T[9]+2336552879&4294967295,R=g+(E<<12&4294967295|E>>>20),E=A+(_^R&(g^_))+T[10]+4294925233&4294967295,A=R+(E<<17&4294967295|E>>>15),E=_+(g^A&(R^g))+T[11]+2304563134&4294967295,_=A+(E<<22&4294967295|E>>>10),E=g+(R^_&(A^R))+T[12]+1804603682&4294967295,g=_+(E<<7&4294967295|E>>>25),E=R+(A^g&(_^A))+T[13]+4254626195&4294967295,R=g+(E<<12&4294967295|E>>>20),E=A+(_^R&(g^_))+T[14]+2792965006&4294967295,A=R+(E<<17&4294967295|E>>>15),E=_+(g^A&(R^g))+T[15]+1236535329&4294967295,_=A+(E<<22&4294967295|E>>>10),E=g+(A^R&(_^A))+T[1]+4129170786&4294967295,g=_+(E<<5&4294967295|E>>>27),E=R+(_^A&(g^_))+T[6]+3225465664&4294967295,R=g+(E<<9&4294967295|E>>>23),E=A+(g^_&(R^g))+T[11]+643717713&4294967295,A=R+(E<<14&4294967295|E>>>18),E=_+(R^g&(A^R))+T[0]+3921069994&4294967295,_=A+(E<<20&4294967295|E>>>12),E=g+(A^R&(_^A))+T[5]+3593408605&4294967295,g=_+(E<<5&4294967295|E>>>27),E=R+(_^A&(g^_))+T[10]+38016083&4294967295,R=g+(E<<9&4294967295|E>>>23),E=A+(g^_&(R^g))+T[15]+3634488961&4294967295,A=R+(E<<14&4294967295|E>>>18),E=_+(R^g&(A^R))+T[4]+3889429448&4294967295,_=A+(E<<20&4294967295|E>>>12),E=g+(A^R&(_^A))+T[9]+568446438&4294967295,g=_+(E<<5&4294967295|E>>>27),E=R+(_^A&(g^_))+T[14]+3275163606&4294967295,R=g+(E<<9&4294967295|E>>>23),E=A+(g^_&(R^g))+T[3]+4107603335&4294967295,A=R+(E<<14&4294967295|E>>>18),E=_+(R^g&(A^R))+T[8]+1163531501&4294967295,_=A+(E<<20&4294967295|E>>>12),E=g+(A^R&(_^A))+T[13]+2850285829&4294967295,g=_+(E<<5&4294967295|E>>>27),E=R+(_^A&(g^_))+T[2]+4243563512&4294967295,R=g+(E<<9&4294967295|E>>>23),E=A+(g^_&(R^g))+T[7]+1735328473&4294967295,A=R+(E<<14&4294967295|E>>>18),E=_+(R^g&(A^R))+T[12]+2368359562&4294967295,_=A+(E<<20&4294967295|E>>>12),E=g+(_^A^R)+T[5]+4294588738&4294967295,g=_+(E<<4&4294967295|E>>>28),E=R+(g^_^A)+T[8]+2272392833&4294967295,R=g+(E<<11&4294967295|E>>>21),E=A+(R^g^_)+T[11]+1839030562&4294967295,A=R+(E<<16&4294967295|E>>>16),E=_+(A^R^g)+T[14]+4259657740&4294967295,_=A+(E<<23&4294967295|E>>>9),E=g+(_^A^R)+T[1]+2763975236&4294967295,g=_+(E<<4&4294967295|E>>>28),E=R+(g^_^A)+T[4]+1272893353&4294967295,R=g+(E<<11&4294967295|E>>>21),E=A+(R^g^_)+T[7]+4139469664&4294967295,A=R+(E<<16&4294967295|E>>>16),E=_+(A^R^g)+T[10]+3200236656&4294967295,_=A+(E<<23&4294967295|E>>>9),E=g+(_^A^R)+T[13]+681279174&4294967295,g=_+(E<<4&4294967295|E>>>28),E=R+(g^_^A)+T[0]+3936430074&4294967295,R=g+(E<<11&4294967295|E>>>21),E=A+(R^g^_)+T[3]+3572445317&4294967295,A=R+(E<<16&4294967295|E>>>16),E=_+(A^R^g)+T[6]+76029189&4294967295,_=A+(E<<23&4294967295|E>>>9),E=g+(_^A^R)+T[9]+3654602809&4294967295,g=_+(E<<4&4294967295|E>>>28),E=R+(g^_^A)+T[12]+3873151461&4294967295,R=g+(E<<11&4294967295|E>>>21),E=A+(R^g^_)+T[15]+530742520&4294967295,A=R+(E<<16&4294967295|E>>>16),E=_+(A^R^g)+T[2]+3299628645&4294967295,_=A+(E<<23&4294967295|E>>>9),E=g+(A^(_|~R))+T[0]+4096336452&4294967295,g=_+(E<<6&4294967295|E>>>26),E=R+(_^(g|~A))+T[7]+1126891415&4294967295,R=g+(E<<10&4294967295|E>>>22),E=A+(g^(R|~_))+T[14]+2878612391&4294967295,A=R+(E<<15&4294967295|E>>>17),E=_+(R^(A|~g))+T[5]+4237533241&4294967295,_=A+(E<<21&4294967295|E>>>11),E=g+(A^(_|~R))+T[12]+1700485571&4294967295,g=_+(E<<6&4294967295|E>>>26),E=R+(_^(g|~A))+T[3]+2399980690&4294967295,R=g+(E<<10&4294967295|E>>>22),E=A+(g^(R|~_))+T[10]+4293915773&4294967295,A=R+(E<<15&4294967295|E>>>17),E=_+(R^(A|~g))+T[1]+2240044497&4294967295,_=A+(E<<21&4294967295|E>>>11),E=g+(A^(_|~R))+T[8]+1873313359&4294967295,g=_+(E<<6&4294967295|E>>>26),E=R+(_^(g|~A))+T[15]+4264355552&4294967295,R=g+(E<<10&4294967295|E>>>22),E=A+(g^(R|~_))+T[6]+2734768916&4294967295,A=R+(E<<15&4294967295|E>>>17),E=_+(R^(A|~g))+T[13]+1309151649&4294967295,_=A+(E<<21&4294967295|E>>>11),E=g+(A^(_|~R))+T[4]+4149444226&4294967295,g=_+(E<<6&4294967295|E>>>26),E=R+(_^(g|~A))+T[11]+3174756917&4294967295,R=g+(E<<10&4294967295|E>>>22),E=A+(g^(R|~_))+T[2]+718787259&4294967295,A=R+(E<<15&4294967295|E>>>17),E=_+(R^(A|~g))+T[9]+3951481745&4294967295,w.g[0]=w.g[0]+g&4294967295,w.g[1]=w.g[1]+(A+(E<<21&4294967295|E>>>11))&4294967295,w.g[2]=w.g[2]+A&4294967295,w.g[3]=w.g[3]+R&4294967295}r.prototype.u=function(w,g){g===void 0&&(g=w.length);for(var _=g-this.blockSize,T=this.B,A=this.h,R=0;R<g;){if(A==0)for(;R<=_;)s(this,w,R),R+=this.blockSize;if(typeof w=="string"){for(;R<g;)if(T[A++]=w.charCodeAt(R++),A==this.blockSize){s(this,T),A=0;break}}else for(;R<g;)if(T[A++]=w[R++],A==this.blockSize){s(this,T),A=0;break}}this.h=A,this.o+=g},r.prototype.v=function(){var w=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);w[0]=128;for(var g=1;g<w.length-8;++g)w[g]=0;var _=8*this.o;for(g=w.length-8;g<w.length;++g)w[g]=_&255,_/=256;for(this.u(w),w=Array(16),g=_=0;4>g;++g)for(var T=0;32>T;T+=8)w[_++]=this.g[g]>>>T&255;return w};function i(w,g){var _=l;return Object.prototype.hasOwnProperty.call(_,w)?_[w]:_[w]=g(w)}function a(w,g){this.h=g;for(var _=[],T=!0,A=w.length-1;0<=A;A--){var R=w[A]|0;T&&R==g||(_[A]=R,T=!1)}this.g=_}var l={};function c(w){return-128<=w&&128>w?i(w,function(g){return new a([g|0],0>g?-1:0)}):new a([w|0],0>w?-1:0)}function h(w){if(isNaN(w)||!isFinite(w))return m;if(0>w)return S(h(-w));for(var g=[],_=1,T=0;w>=_;T++)g[T]=w/_|0,_*=4294967296;return new a(g,0)}function f(w,g){if(w.length==0)throw Error("number format error: empty string");if(g=g||10,2>g||36<g)throw Error("radix out of range: "+g);if(w.charAt(0)=="-")return S(f(w.substring(1),g));if(0<=w.indexOf("-"))throw Error('number format error: interior "-" character');for(var _=h(Math.pow(g,8)),T=m,A=0;A<w.length;A+=8){var R=Math.min(8,w.length-A),E=parseInt(w.substring(A,A+R),g);8>R?(R=h(Math.pow(g,R)),T=T.j(R).add(h(E))):(T=T.j(_),T=T.add(h(E)))}return T}var m=c(0),y=c(1),I=c(16777216);t=a.prototype,t.m=function(){if(P(this))return-S(this).m();for(var w=0,g=1,_=0;_<this.g.length;_++){var T=this.i(_);w+=(0<=T?T:4294967296+T)*g,g*=4294967296}return w},t.toString=function(w){if(w=w||10,2>w||36<w)throw Error("radix out of range: "+w);if(k(this))return"0";if(P(this))return"-"+S(this).toString(w);for(var g=h(Math.pow(w,6)),_=this,T="";;){var A=B(_,g).g;_=x(_,A.j(g));var R=((0<_.g.length?_.g[0]:_.h)>>>0).toString(w);if(_=A,k(_))return R+T;for(;6>R.length;)R="0"+R;T=R+T}},t.i=function(w){return 0>w?0:w<this.g.length?this.g[w]:this.h};function k(w){if(w.h!=0)return!1;for(var g=0;g<w.g.length;g++)if(w.g[g]!=0)return!1;return!0}function P(w){return w.h==-1}t.l=function(w){return w=x(this,w),P(w)?-1:k(w)?0:1};function S(w){for(var g=w.g.length,_=[],T=0;T<g;T++)_[T]=~w.g[T];return new a(_,~w.h).add(y)}t.abs=function(){return P(this)?S(this):this},t.add=function(w){for(var g=Math.max(this.g.length,w.g.length),_=[],T=0,A=0;A<=g;A++){var R=T+(this.i(A)&65535)+(w.i(A)&65535),E=(R>>>16)+(this.i(A)>>>16)+(w.i(A)>>>16);T=E>>>16,R&=65535,E&=65535,_[A]=E<<16|R}return new a(_,_[_.length-1]&-2147483648?-1:0)};function x(w,g){return w.add(S(g))}t.j=function(w){if(k(this)||k(w))return m;if(P(this))return P(w)?S(this).j(S(w)):S(S(this).j(w));if(P(w))return S(this.j(S(w)));if(0>this.l(I)&&0>w.l(I))return h(this.m()*w.m());for(var g=this.g.length+w.g.length,_=[],T=0;T<2*g;T++)_[T]=0;for(T=0;T<this.g.length;T++)for(var A=0;A<w.g.length;A++){var R=this.i(T)>>>16,E=this.i(T)&65535,$e=w.i(A)>>>16,ke=w.i(A)&65535;_[2*T+2*A]+=E*ke,M(_,2*T+2*A),_[2*T+2*A+1]+=R*ke,M(_,2*T+2*A+1),_[2*T+2*A+1]+=E*$e,M(_,2*T+2*A+1),_[2*T+2*A+2]+=R*$e,M(_,2*T+2*A+2)}for(T=0;T<g;T++)_[T]=_[2*T+1]<<16|_[2*T];for(T=g;T<2*g;T++)_[T]=0;return new a(_,0)};function M(w,g){for(;(w[g]&65535)!=w[g];)w[g+1]+=w[g]>>>16,w[g]&=65535,g++}function q(w,g){this.g=w,this.h=g}function B(w,g){if(k(g))throw Error("division by zero");if(k(w))return new q(m,m);if(P(w))return g=B(S(w),g),new q(S(g.g),S(g.h));if(P(g))return g=B(w,S(g)),new q(S(g.g),g.h);if(30<w.g.length){if(P(w)||P(g))throw Error("slowDivide_ only works with positive integers.");for(var _=y,T=g;0>=T.l(w);)_=ie(_),T=ie(T);var A=oe(_,1),R=oe(T,1);for(T=oe(T,2),_=oe(_,2);!k(T);){var E=R.add(T);0>=E.l(w)&&(A=A.add(_),R=E),T=oe(T,1),_=oe(_,1)}return g=x(w,A.j(g)),new q(A,g)}for(A=m;0<=w.l(g);){for(_=Math.max(1,Math.floor(w.m()/g.m())),T=Math.ceil(Math.log(_)/Math.LN2),T=48>=T?1:Math.pow(2,T-48),R=h(_),E=R.j(g);P(E)||0<E.l(w);)_-=T,R=h(_),E=R.j(g);k(R)&&(R=y),A=A.add(R),w=x(w,E)}return new q(A,w)}t.A=function(w){return B(this,w).h},t.and=function(w){for(var g=Math.max(this.g.length,w.g.length),_=[],T=0;T<g;T++)_[T]=this.i(T)&w.i(T);return new a(_,this.h&w.h)},t.or=function(w){for(var g=Math.max(this.g.length,w.g.length),_=[],T=0;T<g;T++)_[T]=this.i(T)|w.i(T);return new a(_,this.h|w.h)},t.xor=function(w){for(var g=Math.max(this.g.length,w.g.length),_=[],T=0;T<g;T++)_[T]=this.i(T)^w.i(T);return new a(_,this.h^w.h)};function ie(w){for(var g=w.g.length+1,_=[],T=0;T<g;T++)_[T]=w.i(T)<<1|w.i(T-1)>>>31;return new a(_,w.h)}function oe(w,g){var _=g>>5;g%=32;for(var T=w.g.length-_,A=[],R=0;R<T;R++)A[R]=0<g?w.i(R+_)>>>g|w.i(R+_+1)<<32-g:w.i(R+_);return new a(A,w.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,Op=r,a.prototype.add=a.prototype.add,a.prototype.multiply=a.prototype.j,a.prototype.modulo=a.prototype.A,a.prototype.compare=a.prototype.l,a.prototype.toNumber=a.prototype.m,a.prototype.toString=a.prototype.toString,a.prototype.getBits=a.prototype.i,a.fromNumber=h,a.fromString=f,Ir=a}).apply(typeof ud<"u"?ud:typeof self<"u"?self:typeof window<"u"?window:{});var io=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class OT{constructor(){this.overlays=new Be(re.comparator),this.Ir=new Map}getOverlay(e,n){return j.resolve(this.overlays.get(n))}getOverlays(e,n){const r=vr();return j.forEach(n,s=>this.getOverlay(e,s).next(i=>{i!==null&&r.set(s,i)})).next(()=>r)}saveOverlays(e,n,r){return r.forEach((s,i)=>{this.ht(e,n,i)}),j.resolve()}removeOverlaysForBatchId(e,n,r){const s=this.Ir.get(r);return s!==void 0&&(s.forEach(i=>this.overlays=this.overlays.remove(i)),this.Ir.delete(r)),j.resolve()}getOverlaysForCollection(e,n,r){const s=vr(),i=n.length+1,a=new re(n.child("")),l=this.overlays.getIteratorFrom(a);for(;l.hasNext();){const c=l.getNext().value,h=c.getKey();if(!n.isPrefixOf(h.path))break;h.path.length===i&&c.largestBatchId>r&&s.set(c.getKey(),c)}return j.resolve(s)}getOverlaysForCollectionGroup(e,n,r,s){let i=new Be((h,f)=>h-f);const a=this.overlays.getIterator();for(;a.hasNext();){const h=a.getNext().value;if(h.getKey().getCollectionGroup()===n&&h.largestBatchId>r){let f=i.get(h.largestBatchId);f===null&&(f=vr(),i=i.insert(h.largestBatchId,f)),f.set(h.getKey(),h)}}const l=vr(),c=i.getIterator();for(;c.hasNext()&&(c.getNext().value.forEach((h,f)=>l.set(h,f)),!(l.size()>=s)););return j.resolve(l)}ht(e,n,r){const s=this.overlays.get(r.key);if(s!==null){const a=this.Ir.get(s.largestBatchId).delete(r.key);this.Ir.set(s.largestBatchId,a)}this.overlays=this.overlays.insert(r.key,new rT(n,r));let i=this.Ir.get(n);i===void 0&&(i=Ee(),this.Ir.set(n,i)),this.Ir.set(n,i.add(r.key))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xT{constructor(){this.sessionToken=ht.EMPTY_BYTE_STRING}getSessionToken(e){return j.resolve(this.sessionToken)}setSessionToken(e,n){return this.sessionToken=n,j.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
