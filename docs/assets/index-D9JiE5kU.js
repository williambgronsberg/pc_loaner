...
* @license MIT
**/function Zl(n){const e=Object.create(null);for(const t of n.split(","))e[t]=1;return t=>t in e}const Pe={},xr=[],Ht=()=>{},ud=()=>!1,jo=n=>n.charCodeAt(0)===111&&n.charCodeAt(1)===110&&(n.charCodeAt(2)>122||n.charCodeAt(2)<97),qo=n=>n.startsWith("onUpdate:"),et=Object.assign,ec=(n,e)=>{const t=n.indexOf(e);t>-1&&n.splice(t,1)},Zm=Object.prototype.hasOwnProperty,Ie=(n,e)=>Zm.call(n,e),ie=Array.isArray,Lr=n=>gi(n)==="[object Map]",hd=n=>gi(n)==="[object Set]",lh=n=>gi(n)==="[object Date]",ce=n=>typeof n=="function",Ne=n=>typeof n=="string",Yt=n=>typeof n=="symbol",Re=n=>n!==null&&typeof n=="object",fd=n=>(Re(n)||ce(n))&&ce(n.then)&&ce(n.catch),dd=Object.prototype.toString,gi=n=>dd.call(n),e_=n=>gi(n).slice(8,-1),pd=n=>gi(n)==="[object Object]",tc=n=>Ne(n)&&n!=="NaN"&&n[0]!=="-"&&""+parseInt(n,10)===n,$s=Zl(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Wo=n=>{const e=Object.create(null);return t=>e[t]||(e[t]=n(t))},t_=/-\w/g,Dt=Wo(n=>n.replace(t_,e=>e.slice(1).toUpperCase())),n_=/\B([A-Z])/g,Gn=Wo(n=>n.replace(n_,"-$1").toLowerCase()),gd=Wo(n=>n.charAt(0).toUpperCase()+n.slice(1)),ja=Wo(n=>n?`on${gd(n)}`:""),qt=(n,e)=>!Object.is(n,e),so=(n,...e)=>{for(let t=0;t<n.length;t++)n[t](...e)},md=(n,e,t,r=!1)=>{Object.defineProperty(n,e,{configurable:!0,enumerable:!1,writable:r,value:t})},nc=n=>{const e=parseFloat(n);return isNaN(e)?n:e};let ch;const Ho=()=>ch||(ch=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function Ko(n){if(ie(n)){const e={};for(let t=0;t<n.length;t++){const r=n[t],s=Ne(r)?o_(r):Ko(r);if(s)for(const i in s)e[i]=s[i]}return e}else if(Ne(n)||Re(n))return n}const r_=/;(?![^(]*\))/g,s_=/:([^]+)/,i_=/\/\*[^]*?\*\//g;function o_(n){const e={};return n.replace(i_,"").split(r_).forEach(t=>{if(t){const r=t.split(s_);r.length>1&&(e[r[0].trim()]=r[1].trim())}}),e}function mn(n){let e="";if(Ne(n))e=n;else if(ie(n))for(let t=0;t<n.length;t++){const r=mn(n[t]);r&&(e+=r+" ")}else if(Re(n))for(const t in n)n[t]&&(e+=t+" ");return e.trim()}const a_="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",l_=Zl(a_);function _d(n){return!!n||n===""}function c_(n,e){if(n.length!==e.length)return!1;let t=!0;for(let r=0;t&&r<n.length;r++)t=rc(n[r],e[r]);return t}function rc(n,e){if(n===e)return!0;let t=lh(n),r=lh(e);if(t||r)return t&&r?n.getTime()===e.getTime():!1;if(t=Yt(n),r=Yt(e),t||r)return n===e;if(t=ie(n),r=ie(e),t||r)return t&&r?c_(n,e):!1;if(t=Re(n),r=Re(e),t||r){if(!t||!r)return!1;const s=Object.keys(n).length,i=Object.keys(e).length;if(s!==i)return!1;for(const a in n){const l=n.hasOwnProperty(a),c=e.hasOwnProperty(a);if(l&&!c||!l&&c||!rc(n[a],e[a]))return!1}}return String(n)===String(e)}const yd=n=>!!(n&&n.__v_isRef===!0),We=n=>Ne(n)?n:n==null?"":ie(n)||Re(n)&&(n.toString===dd||!ce(n.toString))?yd(n)?We(n.value):JSON.stringify(n,vd,2):String(n),vd=(n,e)=>yd(e)?vd(n,e.value):Lr(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((t,[r,s],i)=>(t[qa(r,i)+" =>"]=s,t),{})}:hd(e)?{[`Set(${e.size})`]:[...e.values()].map(t=>qa(t))}:Yt(e)?qa(e):Re(e)&&!ie(e)&&!pd(e)?String(e):e,qa=(n,e="")=>{var t;return Yt(n)?`Symbol(${(t=n.description)!=null?t:e})`:n};/**
* @vue/reactivity v3.5.39
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let Ye;class u_{constructor(e=!1){this.detached=e,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this._warnOnRun=!0,this.__v_skip=!0,!e&&Ye&&(Ye.active?(this.parent=Ye,this.index=(Ye.scopes||(Ye.scopes=[])).push(this)-1):(this._active=!1,this._warnOnRun=!1))}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let e,t;if(this.scopes)for(e=0,t=this.scopes.length;e<t;e++)this.scopes[e].pause();for(e=0,t=this.effects.length;e<t;e++)this.effects[e].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let e,t;if(this.scopes)for(e=0,t=this.scopes.length;e<t;e++)this.scopes[e].resume();for(e=0,t=this.effects.length;e<t;e++)this.effects[e].resume()}}run(e){if(this._active){const t=Ye;try{return Ye=this,e()}finally{Ye=t}}}on(){++this._on===1&&(this.prevScope=Ye,Ye=this)}off(){if(this._on>0&&--this._on===0){if(Ye===this)Ye=this.prevScope;else{let e=Ye;for(;e;){if(e.prevScope===this){e.prevScope=this.prevScope;break}e=e.prevScope}}this.prevScope=void 0}}stop(e){if(this._active){this._active=!1;let t,r;for(t=0,r=this.effects.length;t<r;t++)this.effects[t].stop();for(this.effects.length=0,t=0,r=this.cleanups.length;t<r;t++)this.cleanups[t]();if(this.cleanups.length=0,this.scopes){for(t=0,r=this.scopes.length;t<r;t++)this.scopes[t].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!e){const s=this.parent.scopes.pop();s&&s!==this&&(this.parent.scopes[this.index]=s,s.index=this.index)}this.parent=void 0}}}function h_(){return Ye}let Ce;const Wa=new WeakSet;class Ed{constructor(e){this.fn=e,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,Ye&&(Ye.active?Ye.effects.push(this):this.flags&=-2)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,Wa.has(this)&&(Wa.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||wd(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,uh(this),Id(this);const e=Ce,t=Nt;Ce=this,Nt=!0;try{return this.fn()}finally{Ad(this),Ce=e,Nt=t,this.flags&=-3}}stop(){if(this.flags&1){for(let e=this.deps;e;e=e.nextDep)oc(e);this.deps=this.depsTail=void 0,uh(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?Wa.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){_l(this)&&this.run()}get dirty(){return _l(this)}}let Td=0,js,qs;function wd(n,e=!1){if(n.flags|=8,e){n.next=qs,qs=n;return}n.next=js,js=n}function sc(){Td++}function ic(){if(--Td>0)return;if(qs){let e=qs;for(qs=void 0;e;){const t=e.next;e.next=void 0,e.flags&=-9,e=t}}let n;for(;js;){let e=js;for(js=void 0;e;){const t=e.next;if(e.next=void 0,e.flags&=-9,e.flags&1)try{e.trigger()}catch(r){n||(n=r)}e=t}}if(n)throw n}function Id(n){for(let e=n.deps;e;e=e.nextDep)e.version=-1,e.prevActiveLink=e.dep.activeLink,e.dep.activeLink=e}function Ad(n){let e,t=n.depsTail,r=t;for(;r;){const s=r.prevDep;r.version===-1?(r===t&&(t=s),oc(r),f_(r)):e=r,r.dep.activeLink=r.prevActiveLink,r.prevActiveLink=void 0,r=s}n.deps=e,n.depsTail=t}function _l(n){for(let e=n.deps;e;e=e.nextDep)if(e.dep.version!==e.version||e.dep.computed&&(bd(e.dep.computed)||e.dep.version!==e.version))return!0;return!!n._dirty}function bd(n){if(n.flags&4&&!(n.flags&16)||(n.flags&=-17,n.globalVersion===Zs)||(n.globalVersion=Zs,!n.isSSR&&n.flags&128&&(!n.deps&&!n._dirty||!_l(n))))return;n.flags|=2;const e=n.dep,t=Ce,r=Nt;Ce=n,Nt=!0;try{Id(n);const s=n.fn(n._value);(e.version===0||qt(s,n._value))&&(n.flags|=128,n._value=s,e.version++)}catch(s){throw e.version++,s}finally{Ce=t,Nt=r,Ad(n),n.flags&=-3}}function oc(n,e=!1){const{dep:t,prevSub:r,nextSub:s}=n;if(r&&(r.nextSub=s,n.prevSub=void 0),s&&(s.prevSub=r,n.nextSub=void 0),t.subs===n&&(t.subs=r,!r&&t.computed)){t.computed.flags&=-5;for(let i=t.computed.deps;i;i=i.nextDep)oc(i,!0)}!e&&!--t.sc&&t.map&&t.map.delete(t.key)}function f_(n){const{prevDep:e,nextDep:t}=n;e&&(e.nextDep=t,n.prevDep=void 0),t&&(t.prevDep=e,n.nextDep=void 0)}let Nt=!0;const Rd=[];function Jt(){Rd.push(Nt),Nt=!1}function Xt(){const n=Rd.pop();Nt=n===void 0?!0:n}function uh(n){const{cleanup:e}=n;if(n.cleanup=void 0,e){const t=Ce;Ce=void 0;try{e()}finally{Ce=t}}}let Zs=0;class d_{constructor(e,t){this.sub=e,this.dep=t,this.version=t.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class ac{constructor(e){this.computed=e,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0,this.__v_skip=!0}track(e){if(!Ce||!Nt||Ce===this.computed)return;let t=this.activeLink;if(t===void 0||t.sub!==Ce)t=this.activeLink=new d_(Ce,this),Ce.deps?(t.prevDep=Ce.depsTail,Ce.depsTail.nextDep=t,Ce.depsTail=t):Ce.deps=Ce.depsTail=t,Sd(t);else if(t.version===-1&&(t.version=this.version,t.nextDep)){const r=t.nextDep;r.prevDep=t.prevDep,t.prevDep&&(t.prevDep.nextDep=r),t.prevDep=Ce.depsTail,t.nextDep=void 0,Ce.depsTail.nextDep=t,Ce.depsTail=t,Ce.deps===t&&(Ce.deps=r)}return t}trigger(e){this.version++,Zs++,this.notify(e)}notify(e){sc();try{for(let t=this.subs;t;t=t.prevSub)t.sub.notify()&&t.sub.dep.notify()}finally{ic()}}}function Sd(n){if(n.dep.sc++,n.sub.flags&4){const e=n.dep.computed;if(e&&!n.dep.subs){e.flags|=20;for(let r=e.deps;r;r=r.nextDep)Sd(r)}const t=n.dep.subs;t!==n&&(n.prevSub=t,t&&(t.nextSub=n)),n.dep.subs=n}}const yl=new WeakMap,fr=Symbol(""),vl=Symbol(""),ei=Symbol("");function at(n,e,t){if(Nt&&Ce){let r=yl.get(n);r||yl.set(n,r=new Map);let s=r.get(t);s||(r.set(t,s=new ac),s.map=r,s.key=t),s.track()}}function un(n,e,t,r,s,i){const a=yl.get(n);if(!a){Zs++;return}const l=c=>{c&&c.trigger()};if(sc(),e==="clear")a.forEach(l);else{const c=ie(n),h=c&&tc(t);if(c&&t==="length"){const d=Number(r);a.forEach((g,y)=>{(y==="length"||y===ei||!Yt(y)&&y>=d)&&l(g)})}else switch((t!==void 0||a.has(void 0))&&l(a.get(t)),h&&l(a.get(ei)),e){case"add":c?h&&l(a.get("length")):(l(a.get(fr)),Lr(n)&&l(a.get(vl)));break;case"delete":c||(l(a.get(fr)),Lr(n)&&l(a.get(vl)));break;case"set":Lr(n)&&l(a.get(fr));break}}ic()}function Cr(n){const e=we(n);return e===n?e:(at(e,"iterate",ei),Pt(n)?e:e.map(Ot))}function zo(n){return at(n=we(n),"iterate",ei),n}function $t(n,e){return vn(n)?zr(dr(n)?Ot(e):e):Ot(e)}const p_={__proto__:null,[Symbol.iterator](){return Ha(this,Symbol.iterator,n=>$t(this,n))},concat(...n){return Cr(this).concat(...n.map(e=>ie(e)?Cr(e):e))},entries(){return Ha(this,"entries",n=>(n[1]=$t(this,n[1]),n))},every(n,e){return on(this,"every",n,e,void 0,arguments)},filter(n,e){return on(this,"filter",n,e,t=>t.map(r=>$t(this,r)),arguments)},find(n,e){return on(this,"find",n,e,t=>$t(this,t),arguments)},findIndex(n,e){return on(this,"findIndex",n,e,void 0,arguments)},findLast(n,e){return on(this,"findLast",n,e,t=>$t(this,t),arguments)},findLastIndex(n,e){return on(this,"findLastIndex",n,e,void 0,arguments)},forEach(n,e){return on(this,"forEach",n,e,void 0,arguments)},includes(...n){return Ka(this,"includes",n)},indexOf(...n){return Ka(this,"indexOf",n)},join(n){return Cr(this).join(n)},lastIndexOf(...n){return Ka(this,"lastIndexOf",n)},map(n,e){return on(this,"map",n,e,void 0,arguments)},pop(){return Rs(this,"pop")},push(...n){return Rs(this,"push",n)},reduce(n,...e){return hh(this,"reduce",n,e)},reduceRight(n,...e){return hh(this,"reduceRight",n,e)},shift(){return Rs(this,"shift")},some(n,e){return on(this,"some",n,e,void 0,arguments)},splice(...n){return Rs(this,"splice",n)},toReversed(){return Cr(this).toReversed()},toSorted(n){return Cr(this).toSorted(n)},toSpliced(...n){return Cr(this).toSpliced(...n)},unshift(...n){return Rs(this,"unshift",n)},values(){return Ha(this,"values",n=>$t(this,n))}};function Ha(n,e,t){const r=zo(n),s=r[e]();return r!==n&&!Pt(n)&&(s._next=s.next,s.next=()=>{const i=s._next();return i.done||(i.value=t(i.value)),i}),s}const g_=Array.prototype;function on(n,e,t,r,s,i){const a=zo(n),l=a!==n&&!Pt(n),c=a[e];if(c!==g_[e]){const g=c.apply(n,i);return l?Ot(g):g}let h=t;a!==n&&(l?h=function(g,y){return t.call(this,$t(n,g),y,n)}:t.length>2&&(h=function(g,y){return t.call(this,g,y,n)}));const d=c.call(a,h,r);return l&&s?s(d):d}function hh(n,e,t,r){const s=zo(n),i=s!==n&&!Pt(n);let a=t,l=!1;s!==n&&(i?(l=r.length===0,a=function(h,d,g){return l&&(l=!1,h=$t(n,h)),t.call(this,h,$t(n,d),g,n)}):t.length>3&&(a=function(h,d,g){return t.call(this,h,d,g,n)}));const c=s[e](a,...r);return l?$t(n,c):c}function Ka(n,e,t){const r=we(n);at(r,"iterate",ei);const s=r[e](...t);return(s===-1||s===!1)&&hc(t[0])?(t[0]=we(t[0]),r[e](...t)):s}function Rs(n,e,t=[]){Jt(),sc();const r=we(n)[e].apply(n,t);return ic(),Xt(),r}const m_=Zl("__proto__,__v_isRef,__isVue"),Pd=new Set(Object.getOwnPropertyNames(Symbol).filter(n=>n!=="arguments"&&n!=="caller").map(n=>Symbol[n]).filter(Yt));function __(n){Yt(n)||(n=String(n));const e=we(this);return at(e,"has",n),e.hasOwnProperty(n)}class Cd{constructor(e=!1,t=!1){this._isReadonly=e,this._isShallow=t}get(e,t,r){if(t==="__v_skip")return e.__v_skip;const s=this._isReadonly,i=this._isShallow;if(t==="__v_isReactive")return!s;if(t==="__v_isReadonly")return s;if(t==="__v_isShallow")return i;if(t==="__v_raw")return r===(s?i?S_:Nd:i?Dd:Vd).get(e)||Object.getPrototypeOf(e)===Object.getPrototypeOf(r)?e:void 0;const a=ie(e);if(!s){let c;if(a&&(c=p_[t]))return c;if(t==="hasOwnProperty")return __}const l=Reflect.get(e,t,ut(e)?e:r);if((Yt(t)?Pd.has(t):m_(t))||(s||at(e,"get",t),i))return l;if(ut(l)){const c=a&&tc(t)?l:l.value;return s&&Re(c)?Tl(c):c}return Re(l)?s?Tl(l):cc(l):l}}class kd extends Cd{constructor(e=!1){super(!1,e)}set(e,t,r,s){let i=e[t];const a=ie(e)&&tc(t);if(!this._isShallow){const h=vn(i);if(!Pt(r)&&!vn(r)&&(i=we(i),r=we(r)),!a&&ut(i)&&!ut(r))return h||(i.value=r),!0}const l=a?Number(t)<e.length:Ie(e,t),c=Reflect.set(e,t,r,ut(e)?e:s);return e===we(s)&&c&&(l?qt(r,i)&&un(e,"set",t,r):un(e,"add",t,r)),c}deleteProperty(e,t){const r=Ie(e,t);e[t];const s=Reflect.deleteProperty(e,t);return s&&r&&un(e,"delete",t,void 0),s}has(e,t){const r=Reflect.has(e,t);return(!Yt(t)||!Pd.has(t))&&at(e,"has",t),r}ownKeys(e){return at(e,"iterate",ie(e)?"length":fr),Reflect.ownKeys(e)}}class y_ extends Cd{constructor(e=!1){super(!0,e)}set(e,t){return!0}deleteProperty(e,t){return!0}}const v_=new kd,E_=new y_,T_=new kd(!0);const El=n=>n,Gi=n=>Reflect.getPrototypeOf(n);function w_(n,e,t){return function(...r){const s=this.__v_raw,i=we(s),a=Lr(i),l=n==="entries"||n===Symbol.iterator&&a,c=n==="keys"&&a,h=s[n](...r),d=t?El:e?zr:Ot;return!e&&at(i,"iterate",c?vl:fr),et(Object.create(h),{next(){const{value:g,done:y}=h.next();return y?{value:g,done:y}:{value:l?[d(g[0]),d(g[1])]:d(g),done:y}}})}}function Qi(n){return function(...e){return n==="delete"?!1:n==="clear"?void 0:this}}function I_(n,e){const t={get(s){const i=this.__v_raw,a=we(i),l=we(s);n||(qt(s,l)&&at(a,"get",s),at(a,"get",l));const{has:c}=Gi(a),h=e?El:n?zr:Ot;if(c.call(a,s))return h(i.get(s));if(c.call(a,l))return h(i.get(l));i!==a&&i.get(s)},get size(){const s=this.__v_raw;return!n&&at(we(s),"iterate",fr),s.size},has(s){const i=this.__v_raw,a=we(i),l=we(s);return n||(qt(s,l)&&at(a,"has",s),at(a,"has",l)),s===l?i.has(s):i.has(s)||i.has(l)},forEach(s,i){const a=this,l=a.__v_raw,c=we(l),h=e?El:n?zr:Ot;return!n&&at(c,"iterate",fr),l.forEach((d,g)=>s.call(i,h(d),h(g),a))}};return et(t,n?{add:Qi("add"),set:Qi("set"),delete:Qi("delete"),clear:Qi("clear")}:{add(s){const i=we(this),a=Gi(i),l=we(s),c=!e&&!Pt(s)&&!vn(s)?l:s;return a.has.call(i,c)||qt(s,c)&&a.has.call(i,s)||qt(l,c)&&a.has.call(i,l)||(i.add(c),un(i,"add",c,c)),this},set(s,i){!e&&!Pt(i)&&!vn(i)&&(i=we(i));const a=we(this),{has:l,get:c}=Gi(a);let h=l.call(a,s);h||(s=we(s),h=l.call(a,s));const d=c.call(a,s);return a.set(s,i),h?qt(i,d)&&un(a,"set",s,i):un(a,"add",s,i),this},delete(s){const i=we(this),{has:a,get:l}=Gi(i);let c=a.call(i,s);c||(s=we(s),c=a.call(i,s)),l&&l.call(i,s);const h=i.delete(s);return c&&un(i,"delete",s,void 0),h},clear(){const s=we(this),i=s.size!==0,a=s.clear();return i&&un(s,"clear",void 0,void 0),a}}),["keys","values","entries",Symbol.iterator].forEach(s=>{t[s]=w_(s,n,e)}),t}function lc(n,e){const t=I_(n,e);return(r,s,i)=>s==="__v_isReactive"?!n:s==="__v_isReadonly"?n:s==="__v_raw"?r:Reflect.get(Ie(t,s)&&s in r?t:r,s,i)}const A_={get:lc(!1,!1)},b_={get:lc(!1,!0)},R_={get:lc(!0,!1)};const Vd=new WeakMap,Dd=new WeakMap,Nd=new WeakMap,S_=new WeakMap;function P_(n){switch(n){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function cc(n){return vn(n)?n:uc(n,!1,v_,A_,Vd)}function C_(n){return uc(n,!1,T_,b_,Dd)}function Tl(n){return uc(n,!0,E_,R_,Nd)}function uc(n,e,t,r,s){if(!Re(n)||n.__v_raw&&!(e&&n.__v_isReactive)||n.__v_skip||!Object.isExtensible(n))return n;const i=s.get(n);if(i)return i;const a=P_(e_(n));if(a===0)return n;const l=new Proxy(n,a===2?r:t);return s.set(n,l),l}function dr(n){return vn(n)?dr(n.__v_raw):!!(n&&n.__v_isReactive)}function vn(n){return!!(n&&n.__v_isReadonly)}function Pt(n){return!!(n&&n.__v_isShallow)}function hc(n){return n?!!n.__v_raw:!1}function we(n){const e=n&&n.__v_raw;return e?we(e):n}function k_(n){return!Ie(n,"__v_skip")&&Object.isExtensible(n)&&md(n,"__v_skip",!0),n}const Ot=n=>Re(n)?cc(n):n,zr=n=>Re(n)?Tl(n):n;function ut(n){return n?n.__v_isRef===!0:!1}function He(n){return V_(n,!1)}function V_(n,e){return ut(n)?n:new D_(n,e)}class D_{constructor(e,t){this.dep=new ac,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=t?e:we(e),this._value=t?e:Ot(e),this.__v_isShallow=t}get value(){return this.dep.track(),this._value}set value(e){const t=this._rawValue,r=this.__v_isShallow||Pt(e)||vn(e);e=r?e:we(e),qt(e,t)&&(this._rawValue=e,this._value=r?e:Ot(e),this.dep.trigger())}}function ur(n){return ut(n)?n.value:n}const N_={get:(n,e,t)=>e==="__v_raw"?n:ur(Reflect.get(n,e,t)),set:(n,e,t,r)=>{const s=n[e];return ut(s)&&!ut(t)?(s.value=t,!0):Reflect.set(n,e,t,r)}};function Od(n){return dr(n)?n:new Proxy(n,N_)}class O_{constructor(e,t,r){this.fn=e,this.setter=t,this._value=void 0,this.dep=new ac(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=Zs-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!t,this.isSSR=r}notify(){if(this.flags|=16,!(this.flags&8)&&Ce!==this)return wd(this,!0),!0}get value(){const e=this.dep.track();return bd(this),e&&(e.version=this.dep.version),this._value}set value(e){this.setter&&this.setter(e)}}function M_(n,e,t=!1){let r,s;return ce(n)?r=n:(r=n.get,s=n.set),new O_(r,s,t)}const Yi={},_o=new WeakMap;let ar;function x_(n,e=!1,t=ar){if(t){let r=_o.get(t);r||_o.set(t,r=[]),r.push(n)}}function L_(n,e,t=Pe){const{immediate:r,deep:s,once:i,scheduler:a,augmentJob:l,call:c}=t,h=z=>s?z:Pt(z)||s===!1||s===0?hn(z,1):hn(z);let d,g,y,w,k=!1,R=!1;if(ut(n)?(g=()=>n.value,k=Pt(n)):dr(n)?(g=()=>h(n),k=!0):ie(n)?(R=!0,k=n.some(z=>dr(z)||Pt(z)),g=()=>n.map(z=>{if(ut(z))return z.value;if(dr(z))return h(z);if(ce(z))return c?c(z,2):z()})):ce(n)?e?g=c?()=>c(n,2):n:g=()=>{if(y){Jt();try{y()}finally{Xt()}}const z=ar;ar=d;try{return c?c(n,3,[w]):n(w)}finally{ar=z}}:g=Ht,e&&s){const z=g,fe=s===!0?1/0:s;g=()=>hn(z(),fe)}const P=h_(),U=()=>{d.stop(),P&&P.active&&ec(P.effects,d)};if(i&&e){const z=e;e=(...fe)=>{const he=z(...fe);return U(),he}}let B=R?new Array(n.length).fill(Yi):Yi;const Q=z=>{if(!(!(d.flags&1)||!d.dirty&&!z))if(e){const fe=d.run();if(z||s||k||(R?fe.some((he,T)=>qt(he,B[T])):qt(fe,B))){y&&y();const he=ar;ar=d;try{const T=[fe,B===Yi?void 0:R&&B[0]===Yi?[]:B,w];B=fe,c?c(e,3,T):e(...T)}finally{ar=he}}}else d.run()};return l&&l(Q),d=new Ed(g),d.scheduler=a?()=>a(Q,!1):Q,w=z=>x_(z,!1,d),y=d.onStop=()=>{const z=_o.get(d);if(z){if(c)c(z,4);else for(const fe of z)fe();_o.delete(d)}},e?r?Q(!0):B=d.run():a?a(Q.bind(null,!0),!0):d.run(),U.pause=d.pause.bind(d),U.resume=d.resume.bind(d),U.stop=U,U}function hn(n,e=1/0,t){if(e<=0||!Re(n)||n.__v_skip||(t=t||new Map,(t.get(n)||0)>=e))return n;if(t.set(n,e),e--,ut(n))hn(n.value,e,t);else if(ie(n))for(let r=0;r<n.length;r++)hn(n[r],e,t);else if(hd(n)||Lr(n))n.forEach(r=>{hn(r,e,t)});else if(pd(n)){for(const r in n)hn(n[r],e,t);for(const r of Object.getOwnPropertySymbols(n))Object.prototype.propertyIsEnumerable.call(n,r)&&hn(n[r],e,t)}return n}/**
* @vue/runtime-core v3.5.39
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function mi(n,e,t,r){try{return r?n(...r):n()}catch(s){Go(s,e,t)}}function Mt(n,e,t,r){if(ce(n)){const s=mi(n,e,t,r);return s&&fd(s)&&s.catch(i=>{Go(i,e,t)}),s}if(ie(n)){const s=[];for(let i=0;i<n.length;i++)s.push(Mt(n[i],e,t,r));return s}}function Go(n,e,t,r=!0){const s=e?e.vnode:null,{errorHandler:i,throwUnhandledErrorInProduction:a}=e&&e.appContext.config||Pe;if(e){let l=e.parent;const c=e.proxy,h=`https://vuejs.org/error-reference/#runtime-${t}`;for(;l;){const d=l.ec;if(d){for(let g=0;g<d.length;g++)if(d[g](n,c,h)===!1)return}l=l.parent}if(i){Jt(),mi(i,null,10,[n,c,h]),Xt();return}}F_(n,t,s,r,a)}function F_(n,e,t,r=!0,s=!1){if(s)throw n;console.error(n)}const gt=[];let Bt=-1;const Fr=[];let Dn=null,kr=0;const Md=Promise.resolve();let yo=null;function U_(n){const e=yo||Md;return n?e.then(this?n.bind(this):n):e}function B_(n){let e=Bt+1,t=gt.length;for(;e<t;){const r=e+t>>>1,s=gt[r],i=ti(s);i<n||i===n&&s.flags&2?e=r+1:t=r}return e}function fc(n){if(!(n.flags&1)){const e=ti(n),t=gt[gt.length-1];!t||!(n.flags&2)&&e>=ti(t)?gt.push(n):gt.splice(B_(e),0,n),n.flags|=1,xd()}}function xd(){yo||(yo=Md.then(Fd))}function $_(n){ie(n)?Fr.push(...n):Dn&&n.id===-1?Dn.splice(kr+1,0,n):n.flags&1||(Fr.push(n),n.flags|=1),xd()}function fh(n,e,t=Bt+1){for(;t<gt.length;t++){const r=gt[t];if(r&&r.flags&2){if(n&&r.id!==n.uid)continue;gt.splice(t,1),t--,r.flags&4&&(r.flags&=-2),r(),r.flags&4||(r.flags&=-2)}}}function Ld(n){if(Fr.length){const e=[...new Set(Fr)].sort((t,r)=>ti(t)-ti(r));if(Fr.length=0,Dn){Dn.push(...e);return}for(Dn=e,kr=0;kr<Dn.length;kr++){const t=Dn[kr];t.flags&4&&(t.flags&=-2),t.flags&8||t(),t.flags&=-2}Dn=null,kr=0}}const ti=n=>n.id==null?n.flags&2?-1:1/0:n.id;function Fd(n){try{for(Bt=0;Bt<gt.length;Bt++){const e=gt[Bt];e&&!(e.flags&8)&&(e.flags&4&&(e.flags&=-2),mi(e,e.i,e.i?15:14),e.flags&4||(e.flags&=-2))}}finally{for(;Bt<gt.length;Bt++){const e=gt[Bt];e&&(e.flags&=-2)}Bt=-1,gt.length=0,Ld(),yo=null,(gt.length||Fr.length)&&Fd()}}let St=null,Ud=null;function vo(n){const e=St;return St=n,Ud=n&&n.type.__scopeId||null,e}function j_(n,e=St,t){if(!e||n._n)return n;const r=(...s)=>{r._d&&bh(-1);const i=vo(e);let a;try{a=n(...s)}finally{vo(i),r._d&&bh(1)}return a};return r._n=!0,r._c=!0,r._d=!0,r}function ln(n,e){if(St===null)return n;const t=ea(St),r=n.dirs||(n.dirs=[]);for(let s=0;s<e.length;s++){let[i,a,l,c=Pe]=e[s];i&&(ce(i)&&(i={mounted:i,updated:i}),i.deep&&hn(a),r.push({dir:i,instance:t,value:a,oldValue:void 0,arg:l,modifiers:c}))}return n}function sr(n,e,t,r){const s=n.dirs,i=e&&e.dirs;for(let a=0;a<s.length;a++){const l=s[a];i&&(l.oldValue=i[a].value);let c=l.dir[r];c&&(Jt(),Mt(c,t,8,[n.el,l,n,e]),Xt())}}function io(n,e){if(mt){let t=mt.provides;const r=mt.parent&&mt.parent.provides;r===t&&(t=mt.provides=Object.create(r)),t[n]=e}}function It(n,e,t=!1){const r=jy();if(r||Br){let s=Br?Br._context.provides:r?r.parent==null||r.ce?r.vnode.appContext&&r.vnode.appContext.provides:r.parent.provides:void 0;if(s&&n in s)return s[n];if(arguments.length>1)return t&&ce(e)?e.call(r&&r.proxy):e}}const q_=Symbol.for("v-scx"),W_=()=>It(q_);function za(n,e,t){return Bd(n,e,t)}function Bd(n,e,t=Pe){const{immediate:r,deep:s,flush:i,once:a}=t,l=et({},t),c=e&&r||!e&&i!=="post";let h;if(ri){if(i==="sync"){const w=W_();h=w.__watcherHandles||(w.__watcherHandles=[])}else if(!c){const w=()=>{};return w.stop=Ht,w.resume=Ht,w.pause=Ht,w}}const d=mt;l.call=(w,k,R)=>Mt(w,d,k,R);let g=!1;i==="post"?l.scheduler=w=>{pt(w,d&&d.suspense)}:i!=="sync"&&(g=!0,l.scheduler=(w,k)=>{k?w():fc(w)}),l.augmentJob=w=>{e&&(w.flags|=4),g&&(w.flags|=2,d&&(w.id=d.uid,w.i=d))};const y=L_(n,e,l);return ri&&(h?h.push(y):c&&y()),y}function H_(n,e,t){const r=this.proxy,s=Ne(n)?n.includes(".")?$d(r,n):()=>r[n]:n.bind(r,r);let i;ce(e)?i=e:(i=e.handler,t=e);const a=_i(this),l=Bd(s,i.bind(r),t);return a(),l}function $d(n,e){const t=e.split(".");return()=>{let r=n;for(let s=0;s<t.length&&r;s++)r=r[t[s]];return r}}const Vn=new WeakMap,jd=Symbol("_vte"),K_=n=>n.__isTeleport,cr=n=>n&&(n.disabled||n.disabled===""),z_=n=>n&&(n.defer||n.defer===""),dh=n=>typeof SVGElement<"u"&&n instanceof SVGElement,ph=n=>typeof MathMLElement=="function"&&n instanceof MathMLElement,wl=(n,e)=>{const t=n&&n.to;return Ne(t)?e?e(t):null:t},G_={name:"Teleport",__isTeleport:!0,process(n,e,t,r,s,i,a,l,c,h){const{mc:d,pc:g,pbc:y,o:{insert:w,querySelector:k,createText:R,createComment:P,parentNode:U}}=h,B=cr(e.props);let{dynamicChildren:Q}=e;const z=(T,m,v)=>{T.shapeFlag&16&&d(T.children,m,v,s,i,a,l,c)},fe=(T=e)=>{const m=cr(T.props),v=T.target=wl(T.props,k),I=Il(v,T,R,w);v&&(a!=="svg"&&dh(v)?a="svg":a!=="mathml"&&ph(v)&&(a="mathml"),s&&s.isCE&&(s.ce._teleportTargets||(s.ce._teleportTargets=new Set)).add(v),m||(z(T,v,I),Ds(T,!1)))},he=T=>{const m=()=>{if(Vn.get(T)===m){if(Vn.delete(T),cr(T.props)){const v=U(T.el)||t;z(T,v,T.anchor),Ds(T,!0)}fe(T)}};Vn.set(T,m),pt(m,i)};if(n==null){const T=e.el=R(""),m=e.anchor=R("");if(w(T,t,r),w(m,t,r),z_(e.props)||i&&i.pendingBranch){he(e);return}B&&(z(e,t,m),Ds(e,!0)),fe()}else{e.el=n.el;const T=e.anchor=n.anchor,m=Vn.get(n);if(m){m.flags|=8,Vn.delete(n),he(e);return}e.targetStart=n.targetStart;const v=e.target=n.target,I=e.targetAnchor=n.targetAnchor,b=cr(n.props),S=b?t:v,_=b?T:I;if(a==="svg"||dh(v)?a="svg":(a==="mathml"||ph(v))&&(a="mathml"),Q?(y(n.dynamicChildren,Q,S,s,i,a,l),_c(n,e,!0)):c||g(n,e,S,_,s,i,a,l,!1),B)b?e.props&&n.props&&e.props.to!==n.props.to&&(e.props.to=n.props.to):Ji(e,t,T,h,1);else if((e.props&&e.props.to)!==(n.props&&n.props.to)){const Y=wl(e.props,k);Y&&(e.target=Y,Ji(e,Y,null,h,0))}else b&&Ji(e,v,I,h,1);Ds(e,B)}},remove(n,e,t,{um:r,o:{remove:s}},i){const{shapeFlag:a,children:l,anchor:c,targetStart:h,targetAnchor:d,target:g,props:y}=n,w=cr(y),k=i||!w,R=Vn.get(n);if(R&&(R.flags|=8,Vn.delete(n)),g&&(s(h),s(d)),i&&s(c),!R&&(w||g)&&a&16)for(let P=0;P<l.length;P++){const U=l[P];r(U,e,t,k,!!U.dynamicChildren)}},move:Ji,hydrate:Q_};function Ji(n,e,t,{o:{insert:r},m:s},i=2){i===0&&r(n.targetAnchor,e,t);const{el:a,anchor:l,shapeFlag:c,children:h,props:d}=n,g=i===2;if(g&&r(a,e,t),!Vn.has(n)&&(!g||cr(d))&&c&16)for(let y=0;y<h.length;y++)s(h[y],e,t,2);g&&r(l,e,t)}function Q_(n,e,t,r,s,i,{o:{nextSibling:a,parentNode:l,querySelector:c,insert:h,createText:d}},g){function y(P,U){let B=U;for(;B;){if(B&&B.nodeType===8){if(B.data==="teleport start anchor")e.targetStart=B;else if(B.data==="teleport anchor"){e.targetAnchor=B,P._lpa=e.targetAnchor&&a(e.targetAnchor);break}}B=a(B)}}function w(P,U){U.anchor=g(a(P),U,l(P),t,r,s,i)}const k=e.target=wl(e.props,c),R=cr(e.props);if(k){const P=k._lpa||k.firstChild;e.shapeFlag&16&&(R?(w(n,e),y(k,P),e.targetAnchor||Il(k,e,d,h,l(n)===k?n:null)):(e.anchor=a(n),y(k,P),e.targetAnchor||Il(k,e,d,h),g(P&&a(P),e,k,t,r,s,i))),Ds(e,R)}else R&&e.shapeFlag&16&&(w(n,e),e.targetStart=n,e.targetAnchor=a(n));return e.anchor&&a(e.anchor)}const Y_=G_;function Ds(n,e){const t=n.ctx;if(t&&t.ut){let r,s;for(e?(r=n.el,s=n.anchor):(r=n.targetStart,s=n.targetAnchor);r&&r!==s;)r.nodeType===1&&r.setAttribute("data-v-owner",t.uid),r=r.nextSibling;t.ut()}}function Il(n,e,t,r,s=null){const i=e.targetStart=t(""),a=e.targetAnchor=t("");return i[jd]=a,n&&(r(i,n,s),r(a,n,s)),a}const Ga=Symbol("_leaveCb");function dc(n,e){n.shapeFlag&6&&n.component?(n.transition=e,dc(n.component.subTree,e)):n.shapeFlag&128?(n.ssContent.transition=e.clone(n.ssContent),n.ssFallback.transition=e.clone(n.ssFallback)):n.transition=e}function Qo(n,e){return ce(n)?et({name:n.name},e,{setup:n}):n}function qd(n){n.ids=[n.ids[0]+n.ids[2]+++"-",0,0]}function gh(n,e){let t;return!!((t=Object.getOwnPropertyDescriptor(n,e))&&!t.configurable)}const Eo=new WeakMap;function Ws(n,e,t,r,s=!1){if(ie(n)){n.forEach((R,P)=>Ws(R,e&&(ie(e)?e[P]:e),t,r,s));return}if(Hs(r)&&!s){r.shapeFlag&512&&r.type.__asyncResolved&&r.component.subTree.component&&Ws(n,e,t,r.component.subTree);return}const i=r.shapeFlag&4?ea(r.component):r.el,a=s?null:i,{i:l,r:c}=n,h=e&&e.r,d=l.refs===Pe?l.refs={}:l.refs,g=l.setupState,y=we(g),w=g===Pe?ud:R=>gh(d,R)?!1:Ie(y,R),k=(R,P)=>!(P&&gh(d,P));if(h!=null&&h!==c){if(mh(e),Ne(h))d[h]=null,w(h)&&(g[h]=null);else if(ut(h)){const R=e;k(h,R.k)&&(h.value=null),R.k&&(d[R.k]=null)}}if(ce(c)){Jt();try{mi(c,l,12,[a,d])}finally{Xt()}}else{const R=Ne(c),P=ut(c);if(R||P){const U=()=>{if(n.f){const B=R?w(c)?g[c]:d[c]:k()||!n.k?c.value:d[n.k];if(s)ie(B)&&ec(B,i);else if(ie(B))B.includes(i)||B.push(i);else if(R)d[c]=[i],w(c)&&(g[c]=d[c]);else{const Q=[i];k(c,n.k)&&(c.value=Q),n.k&&(d[n.k]=Q)}}else R?(d[c]=a,w(c)&&(g[c]=a)):P&&(k(c,n.k)&&(c.value=a),n.k&&(d[n.k]=a))};if(a){const B=()=>{U(),Eo.delete(n)};B.id=-1,Eo.set(n,B),pt(B,t)}else mh(n),U()}}}function mh(n){const e=Eo.get(n);e&&(e.flags|=8,Eo.delete(n))}Ho().requestIdleCallback;Ho().cancelIdleCallback;const Hs=n=>!!n.type.__asyncLoader,Wd=n=>n.type.__isKeepAlive;function J_(n,e){Hd(n,"a",e)}function X_(n,e){Hd(n,"da",e)}function Hd(n,e,t=mt){const r=n.__wdc||(n.__wdc=()=>{let s=t;for(;s;){if(s.isDeactivated)return;s=s.parent}return n()});if(Yo(e,r,t),t){let s=t.parent;for(;s&&s.parent;)Wd(s.parent.vnode)&&Z_(r,e,t,s),s=s.parent}}function Z_(n,e,t,r){const s=Yo(e,n,r,!0);Jo(()=>{ec(r[e],s)},t)}function Yo(n,e,t=mt,r=!1){if(t){const s=t[n]||(t[n]=[]),i=e.__weh||(e.__weh=(...a)=>{Jt();const l=_i(t),c=Mt(e,t,n,a);return l(),Xt(),c});return r?s.unshift(i):s.push(i),i}}const An=n=>(e,t=mt)=>{(!ri||n==="sp")&&Yo(n,(...r)=>e(...r),t)},ey=An("bm"),pc=An("m"),ty=An("bu"),ny=An("u"),ry=An("bum"),Jo=An("um"),sy=An("sp"),iy=An("rtg"),oy=An("rtc");function ay(n,e=mt){Yo("ec",n,e)}const ly=Symbol.for("v-ndc");function Ur(n,e,t,r){let s;const i=t,a=ie(n);if(a||Ne(n)){const l=a&&dr(n);let c=!1,h=!1;l&&(c=!Pt(n),h=vn(n),n=zo(n)),s=new Array(n.length);for(let d=0,g=n.length;d<g;d++)s[d]=e(c?h?zr(Ot(n[d])):Ot(n[d]):n[d],d,void 0,i)}else if(typeof n=="number"){s=new Array(n);for(let l=0;l<n;l++)s[l]=e(l+1,l,void 0,i)}else if(Re(n))if(n[Symbol.iterator])s=Array.from(n,(l,c)=>e(l,c,void 0,i));else{const l=Object.keys(n);s=new Array(l.length);for(let c=0,h=l.length;c<h;c++){const d=l[c];s[c]=e(n[d],d,c,i)}}else s=[];return s}const Al=n=>n?fp(n)?ea(n):Al(n.parent):null,Ks=et(Object.create(null),{$:n=>n,$el:n=>n.vnode.el,$data:n=>n.data,$props:n=>n.props,$attrs:n=>n.attrs,$slots:n=>n.slots,$refs:n=>n.refs,$parent:n=>Al(n.parent),$root:n=>Al(n.root),$host:n=>n.ce,$emit:n=>n.emit,$options:n=>zd(n),$forceUpdate:n=>n.f||(n.f=()=>{fc(n.update)}),$nextTick:n=>n.n||(n.n=U_.bind(n.proxy)),$watch:n=>H_.bind(n)}),Qa=(n,e)=>n!==Pe&&!n.__isScriptSetup&&Ie(n,e),cy={get({_:n},e){if(e==="__v_skip")return!0;const{ctx:t,setupState:r,data:s,props:i,accessCache:a,type:l,appContext:c}=n;if(e[0]!=="$"){const y=a[e];if(y!==void 0)switch(y){case 1:return r[e];case 2:return s[e];case 4:return t[e];case 3:return i[e]}else{if(Qa(r,e))return a[e]=1,r[e];if(s!==Pe&&Ie(s,e))return a[e]=2,s[e];if(Ie(i,e))return a[e]=3,i[e];if(t!==Pe&&Ie(t,e))return a[e]=4,t[e];bl&&(a[e]=0)}}const h=Ks[e];let d,g;if(h)return e==="$attrs"&&at(n.attrs,"get",""),h(n);if((d=l.__cssModules)&&(d=d[e]))return d;if(t!==Pe&&Ie(t,e))return a[e]=4,t[e];if(g=c.config.globalProperties,Ie(g,e))return g[e]},set({_:n},e,t){const{data:r,setupState:s,ctx:i}=n;return Qa(s,e)?(s[e]=t,!0):r!==Pe&&Ie(r,e)?(r[e]=t,!0):Ie(n.props,e)||e[0]==="$"&&e.slice(1)in n?!1:(i[e]=t,!0)},has({_:{data:n,setupState:e,accessCache:t,ctx:r,appContext:s,props:i,type:a}},l){let c;return!!(t[l]||n!==Pe&&l[0]!=="$"&&Ie(n,l)||Qa(e,l)||Ie(i,l)||Ie(r,l)||Ie(Ks,l)||Ie(s.config.globalProperties,l)||(c=a.__cssModules)&&c[l])},defineProperty(n,e,t){return t.get!=null?n._.accessCache[e]=0:Ie(t,"value")&&this.set(n,e,t.value,null),Reflect.defineProperty(n,e,t)}};function _h(n){return ie(n)?n.reduce((e,t)=>(e[t]=null,e),{}):n}let bl=!0;function uy(n){const e=zd(n),t=n.proxy,r=n.ctx;bl=!1,e.beforeCreate&&yh(e.beforeCreate,n,"bc");const{data:s,computed:i,methods:a,watch:l,provide:c,inject:h,created:d,beforeMount:g,mounted:y,beforeUpdate:w,updated:k,activated:R,deactivated:P,beforeDestroy:U,beforeUnmount:B,destroyed:Q,unmounted:z,render:fe,renderTracked:he,renderTriggered:T,errorCaptured:m,serverPrefetch:v,expose:I,inheritAttrs:b,components:S,directives:_,filters:Y}=e;if(h&&hy(h,r,null),a)for(const Ae in a){const ye=a[Ae];ce(ye)&&(r[Ae]=ye.bind(t))}if(s){const Ae=s.call(t,t);Re(Ae)&&(n.data=cc(Ae))}if(bl=!0,i)for(const Ae in i){const ye=i[Ae],kt=ce(ye)?ye.bind(t,t):ce(ye.get)?ye.get.bind(t,t):Ht,Jn=!ce(ye)&&ce(ye.set)?ye.set.bind(t):Ht,tn=pp({get:kt,set:Jn});Object.defineProperty(r,Ae,{enumerable:!0,configurable:!0,get:()=>tn.value,set:je=>tn.value=je})}if(l)for(const Ae in l)Kd(l[Ae],r,t,Ae);if(c){const Ae=ce(c)?c.call(t):c;Reflect.ownKeys(Ae).forEach(ye=>{io(ye,Ae[ye])})}d&&yh(d,n,"c");function $e(Ae,ye){ie(ye)?ye.forEach(kt=>Ae(kt.bind(t))):ye&&Ae(ye.bind(t))}if($e(ey,g),$e(pc,y),$e(ty,w),$e(ny,k),$e(J_,R),$e(X_,P),$e(ay,m),$e(oy,he),$e(iy,T),$e(ry,B),$e(Jo,z),$e(sy,v),ie(I))if(I.length){const Ae=n.exposed||(n.exposed={});I.forEach(ye=>{Object.defineProperty(Ae,ye,{get:()=>t[ye],set:kt=>t[ye]=kt,enumerable:!0})})}else n.exposed||(n.exposed={});fe&&n.render===Ht&&(n.render=fe),b!=null&&(n.inheritAttrs=b),S&&(n.components=S),_&&(n.directives=_),v&&qd(n)}function hy(n,e,t=Ht){ie(n)&&(n=Rl(n));for(const r in n){const s=n[r];let i;Re(s)?"default"in s?i=It(s.from||r,s.default,!0):i=It(s.from||r):i=It(s),ut(i)?Object.defineProperty(e,r,{enumerable:!0,configurable:!0,get:()=>i.value,set:a=>i.value=a}):e[r]=i}}function yh(n,e,t){Mt(ie(n)?n.map(r=>r.bind(e.proxy)):n.bind(e.proxy),e,t)}function Kd(n,e,t,r){let s=r.includes(".")?$d(t,r):()=>t[r];if(Ne(n)){const i=e[n];ce(i)&&za(s,i)}else if(ce(n))za(s,n.bind(t));else if(Re(n))if(ie(n))n.forEach(i=>Kd(i,e,t,r));else{const i=ce(n.handler)?n.handler.bind(t):e[n.handler];ce(i)&&za(s,i,n)}}function zd(n){const e=n.type,{mixins:t,extends:r}=e,{mixins:s,optionsCache:i,config:{optionMergeStrategies:a}}=n.appContext,l=i.get(e);let c;return l?c=l:!s.length&&!t&&!r?c=e:(c={},s.length&&s.forEach(h=>To(c,h,a,!0)),To(c,e,a)),Re(e)&&i.set(e,c),c}function To(n,e,t,r=!1){const{mixins:s,extends:i}=e;i&&To(n,i,t,!0),s&&s.forEach(a=>To(n,a,t,!0));for(const a in e)if(!(r&&a==="expose")){const l=fy[a]||t&&t[a];n[a]=l?l(n[a],e[a]):e[a]}return n}const fy={data:vh,props:Eh,emits:Eh,methods:Ns,computed:Ns,beforeCreate:dt,created:dt,beforeMount:dt,mounted:dt,beforeUpdate:dt,updated:dt,beforeDestroy:dt,beforeUnmount:dt,destroyed:dt,unmounted:dt,activated:dt,deactivated:dt,errorCaptured:dt,serverPrefetch:dt,components:Ns,directives:Ns,watch:py,provide:vh,inject:dy};function vh(n,e){return e?n?function(){return et(ce(n)?n.call(this,this):n,ce(e)?e.call(this,this):e)}:e:n}function dy(n,e){return Ns(Rl(n),Rl(e))}function Rl(n){if(ie(n)){const e={};for(let t=0;t<n.length;t++)e[n[t]]=n[t];return e}return n}function dt(n,e){return n?[...new Set([].concat(n,e))]:e}function Ns(n,e){return n?et(Object.create(null),n,e):e}function Eh(n,e){return n?ie(n)&&ie(e)?[...new Set([...n,...e])]:et(Object.create(null),_h(n),_h(e??{})):e}function py(n,e){if(!n)return e;if(!e)return n;const t=et(Object.create(null),n);for(const r in e)t[r]=dt(n[r],e[r]);return t}function Gd(){return{app:null,config:{isNativeTag:ud,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let gy=0;function my(n,e){return function(r,s=null){ce(r)||(r=et({},r)),s!=null&&!Re(s)&&(s=null);const i=Gd(),a=new WeakSet,l=[];let c=!1;const h=i.app={_uid:gy++,_component:r,_props:s,_container:null,_context:i,_instance:null,version:Gy,get config(){return i.config},set config(d){},use(d,...g){return a.has(d)||(d&&ce(d.install)?(a.add(d),d.install(h,...g)):ce(d)&&(a.add(d),d(h,...g))),h},mixin(d){return i.mixins.includes(d)||i.mixins.push(d),h},component(d,g){return g?(i.components[d]=g,h):i.components[d]},directive(d,g){return g?(i.directives[d]=g,h):i.directives[d]},mount(d,g,y){if(!c){const w=h._ceVNode||_n(r,s);return w.appContext=i,y===!0?y="svg":y===!1&&(y=void 0),n(w,d,y),c=!0,h._container=d,d.__vue_app__=h,ea(w.component)}},onUnmount(d){l.push(d)},unmount(){c&&(Mt(l,h._instance,16),n(null,h._container),delete h._container.__vue_app__)},provide(d,g){return i.provides[d]=g,h},runWithContext(d){const g=Br;Br=h;try{return d()}finally{Br=g}}};return h}}let Br=null;const _y=(n,e)=>e==="modelValue"||e==="model-value"?n.modelModifiers:n[`${e}Modifiers`]||n[`${Dt(e)}Modifiers`]||n[`${Gn(e)}Modifiers`];function yy(n,e,...t){if(n.isUnmounted)return;const r=n.vnode.props||Pe;let s=t;const i=e.startsWith("update:"),a=i&&_y(r,e.slice(7));a&&(a.trim&&(s=t.map(d=>Ne(d)?d.trim():d)),a.number&&(s=t.map(nc)));let l,c=r[l=ja(e)]||r[l=ja(Dt(e))];!c&&i&&(c=r[l=ja(Gn(e))]),c&&Mt(c,n,6,s);const h=r[l+"Once"];if(h){if(!n.emitted)n.emitted={};else if(n.emitted[l])return;n.emitted[l]=!0,Mt(h,n,6,s)}}const vy=new WeakMap;function Qd(n,e,t=!1){const r=t?vy:e.emitsCache,s=r.get(n);if(s!==void 0)return s;const i=n.emits;let a={},l=!1;if(!ce(n)){const c=h=>{const d=Qd(h,e,!0);d&&(l=!0,et(a,d))};!t&&e.mixins.length&&e.mixins.forEach(c),n.extends&&c(n.extends),n.mixins&&n.mixins.forEach(c)}return!i&&!l?(Re(n)&&r.set(n,null),null):(ie(i)?i.forEach(c=>a[c]=null):et(a,i),Re(n)&&r.set(n,a),a)}function Xo(n,e){return!n||!jo(e)?!1:(e=e.slice(2),e=e==="Once"?e:e.replace(/Once$/,""),Ie(n,e[0].toLowerCase()+e.slice(1))||Ie(n,Gn(e))||Ie(n,e))}function Th(n){const{type:e,vnode:t,proxy:r,withProxy:s,propsOptions:[i],slots:a,attrs:l,emit:c,render:h,renderCache:d,props:g,data:y,setupState:w,ctx:k,inheritAttrs:R}=n,P=vo(n);let U,B;try{if(t.shapeFlag&4){const z=s||r,fe=z;U=jt(h.call(fe,z,d,g,w,y,k)),B=l}else{const z=e;U=jt(z.length>1?z(g,{attrs:l,slots:a,emit:c}):z(g,null)),B=e.props?l:Ey(l)}}catch(z){zs.length=0,Go(z,n,1),U=_n(qn)}let Q=U;if(B&&R!==!1){const z=Object.keys(B),{shapeFlag:fe}=Q;z.length&&fe&7&&(i&&z.some(qo)&&(B=Ty(B,i)),Q=Gr(Q,B,!1,!0))}return t.dirs&&(Q=Gr(Q,null,!1,!0),Q.dirs=Q.dirs?Q.dirs.concat(t.dirs):t.dirs),t.transition&&dc(Q,t.transition),U=Q,vo(P),U}const Ey=n=>{let e;for(const t in n)(t==="class"||t==="style"||jo(t))&&((e||(e={}))[t]=n[t]);return e},Ty=(n,e)=>{const t={};for(const r in n)(!qo(r)||!(r.slice(9)in e))&&(t[r]=n[r]);return t};function wy(n,e,t){const{props:r,children:s,component:i}=n,{props:a,children:l,patchFlag:c}=e,h=i.emitsOptions;if(e.dirs||e.transition)return!0;if(t&&c>=0){if(c&1024)return!0;if(c&16)return r?wh(r,a,h):!!a;if(c&8){const d=e.dynamicProps;for(let g=0;g<d.length;g++){const y=d[g];if(Yd(a,r,y)&&!Xo(h,y))return!0}}}else return(s||l)&&(!l||!l.$stable)?!0:r===a?!1:r?a?wh(r,a,h):!0:!!a;return!1}function wh(n,e,t){const r=Object.keys(e);if(r.length!==Object.keys(n).length)return!0;for(let s=0;s<r.length;s++){const i=r[s];if(Yd(e,n,i)&&!Xo(t,i))return!0}return!1}function Yd(n,e,t){const r=n[t],s=e[t];return t==="style"&&Re(r)&&Re(s)?!rc(r,s):r!==s}function Iy({vnode:n,parent:e,suspense:t},r){for(;e;){const s=e.subTree;if(s.suspense&&s.suspense.activeBranch===n&&(s.suspense.vnode.el=s.el=r,n=s),s===n)(n=e.vnode).el=r,e=e.parent;else break}t&&t.activeBranch===n&&(t.vnode.el=r)}const Jd={},Xd=()=>Object.create(Jd),Zd=n=>Object.getPrototypeOf(n)===Jd;function Ay(n,e,t,r=!1){const s={},i=Xd();n.propsDefaults=Object.create(null),ep(n,e,s,i);for(const a in n.propsOptions[0])a in s||(s[a]=void 0);t?n.props=r?s:C_(s):n.type.props?n.props=s:n.props=i,n.attrs=i}function by(n,e,t,r){const{props:s,attrs:i,vnode:{patchFlag:a}}=n,l=we(s),[c]=n.propsOptions;let h=!1;if((r||a>0)&&!(a&16)){if(a&8){const d=n.vnode.dynamicProps;for(let g=0;g<d.length;g++){let y=d[g];if(Xo(n.emitsOptions,y))continue;const w=e[y];if(c)if(Ie(i,y))w!==i[y]&&(i[y]=w,h=!0);else{const k=Dt(y);s[k]=Sl(c,l,k,w,n,!1)}else w!==i[y]&&(i[y]=w,h=!0)}}}else{ep(n,e,s,i)&&(h=!0);let d;for(const g in l)(!e||!Ie(e,g)&&((d=Gn(g))===g||!Ie(e,d)))&&(c?t&&(t[g]!==void 0||t[d]!==void 0)&&(s[g]=Sl(c,l,g,void 0,n,!0)):delete s[g]);if(i!==l)for(const g in i)(!e||!Ie(e,g))&&(delete i[g],h=!0)}h&&un(n.attrs,"set","")}function ep(n,e,t,r){const[s,i]=n.propsOptions;let a=!1,l;if(e)for(let c in e){if($s(c))continue;const h=e[c];let d;s&&Ie(s,d=Dt(c))?!i||!i.includes(d)?t[d]=h:(l||(l={}))[d]=h:Xo(n.emitsOptions,c)||(!(c in r)||h!==r[c])&&(r[c]=h,a=!0)}if(i){const c=we(t),h=l||Pe;for(let d=0;d<i.length;d++){const g=i[d];t[g]=Sl(s,c,g,h[g],n,!Ie(h,g))}}return a}function Sl(n,e,t,r,s,i){const a=n[t];if(a!=null){const l=Ie(a,"default");if(l&&r===void 0){const c=a.default;if(a.type!==Function&&!a.skipFactory&&ce(c)){const{propsDefaults:h}=s;if(t in h)r=h[t];else{const d=_i(s);r=h[t]=c.call(null,e),d()}}else r=c;s.ce&&s.ce._setProp(t,r)}a[0]&&(i&&!l?r=!1:a[1]&&(r===""||r===Gn(t))&&(r=!0))}return r}const Ry=new WeakMap;function tp(n,e,t=!1){const r=t?Ry:e.propsCache,s=r.get(n);if(s)return s;const i=n.props,a={},l=[];let c=!1;if(!ce(n)){const d=g=>{c=!0;const[y,w]=tp(g,e,!0);et(a,y),w&&l.push(...w)};!t&&e.mixins.length&&e.mixins.forEach(d),n.extends&&d(n.extends),n.mixins&&n.mixins.forEach(d)}if(!i&&!c)return Re(n)&&r.set(n,xr),xr;if(ie(i))for(let d=0;d<i.length;d++){const g=Dt(i[d]);Ih(g)&&(a[g]=Pe)}else if(i)for(const d in i){const g=Dt(d);if(Ih(g)){const y=i[d],w=a[g]=ie(y)||ce(y)?{type:y}:et({},y),k=w.type;let R=!1,P=!0;if(ie(k))for(let U=0;U<k.length;++U){const B=k[U],Q=ce(B)&&B.name;if(Q==="Boolean"){R=!0;break}else Q==="String"&&(P=!1)}else R=ce(k)&&k.name==="Boolean";w[0]=R,w[1]=P,(R||Ie(w,"default"))&&l.push(g)}}const h=[a,l];return Re(n)&&r.set(n,h),h}function Ih(n){return n[0]!=="$"&&!$s(n)}const gc=n=>n==="_"||n==="_ctx"||n==="$stable",mc=n=>ie(n)?n.map(jt):[jt(n)],Sy=(n,e,t)=>{if(e._n)return e;const r=j_((...s)=>mc(e(...s)),t);return r._c=!1,r},np=(n,e,t)=>{const r=n._ctx;for(const s in n){if(gc(s))continue;const i=n[s];if(ce(i))e[s]=Sy(s,i,r);else if(i!=null){const a=mc(i);e[s]=()=>a}}},rp=(n,e)=>{const t=mc(e);n.slots.default=()=>t},sp=(n,e,t)=>{for(const r in e)(t||!gc(r))&&(n[r]=e[r])},Py=(n,e,t)=>{const r=n.slots=Xd();if(n.vnode.shapeFlag&32){const s=e._;s?(sp(r,e,t),t&&md(r,"_",s,!0)):np(e,r)}else e&&rp(n,e)},Cy=(n,e,t)=>{const{vnode:r,slots:s}=n;let i=!0,a=Pe;if(r.shapeFlag&32){const l=e._;l?t&&l===1?i=!1:sp(s,e,t):(i=!e.$stable,np(e,s)),a=e}else e&&(rp(n,e),a={default:1});if(i)for(const l in s)!gc(l)&&a[l]==null&&delete s[l]},pt=Oy;function ky(n){return Vy(n)}function Vy(n,e){const t=Ho();t.__VUE__=!0;const{insert:r,remove:s,patchProp:i,createElement:a,createText:l,createComment:c,setText:h,setElementText:d,parentNode:g,nextSibling:y,setScopeId:w=Ht,insertStaticContent:k}=n,R=(E,A,D,L=null,x=null,O=null,K=void 0,j=null,$=!!A.dynamicChildren)=>{if(E===A)return;E&&!Ss(E,A)&&(L=nn(E),je(E,x,O,!0),E=null),A.patchFlag===-2&&($=!1,A.dynamicChildren=null);const{type:M,ref:ee,shapeFlag:G}=A;switch(M){case Zo:P(E,A,D,L);break;case qn:U(E,A,D,L);break;case Ja:E==null&&B(A,D,L,K);break;case lt:S(E,A,D,L,x,O,K,j,$);break;default:G&1?fe(E,A,D,L,x,O,K,j,$):G&6?_(E,A,D,L,x,O,K,j,$):(G&64||G&128)&&M.process(E,A,D,L,x,O,K,j,$,Ft)}ee!=null&&x?Ws(ee,E&&E.ref,O,A||E,!A):ee==null&&E&&E.ref!=null&&Ws(E.ref,null,O,E,!0)},P=(E,A,D,L)=>{if(E==null)r(A.el=l(A.children),D,L);else{const x=A.el=E.el;A.children!==E.children&&h(x,A.children)}},U=(E,A,D,L)=>{E==null?r(A.el=c(A.children||""),D,L):A.el=E.el},B=(E,A,D,L)=>{[E.el,E.anchor]=k(E.children,A,D,L,E.el,E.anchor)},Q=({el:E,anchor:A},D,L)=>{let x;for(;E&&E!==A;)x=y(E),r(E,D,L),E=x;r(A,D,L)},z=({el:E,anchor:A})=>{let D;for(;E&&E!==A;)D=y(E),s(E),E=D;s(A)},fe=(E,A,D,L,x,O,K,j,$)=>{if(A.type==="svg"?K="svg":A.type==="math"&&(K="mathml"),E==null)he(A,D,L,x,O,K,j,$);else{const M=E.el&&E.el._isVueCE?E.el:null;try{M&&M._beginPatch(),v(E,A,x,O,K,j,$)}finally{M&&M._endPatch()}}},he=(E,A,D,L,x,O,K,j)=>{let $,M;const{props:ee,shapeFlag:G,transition:X,dirs:ne}=E;if($=E.el=a(E.type,O,ee&&ee.is,ee),G&8?d($,E.children):G&16&&m(E.children,$,null,L,x,Ya(E,O),K,j),ne&&sr(E,null,L,"created"),T($,E,E.scopeId,K,L),ee){for(const le in ee)le!=="value"&&!$s(le)&&i($,le,null,ee[le],O,L);"value"in ee&&i($,"value",null,ee.value,O),(M=ee.onVnodeBeforeMount)&&Ut(M,L,E)}ne&&sr(E,null,L,"beforeMount");const te=Dy(x,X);te&&X.beforeEnter($),r($,A,D),((M=ee&&ee.onVnodeMounted)||te||ne)&&pt(()=>{try{M&&Ut(M,L,E),te&&X.enter($),ne&&sr(E,null,L,"mounted")}finally{}},x)},T=(E,A,D,L,x)=>{if(D&&w(E,D),L)for(let O=0;O<L.length;O++)w(E,L[O]);if(x){let O=x.subTree;if(A===O||ap(O.type)&&(O.ssContent===A||O.ssFallback===A)){const K=x.vnode;T(E,K,K.scopeId,K.slotScopeIds,x.parent)}}},m=(E,A,D,L,x,O,K,j,$=0)=>{for(let M=$;M<E.length;M++){const ee=E[M]=j?cn(E[M]):jt(E[M]);R(null,ee,A,D,L,x,O,K,j)}},v=(E,A,D,L,x,O,K)=>{const j=A.el=E.el;let{patchFlag:$,dynamicChildren:M,dirs:ee}=A;$|=E.patchFlag&16;const G=E.props||Pe,X=A.props||Pe;let ne;if(D&&ir(D,!1),(ne=X.onVnodeBeforeUpdate)&&Ut(ne,D,A,E),ee&&sr(A,E,D,"beforeUpdate"),D&&ir(D,!0),M&&(!E.dynamicChildren||E.dynamicChildren.length!==M.length)&&($=0,K=!1,M=null),(G.innerHTML&&X.innerHTML==null||G.textContent&&X.textContent==null)&&d(j,""),M?I(E.dynamicChildren,M,j,D,L,Ya(A,x),O):K||ye(E,A,j,null,D,L,Ya(A,x),O,!1),$>0){if($&16)b(j,G,X,D,x);else if($&2&&G.class!==X.class&&i(j,"class",null,X.class,x),$&4&&i(j,"style",G.style,X.style,x),$&8){const te=A.dynamicProps;for(let le=0;le<te.length;le++){const _e=te[le],De=G[_e],Fe=X[_e];(Fe!==De||_e==="value")&&i(j,_e,De,Fe,x,D)}}$&1&&E.children!==A.children&&d(j,A.children)}else!K&&M==null&&b(j,G,X,D,x);((ne=X.onVnodeUpdated)||ee)&&pt(()=>{ne&&Ut(ne,D,A,E),ee&&sr(A,E,D,"updated")},L)},I=(E,A,D,L,x,O,K)=>{for(let j=0;j<A.length;j++){const $=E[j],M=A[j],ee=$.el&&($.type===lt||!Ss($,M)||$.shapeFlag&198)?g($.el):D;R($,M,ee,null,L,x,O,K,!0)}},b=(E,A,D,L,x)=>{if(A!==D){if(A!==Pe)for(const O in A)!$s(O)&&!(O in D)&&i(E,O,A[O],null,x,L);for(const O in D){if($s(O))continue;const K=D[O],j=A[O];K!==j&&O!=="value"&&i(E,O,j,K,x,L)}"value"in D&&i(E,"value",A.value,D.value,x)}},S=(E,A,D,L,x,O,K,j,$)=>{const M=A.el=E?E.el:l(""),ee=A.anchor=E?E.anchor:l("");let{patchFlag:G,dynamicChildren:X,slotScopeIds:ne}=A;ne&&(j=j?j.concat(ne):ne),E==null?(r(M,D,L),r(ee,D,L),m(A.children||[],D,ee,x,O,K,j,$)):G>0&&G&64&&X&&E.dynamicChildren&&E.dynamicChildren.length===X.length?(I(E.dynamicChildren,X,D,x,O,K,j),(A.key!=null||x&&A===x.subTree)&&_c(E,A,!0)):ye(E,A,D,ee,x,O,K,j,$)},_=(E,A,D,L,x,O,K,j,$)=>{A.slotScopeIds=j,E==null?A.shapeFlag&512?x.ctx.activate(A,D,L,K,$):Y(A,D,L,x,O,K,$):ue(E,A,$)},Y=(E,A,D,L,x,O,K)=>{const j=E.component=$y(E,L,x);if(Wd(E)&&(j.ctx.renderer=Ft),qy(j,!1,K),j.asyncDep){if(x&&x.registerDep(j,$e,K),!E.el){const $=j.subTree=_n(qn);U(null,$,A,D),E.placeholder=$.el}}else $e(j,E,A,D,x,O,K)},ue=(E,A,D)=>{const L=A.component=E.component;if(wy(E,A,D))if(L.asyncDep&&!L.asyncResolved){Ae(L,A,D);return}else L.next=A,L.update();else A.el=E.el,L.vnode=A},$e=(E,A,D,L,x,O,K)=>{const j=()=>{if(E.isMounted){let{next:G,bu:X,u:ne,parent:te,vnode:le}=E;{const nt=ip(E);if(nt){G&&(G.el=le.el,Ae(E,G,K)),nt.asyncDep.then(()=>{pt(()=>{E.isUnmounted||M()},x)});return}}let _e=G,De;ir(E,!1),G?(G.el=le.el,Ae(E,G,K)):G=le,X&&so(X),(De=G.props&&G.props.onVnodeBeforeUpdate)&&Ut(De,te,G,le),ir(E,!0);const Fe=Th(E),bt=E.subTree;E.subTree=Fe,R(bt,Fe,g(bt.el),nn(bt),E,x,O),G.el=Fe.el,_e===null&&Iy(E,Fe.el),ne&&pt(ne,x),(De=G.props&&G.props.onVnodeUpdated)&&pt(()=>Ut(De,te,G,le),x)}else{let G;const{el:X,props:ne}=A,{bm:te,m:le,parent:_e,root:De,type:Fe}=E,bt=Hs(A);ir(E,!1),te&&so(te),!bt&&(G=ne&&ne.onVnodeBeforeMount)&&Ut(G,_e,A),ir(E,!0);{De.ce&&De.ce._hasShadowRoot()&&De.ce._injectChildStyle(Fe,E.parent?E.parent.type:void 0);const nt=E.subTree=Th(E);R(null,nt,D,L,E,x,O),A.el=nt.el}if(le&&pt(le,x),!bt&&(G=ne&&ne.onVnodeMounted)){const nt=A;pt(()=>Ut(G,_e,nt),x)}(A.shapeFlag&256||_e&&Hs(_e.vnode)&&_e.vnode.shapeFlag&256)&&E.a&&pt(E.a,x),E.isMounted=!0,A=D=L=null}};E.scope.on();const $=E.effect=new Ed(j);E.scope.off();const M=E.update=$.run.bind($),ee=E.job=$.runIfDirty.bind($);ee.i=E,ee.id=E.uid,$.scheduler=()=>fc(ee),ir(E,!0),M()},Ae=(E,A,D)=>{A.component=E;const L=E.vnode.props;E.vnode=A,E.next=null,by(E,A.props,L,D),Cy(E,A.children,D),Jt(),fh(E),Xt()},ye=(E,A,D,L,x,O,K,j,$=!1)=>{const M=E&&E.children,ee=E?E.shapeFlag:0,G=A.children,{patchFlag:X,shapeFlag:ne}=A;if(X>0){if(X&128){Jn(M,G,D,L,x,O,K,j,$);return}else if(X&256){kt(M,G,D,L,x,O,K,j,$);return}}ne&8?(ee&16&&Zn(M,x,O),G!==M&&d(D,G)):ee&16?ne&16?Jn(M,G,D,L,x,O,K,j,$):Zn(M,x,O,!0):(ee&8&&d(D,""),ne&16&&m(G,D,L,x,O,K,j,$))},kt=(E,A,D,L,x,O,K,j,$)=>{E=E||xr,A=A||xr;const M=E.length,ee=A.length,G=Math.min(M,ee);let X;for(X=0;X<G;X++){const ne=A[X]=$?cn(A[X]):jt(A[X]);R(E[X],ne,D,null,x,O,K,j,$)}M>ee?Zn(E,x,O,!0,!1,G):m(A,D,L,x,O,K,j,$,G)},Jn=(E,A,D,L,x,O,K,j,$)=>{let M=0;const ee=A.length;let G=E.length-1,X=ee-1;for(;M<=G&&M<=X;){const ne=E[M],te=A[M]=$?cn(A[M]):jt(A[M]);if(Ss(ne,te))R(ne,te,D,null,x,O,K,j,$);else break;M++}for(;M<=G&&M<=X;){const ne=E[G],te=A[X]=$?cn(A[X]):jt(A[X]);if(Ss(ne,te))R(ne,te,D,null,x,O,K,j,$);else break;G--,X--}if(M>G){if(M<=X){const ne=X+1,te=ne<ee?A[ne].el:L;for(;M<=X;)R(null,A[M]=$?cn(A[M]):jt(A[M]),D,te,x,O,K,j,$),M++}}else if(M>X)for(;M<=G;)je(E[M],x,O,!0),M++;else{const ne=M,te=M,le=new Map;for(M=te;M<=X;M++){const Ge=A[M]=$?cn(A[M]):jt(A[M]);Ge.key!=null&&le.set(Ge.key,M)}let _e,De=0;const Fe=X-te+1;let bt=!1,nt=0;const Rn=new Array(Fe);for(M=0;M<Fe;M++)Rn[M]=0;for(M=ne;M<=G;M++){const Ge=E[M];if(De>=Fe){je(Ge,x,O,!0);continue}let Rt;if(Ge.key!=null)Rt=le.get(Ge.key);else for(_e=te;_e<=X;_e++)if(Rn[_e-te]===0&&Ss(Ge,A[_e])){Rt=_e;break}Rt===void 0?je(Ge,x,O,!0):(Rn[Rt-te]=M+1,Rt>=nt?nt=Rt:bt=!0,R(Ge,A[Rt],D,null,x,O,K,j,$),De++)}const ds=bt?Ny(Rn):xr;for(_e=ds.length-1,M=Fe-1;M>=0;M--){const Ge=te+M,Rt=A[Ge],Di=A[Ge+1],Ar=Ge+1<ee?Di.el||op(Di):L;Rn[M]===0?R(null,Rt,D,Ar,x,O,K,j,$):bt&&(_e<0||M!==ds[_e]?tn(Rt,D,Ar,2):_e--)}}},tn=(E,A,D,L,x=null)=>{const{el:O,type:K,transition:j,children:$,shapeFlag:M}=E;if(M&6){tn(E.component.subTree,A,D,L);return}if(M&128){E.suspense.move(A,D,L);return}if(M&64){K.move(E,A,D,Ft);return}if(K===lt){r(O,A,D);for(let G=0;G<$.length;G++)tn($[G],A,D,L);r(E.anchor,A,D);return}if(K===Ja){Q(E,A,D);return}if(L!==2&&M&1&&j)if(L===0)j.persisted&&!O[Ga]?r(O,A,D):(j.beforeEnter(O),r(O,A,D),pt(()=>j.enter(O),x));else{const{leave:G,delayLeave:X,afterLeave:ne}=j,te=()=>{E.ctx.isUnmounted?s(O):r(O,A,D)},le=()=>{const _e=O._isLeaving||!!O[Ga];O._isLeaving&&O[Ga](!0),j.persisted&&!_e?te():G(O,()=>{te(),ne&&ne()})};X?X(O,te,le):le()}else r(O,A,D)},je=(E,A,D,L=!1,x=!1)=>{const{type:O,props:K,ref:j,children:$,dynamicChildren:M,shapeFlag:ee,patchFlag:G,dirs:X,cacheIndex:ne,memo:te}=E;if(G===-2&&(x=!1),j!=null&&(Jt(),Ws(j,null,D,E,!0),Xt()),ne!=null&&(A.renderCache[ne]=void 0),ee&256){A.ctx.deactivate(E);return}const le=ee&1&&X,_e=!Hs(E);let De;if(_e&&(De=K&&K.onVnodeBeforeUnmount)&&Ut(De,A,E),ee&6)Xn(E.component,D,L);else{if(ee&128){E.suspense.unmount(D,L);return}le&&sr(E,null,A,"beforeUnmount"),ee&64?E.type.remove(E,A,D,Ft,L):M&&!M.hasOnce&&(O!==lt||G>0&&G&64)?Zn(M,A,D,!1,!0):(O===lt&&G&384||!x&&ee&16)&&Zn($,A,D),L&&qe(E)}const Fe=te!=null&&ne==null;(_e&&(De=K&&K.onVnodeUnmounted)||le||Fe)&&pt(()=>{De&&Ut(De,A,E),le&&sr(E,null,A,"unmounted"),Fe&&(E.el=null)},D)},qe=E=>{const{type:A,el:D,anchor:L,transition:x}=E;if(A===lt){Sa(D,L);return}if(A===Ja){z(E);return}const O=()=>{s(D),x&&!x.persisted&&x.afterLeave&&x.afterLeave()};if(E.shapeFlag&1&&x&&!x.persisted){const{leave:K,delayLeave:j}=x,$=()=>K(D,O);j?j(E.el,O,$):$()}else O()},Sa=(E,A)=>{let D;for(;E!==A;)D=y(E),s(E),E=D;s(A)},Xn=(E,A,D)=>{const{bum:L,scope:x,job:O,subTree:K,um:j,m:$,a:M}=E;Ah($),Ah(M),L&&so(L),x.stop(),O&&(O.flags|=8,je(K,E,A,D)),j&&pt(j,A),pt(()=>{E.isUnmounted=!0},A)},Zn=(E,A,D,L=!1,x=!1,O=0)=>{for(let K=O;K<E.length;K++)je(E[K],A,D,L,x)},nn=E=>{if(E.shapeFlag&6)return nn(E.component.subTree);if(E.shapeFlag&128)return E.suspense.next();const A=y(E.anchor||E.el),D=A&&A[jd];return D?y(D):A};let hs=!1;const Vi=(E,A,D)=>{let L;E==null?A._vnode&&(je(A._vnode,null,null,!0),L=A._vnode.component):R(A._vnode||null,E,A,null,null,null,D),A._vnode=E,hs||(hs=!0,fh(L),Ld(),hs=!1)},Ft={p:R,um:je,m:tn,r:qe,mt:Y,mc:m,pc:ye,pbc:I,n:nn,o:n};return{render:Vi,hydrate:void 0,createApp:my(Vi)}}function Ya({type:n,props:e},t){return t==="svg"&&n==="foreignObject"||t==="mathml"&&n==="annotation-xml"&&e&&e.encoding&&e.encoding.includes("html")?void 0:t}function ir({effect:n,job:e},t){t?(n.flags|=32,e.flags|=4):(n.flags&=-33,e.flags&=-5)}function Dy(n,e){return(!n||n&&!n.pendingBranch)&&e&&!e.persisted}function _c(n,e,t=!1){const r=n.children,s=e.children;if(ie(r)&&ie(s))for(let i=0;i<r.length;i++){const a=r[i];let l=s[i];l.shapeFlag&1&&!l.dynamicChildren&&((l.patchFlag<=0||l.patchFlag===32)&&(l=s[i]=cn(s[i]),l.el=a.el),!t&&l.patchFlag!==-2&&_c(a,l)),l.type===Zo&&(l.patchFlag===-1&&(l=s[i]=cn(l)),l.el=a.el),l.type===qn&&!l.el&&(l.el=a.el)}}function Ny(n){const e=n.slice(),t=[0];let r,s,i,a,l;const c=n.length;for(r=0;r<c;r++){const h=n[r];if(h!==0){if(s=t[t.length-1],n[s]<h){e[r]=s,t.push(r);continue}for(i=0,a=t.length-1;i<a;)l=i+a>>1,n[t[l]]<h?i=l+1:a=l;h<n[t[i]]&&(i>0&&(e[r]=t[i-1]),t[i]=r)}}for(i=t.length,a=t[i-1];i-- >0;)t[i]=a,a=e[a];return t}function ip(n){const e=n.subTree.component;if(e)return e.asyncDep&&!e.asyncResolved?e:ip(e)}function Ah(n){if(n)for(let e=0;e<n.length;e++)n[e].flags|=8}function op(n){if(n.placeholder)return n.placeholder;const e=n.component;return e?op(e.subTree):null}const ap=n=>n.__isSuspense;function Oy(n,e){e&&e.pendingBranch?ie(n)?e.effects.push(...n):e.effects.push(n):$_(n)}const lt=Symbol.for("v-fgt"),Zo=Symbol.for("v-txt"),qn=Symbol.for("v-cmt"),Ja=Symbol.for("v-stc"),zs=[];let Tt=null;function de(n=!1){zs.push(Tt=n?null:[])}function My(){zs.pop(),Tt=zs[zs.length-1]||null}let ni=1;function bh(n,e=!1){ni+=n,n<0&&Tt&&e&&(Tt.hasOnce=!0)}function lp(n){return n.dynamicChildren=ni>0?Tt||xr:null,My(),ni>0&&Tt&&Tt.push(n),n}function Te(n,e,t,r,s,i){return lp(q(n,e,t,r,s,i,!0))}function Gs(n,e,t,r,s){return lp(_n(n,e,t,r,s,!0))}function cp(n){return n?n.__v_isVNode===!0:!1}function Ss(n,e){return n.type===e.type&&n.key===e.key}const up=({key:n})=>n??null,oo=({ref:n,ref_key:e,ref_for:t})=>(typeof n=="number"&&(n=""+n),n!=null?Ne(n)||ut(n)||ce(n)?{i:St,r:n,k:e,f:!!t}:n:null);function q(n,e=null,t=null,r=0,s=null,i=n===lt?0:1,a=!1,l=!1){const c={__v_isVNode:!0,__v_skip:!0,type:n,props:e,key:e&&up(e),ref:e&&oo(e),scopeId:Ud,slotScopeIds:null,children:t,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:i,patchFlag:r,dynamicProps:s,dynamicChildren:null,appContext:null,ctx:St};return l?(wo(c,t),i&128&&n.normalize(c)):t&&(c.shapeFlag|=Ne(t)?8:16),ni>0&&!a&&Tt&&(c.patchFlag>0||i&6)&&c.patchFlag!==32&&Tt.push(c),c}const _n=xy;function xy(n,e=null,t=null,r=0,s=null,i=!1){if((!n||n===ly)&&(n=qn),cp(n)){const l=Gr(n,e,!0);return t&&wo(l,t),ni>0&&!i&&Tt&&(l.shapeFlag&6?Tt[Tt.indexOf(n)]=l:Tt.push(l)),l.patchFlag=-2,l}if(zy(n)&&(n=n.__vccOpts),e){e=Ly(e);let{class:l,style:c}=e;l&&!Ne(l)&&(e.class=mn(l)),Re(c)&&(hc(c)&&!ie(c)&&(c=et({},c)),e.style=Ko(c))}const a=Ne(n)?1:ap(n)?128:K_(n)?64:Re(n)?4:ce(n)?2:0;return q(n,e,t,r,s,a,i,!0)}function Ly(n){return n?hc(n)||Zd(n)?et({},n):n:null}function Gr(n,e,t=!1,r=!1){const{props:s,ref:i,patchFlag:a,children:l,transition:c}=n,h=e?Fy(s||{},e):s,d={__v_isVNode:!0,__v_skip:!0,type:n.type,props:h,key:h&&up(h),ref:e&&e.ref?t&&i?ie(i)?i.concat(oo(e)):[i,oo(e)]:oo(e):i,scopeId:n.scopeId,slotScopeIds:n.slotScopeIds,children:l,target:n.target,targetStart:n.targetStart,targetAnchor:n.targetAnchor,staticCount:n.staticCount,shapeFlag:n.shapeFlag,patchFlag:e&&n.type!==lt?a===-1?16:a|16:a,dynamicProps:n.dynamicProps,dynamicChildren:n.dynamicChildren,appContext:n.appContext,dirs:n.dirs,transition:c,component:n.component,suspense:n.suspense,ssContent:n.ssContent&&Gr(n.ssContent),ssFallback:n.ssFallback&&Gr(n.ssFallback),placeholder:n.placeholder,el:n.el,anchor:n.anchor,ctx:n.ctx,ce:n.ce};return c&&r&&dc(d,c.clone(d)),d}function hp(n=" ",e=0){return _n(Zo,null,n,e)}function Wt(n="",e=!1){return e?(de(),Gs(qn,null,n)):_n(qn,null,n)}function jt(n){return n==null||typeof n=="boolean"?_n(qn):ie(n)?_n(lt,null,n.slice()):cp(n)?cn(n):_n(Zo,null,String(n))}function cn(n){return n.el===null&&n.patchFlag!==-1||n.memo?n:Gr(n)}function wo(n,e){let t=0;const{shapeFlag:r}=n;if(e==null)e=null;else if(ie(e))t=16;else if(typeof e=="object")if(r&65){const s=e.default;s&&(s._c&&(s._d=!1),wo(n,s()),s._c&&(s._d=!0));return}else{t=32;const s=e._;!s&&!Zd(e)?e._ctx=St:s===3&&St&&(St.slots._===1?e._=1:(e._=2,n.patchFlag|=1024))}else if(ce(e)){if(r&65){wo(n,{default:e});return}e={default:e,_ctx:St},t=32}else e=String(e),r&64?(t=16,e=[hp(e)]):t=8;n.children=e,n.shapeFlag|=t}function Fy(...n){const e={};for(let t=0;t<n.length;t++){const r=n[t];for(const s in r)if(s==="class")e.class!==r.class&&(e.class=mn([e.class,r.class]));else if(s==="style")e.style=Ko([e.style,r.style]);else if(jo(s)){const i=e[s],a=r[s];a&&i!==a&&!(ie(i)&&i.includes(a))?e[s]=i?[].concat(i,a):a:a==null&&i==null&&!qo(s)&&(e[s]=a)}else s!==""&&(e[s]=r[s])}return e}function Ut(n,e,t,r=null){Mt(n,e,7,[t,r])}const Uy=Gd();let By=0;function $y(n,e,t){const r=n.type,s=(e?e.appContext:n.appContext)||Uy,i={uid:By++,vnode:n,type:r,parent:e,appContext:s,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new u_(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(s.provides),ids:e?e.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:tp(r,s),emitsOptions:Qd(r,s),emit:null,emitted:null,propsDefaults:Pe,inheritAttrs:r.inheritAttrs,ctx:Pe,data:Pe,props:Pe,attrs:Pe,slots:Pe,refs:Pe,setupState:Pe,setupContext:null,suspense:t,suspenseId:t?t.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return i.ctx={_:i},i.root=e?e.root:i,i.emit=yy.bind(null,i),n.ce&&n.ce(i),i}let mt=null;const jy=()=>mt||St;let Io,Pl;{const n=Ho(),e=(t,r)=>{let s;return(s=n[t])||(s=n[t]=[]),s.push(r),i=>{s.length>1?s.forEach(a=>a(i)):s[0](i)}};Io=e("__VUE_INSTANCE_SETTERS__",t=>mt=t),Pl=e("__VUE_SSR_SETTERS__",t=>ri=t)}const _i=n=>{const e=mt;return Io(n),n.scope.on(),()=>{n.scope.off(),Io(e)}},Rh=()=>{mt&&mt.scope.off(),Io(null)};function fp(n){return n.vnode.shapeFlag&4}let ri=!1;function qy(n,e=!1,t=!1){e&&Pl(e);const{props:r,children:s}=n.vnode,i=fp(n);Ay(n,r,i,e),Py(n,s,t||e);const a=i?Wy(n,e):void 0;return e&&Pl(!1),a}function Wy(n,e){const t=n.type;n.accessCache=Object.create(null),n.proxy=new Proxy(n.ctx,cy);const{setup:r}=t;if(r){Jt();const s=n.setupContext=r.length>1?Ky(n):null,i=_i(n),a=mi(r,n,0,[n.props,s]),l=fd(a);if(Xt(),i(),(l||n.sp)&&!Hs(n)&&qd(n),l){if(a.then(Rh,Rh),e)return a.then(c=>{Sh(n,c)}).catch(c=>{Go(c,n,0)});n.asyncDep=a}else Sh(n,a)}else dp(n)}function Sh(n,e,t){ce(e)?n.type.__ssrInlineRender?n.ssrRender=e:n.render=e:Re(e)&&(n.setupState=Od(e)),dp(n)}function dp(n,e,t){const r=n.type;n.render||(n.render=r.render||Ht);{const s=_i(n);Jt();try{uy(n)}finally{Xt(),s()}}}const Hy={get(n,e){return at(n,"get",""),n[e]}};function Ky(n){const e=t=>{n.exposed=t||{}};return{attrs:new Proxy(n.attrs,Hy),slots:n.slots,emit:n.emit,expose:e}}function ea(n){return n.exposed?n.exposeProxy||(n.exposeProxy=new Proxy(Od(k_(n.exposed)),{get(e,t){if(t in e)return e[t];if(t in Ks)return Ks[t](n)},has(e,t){return t in e||t in Ks}})):n.proxy}function zy(n){return ce(n)&&"__vccOpts"in n}const pp=(n,e)=>M_(n,e,ri),Gy="3.5.39";/**
* @vue/runtime-dom v3.5.39
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let Cl;const Ph=typeof window<"u"&&window.trustedTypes;if(Ph)try{Cl=Ph.createPolicy("vue",{createHTML:n=>n})}catch{}const gp=Cl?n=>Cl.createHTML(n):n=>n,Qy="http://www.w3.org/2000/svg",Yy="http://www.w3.org/1998/Math/MathML",an=typeof document<"u"?document:null,Ch=an&&an.createElement("template"),Jy={insert:(n,e,t)=>{e.insertBefore(n,t||null)},remove:n=>{const e=n.parentNode;e&&e.removeChild(n)},createElement:(n,e,t,r)=>{const s=e==="svg"?an.createElementNS(Qy,n):e==="mathml"?an.createElementNS(Yy,n):t?an.createElement(n,{is:t}):an.createElement(n);return n==="select"&&r&&r.multiple!=null&&s.setAttribute("multiple",r.multiple),s},createText:n=>an.createTextNode(n),createComment:n=>an.createComment(n),setText:(n,e)=>{n.nodeValue=e},setElementText:(n,e)=>{n.textContent=e},parentNode:n=>n.parentNode,nextSibling:n=>n.nextSibling,querySelector:n=>an.querySelector(n),setScopeId(n,e){n.setAttribute(e,"")},insertStaticContent(n,e,t,r,s,i){const a=t?t.previousSibling:e.lastChild;if(s&&(s===i||s.nextSibling))for(;e.insertBefore(s.cloneNode(!0),t),!(s===i||!(s=s.nextSibling)););else{Ch.innerHTML=gp(r==="svg"?`<svg>${n}</svg>`:r==="mathml"?`<math>${n}</math>`:n);const l=Ch.content;if(r==="svg"||r==="mathml"){const c=l.firstChild;for(;c.firstChild;)l.appendChild(c.firstChild);l.removeChild(c)}e.insertBefore(l,t)}return[a?a.nextSibling:e.firstChild,t?t.previousSibling:e.lastChild]}},Xy=Symbol("_vtc");function Zy(n,e,t){const r=n[Xy];r&&(e=(e?[e,...r]:[...r]).join(" ")),e==null?n.removeAttribute("class"):t?n.setAttribute("class",e):n.className=e}const Ao=Symbol("_vod"),mp=Symbol("_vsh"),Xa={name:"show",beforeMount(n,{value:e},{transition:t}){n[Ao]=n.style.display==="none"?"":n.style.display,t&&e?t.beforeEnter(n):Ps(n,e)},mounted(n,{value:e},{transition:t}){t&&e&&t.enter(n)},updated(n,{value:e,oldValue:t},{transition:r}){!e!=!t&&(r?e?(r.beforeEnter(n),Ps(n,!0),r.enter(n)):r.leave(n,()=>{Ps(n,!1)}):Ps(n,e))},beforeUnmount(n,{value:e}){Ps(n,e)}};function Ps(n,e){n.style.display=e?n[Ao]:"none",n[mp]=!e}const ev=Symbol(""),tv=/(?:^|;)\s*display\s*:/;function nv(n,e,t){const r=n.style,s=Ne(t);let i=!1;if(t&&!s){if(e)if(Ne(e))for(const a of e.split(";")){const l=a.slice(0,a.indexOf(":")).trim();t[l]==null&&Os(r,l,"")}else for(const a in e)t[a]==null&&Os(r,a,"");for(const a in t){a==="display"&&(i=!0);const l=t[a];l!=null?sv(n,a,!Ne(e)&&e?e[a]:void 0,l)||Os(r,a,l):Os(r,a,"")}}else if(s){if(e!==t){const a=r[ev];a&&(t+=";"+a),r.cssText=t,i=tv.test(t)}}else e&&n.removeAttribute("style");Ao in n&&(n[Ao]=i?r.display:"",n[mp]&&(r.display="none"))}const kh=/\s*!important$/;function Os(n,e,t){if(ie(t))t.forEach(r=>Os(n,e,r));else if(t==null&&(t=""),e.startsWith("--"))n.setProperty(e,t);else{const r=rv(n,e);kh.test(t)?n.setProperty(Gn(r),t.replace(kh,""),"important"):n[r]=t}}const Vh=["Webkit","Moz","ms"],Za={};function rv(n,e){const t=Za[e];if(t)return t;let r=Dt(e);if(r!=="filter"&&r in n)return Za[e]=r;r=gd(r);for(let s=0;s<Vh.length;s++){const i=Vh[s]+r;if(i in n)return Za[e]=i}return e}function sv(n,e,t,r){return n.tagName==="TEXTAREA"&&(e==="width"||e==="height")&&Ne(r)&&t===r}const Dh="http://www.w3.org/1999/xlink";function Nh(n,e,t,r,s,i=l_(e)){r&&e.startsWith("xlink:")?t==null?n.removeAttributeNS(Dh,e.slice(6,e.length)):n.setAttributeNS(Dh,e,t):t==null||i&&!_d(t)?n.removeAttribute(e):n.setAttribute(e,i?"":Yt(t)?String(t):t)}function Oh(n,e,t,r,s){if(e==="innerHTML"||e==="textContent"){t!=null&&(n[e]=e==="innerHTML"?gp(t):t);return}const i=n.tagName;if(e==="value"&&i!=="PROGRESS"&&!i.includes("-")){const l=i==="OPTION"?n.getAttribute("value")||"":n.value,c=t==null?n.type==="checkbox"?"on":"":String(t);(l!==c||!("_value"in n))&&(n.value=c),t==null&&n.removeAttribute(e),n._value=t;return}let a=!1;if(t===""||t==null){const l=typeof n[e];l==="boolean"?t=_d(t):t==null&&l==="string"?(t="",a=!0):l==="number"&&(t=0,a=!0)}try{n[e]=t}catch{}a&&n.removeAttribute(s||e)}function Vr(n,e,t,r){n.addEventListener(e,t,r)}function iv(n,e,t,r){n.removeEventListener(e,t,r)}const Mh=Symbol("_vei");function ov(n,e,t,r,s=null){const i=n[Mh]||(n[Mh]={}),a=i[e];if(r&&a)a.value=r;else{const[l,c]=cv(e);if(r){const h=i[e]=fv(r,s);Vr(n,l,h,c)}else a&&(iv(n,l,a,c),i[e]=void 0)}}const av=/(Once|Passive|Capture)$/,lv=/^on:?(?:Once|Passive|Capture)$/;function cv(n){let e,t;for(;(t=n.match(av))&&!lv.test(n);)e||(e={}),n=n.slice(0,n.length-t[1].length),e[t[1].toLowerCase()]=!0;return[n[2]===":"?n.slice(3):Gn(n.slice(2)),e]}let el=0;const uv=Promise.resolve(),hv=()=>el||(uv.then(()=>el=0),el=Date.now());function fv(n,e){const t=r=>{if(!r._vts)r._vts=Date.now();else if(r._vts<=t.attached)return;const s=t.value;if(ie(s)){const i=r.stopImmediatePropagation;r.stopImmediatePropagation=()=>{i.call(r),r._stopped=!0};const a=s.slice(),l=[r];for(let c=0;c<a.length&&!r._stopped;c++){const h=a[c];h&&Mt(h,e,5,l)}}else Mt(s,e,5,[r])};return t.value=n,t.attached=hv(),t}const xh=n=>n.charCodeAt(0)===111&&n.charCodeAt(1)===110&&n.charCodeAt(2)>96&&n.charCodeAt(2)<123,dv=(n,e,t,r,s,i)=>{const a=s==="svg";e==="class"?Zy(n,r,a):e==="style"?nv(n,t,r):jo(e)?qo(e)||ov(n,e,t,r,i):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):pv(n,e,r,a))?(Oh(n,e,r),!n.tagName.includes("-")&&(e==="value"||e==="checked"||e==="selected")&&Nh(n,e,r,a,i,e!=="value")):n._isVueCE&&(gv(n,e)||n._def.__asyncLoader&&(/[A-Z]/.test(e)||!Ne(r)))?Oh(n,Dt(e),r,i,e):(e==="true-value"?n._trueValue=r:e==="false-value"&&(n._falseValue=r),Nh(n,e,r,a))};function pv(n,e,t,r){if(r)return!!(e==="innerHTML"||e==="textContent"||e in n&&xh(e)&&ce(t));if(e==="spellcheck"||e==="draggable"||e==="translate"||e==="autocorrect"||e==="sandbox"&&n.tagName==="IFRAME"||e==="form"||e==="list"&&n.tagName==="INPUT"||e==="type"&&n.tagName==="TEXTAREA")return!1;if(e==="width"||e==="height"){const s=n.tagName;if(s==="IMG"||s==="VIDEO"||s==="CANVAS"||s==="SOURCE")return!1}return xh(e)&&Ne(t)?!1:e in n}function gv(n,e){const t=n._def.props;if(!t)return!1;const r=Dt(e);return Array.isArray(t)?t.some(s=>Dt(s)===r):Object.keys(t).some(s=>Dt(s)===r)}const Lh=n=>{const e=n.props["onUpdate:modelValue"]||!1;return ie(e)?t=>so(e,t):e};function mv(n){n.target.composing=!0}function Fh(n){const e=n.target;e.composing&&(e.composing=!1,e.dispatchEvent(new Event("input")))}const tl=Symbol("_assign");function Uh(n,e,t){return e&&(n=n.trim()),t&&(n=nc(n)),n}const $r={created(n,{modifiers:{lazy:e,trim:t,number:r}},s){n[tl]=Lh(s);const i=r||s.props&&s.props.type==="number";Vr(n,e?"change":"input",a=>{a.target.composing||n[tl](Uh(n.value,t,i))}),(t||i)&&Vr(n,"change",()=>{n.value=Uh(n.value,t,i)}),e||(Vr(n,"compositionstart",mv),Vr(n,"compositionend",Fh),Vr(n,"change",Fh))},mounted(n,{value:e}){n.value=e??""},beforeUpdate(n,{value:e,oldValue:t,modifiers:{lazy:r,trim:s,number:i}},a){if(n[tl]=Lh(a),n.composing)return;const l=(i||n.type==="number")&&!/^0\d/.test(n.value)?nc(n.value):n.value,c=e??"";if(l===c)return;const h=n.getRootNode();(h instanceof Document||h instanceof ShadowRoot)&&h.activeElement===n&&n.type!=="range"&&(r&&e===t||s&&n.value.trim()===c)||(n.value=c)}},_v=["ctrl","shift","alt","meta"],yv={stop:n=>n.stopPropagation(),prevent:n=>n.preventDefault(),self:n=>n.target!==n.currentTarget,ctrl:n=>!n.ctrlKey,shift:n=>!n.shiftKey,alt:n=>!n.altKey,meta:n=>!n.metaKey,left:n=>"button"in n&&n.button!==0,middle:n=>"button"in n&&n.button!==1,right:n=>"button"in n&&n.button!==2,exact:(n,e)=>_v.some(t=>n[`${t}Key`]&&!e.includes(t))},yc=(n,e)=>{if(!n)return n;const t=n._withMods||(n._withMods={}),r=e.join(".");return t[r]||(t[r]=(s,...i)=>{for(let a=0;a<e.length;a++){const l=yv[e[a]];if(l&&l(s,e))return}return n(s,...i)})},vv={esc:"escape",space:" ",up:"arrow-up",left:"arrow-left",right:"arrow-right",down:"arrow-down",delete:"backspace"},Bh=(n,e)=>{const t=n._withKeys||(n._withKeys={}),r=e.join(".");return t[r]||(t[r]=s=>{if(!("key"in s))return;const i=Gn(s.key);if(e.some(a=>a===i||vv[a]===i))return n(s)})},Ev=et({patchProp:dv},Jy);let $h;function Tv(){return $h||($h=ky(Ev))}const wv=(...n)=>{const e=Tv().createApp(...n),{mount:t}=e;return e.mount=r=>{const s=Av(r);if(!s)return;const i=e._component;!ce(i)&&!i.render&&!i.template&&(i.template=s.innerHTML),s.nodeType===1&&(s.textContent="");const a=t(s,!1,Iv(s));return s instanceof Element&&(s.removeAttribute("v-cloak"),s.setAttribute("data-v-app","")),a},e};function Iv(n){if(n instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&n instanceof MathMLElement)return"mathml"}function Av(n){return Ne(n)?document.querySelector(n):n}var jh={};/**
 * @license
 ...
 */const _p=function(n){const e=[];let t=0;for(let r=0;r<n.length;r++){let s=n.charCodeAt(r);s<128?e[t++]=s:s<2048?(e[t++]=s>>6|192,e[t++]=s&63|128):(s&64512)===55296&&r+1<n.length&&(n.charCodeAt(r+1)&64512)===56320?(s=65536+((s&1023)<<10)+(n.charCodeAt(++r)&1023),e[t++]=s>>18|240,e[t++]=s>>12&63|128,e[t++]=s>>6&63|128,e[t++]=s&63|128):(e[t++]=s>>12|224,e[t++]=s>>6&63|128,e[t++]=s&63|128)}return e},bv=function(n){const e=[];let t=0,r=0;for(;t<n.length;){const s=n[t++];if(s<128)e[r++]=String.fromCharCode(s);else if(s>191&&s<224){const i=n[t++];e[r++]=String.fromCharCode((s&31)<<6|i&63)}else if(s>239&&s<365){const i=n[t++],a=n[t++],l=n[t++],c=((s&7)<<18|(i&63)<<12|(a&63)<<6|l&63)-65536;e[r++]=String.fromCharCode(55296+(c>>10)),e[r++]=String.fromCharCode(56320+(c&1023))}else{const i=n[t++],a=n[t++];e[r++]=String.fromCharCode((s&15)<<12|(i&63)<<6|a&63)}}return e.join("")},yp={byteToCharMap_:null,charToByteMap_:null,byteToCharMapWebSafe_:null,charToByteMapWebSafe_:null,ENCODED_VALS_BASE:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",get ENCODED_VALS(){return this.ENCODED_VALS_BASE+"+/="},get ENCODED_VALS_WEBSAFE(){return this.ENCODED_VALS_BASE+"-_."},HAS_NATIVE_SUPPORT:typeof atob=="function",encodeByteArray(n,e){if(!Array.isArray(n))throw Error("encodeByteArray takes an array as a parameter");this.init_();const t=e?this.byteToCharMapWebSafe_:this.byteToCharMap_,r=[];for(let s=0;s<n.length;s+=3){const i=n[s],a=s+1<n.length,l=a?n[s+1]:0,c=s+2<n.length,h=c?n[s+2]:0,d=i>>2,g=(i&3)<<4|l>>4;let y=(l&15)<<2|h>>6,w=h&63;c||(w=64,a||(y=64)),r.push(t[d],t[g],t[y],t[w])}return r.join("")},encodeString(n,e){return this.HAS_NATIVE_SUPPORT&&!e?btoa(n):this.encodeByteArray(_p(n),e)},decodeString(n,e){return this.HAS_NATIVE_SUPPORT&&!e?atob(n):bv(this.decodeStringToByteArray(n,e))},decodeStringToByteArray(n,e){this.init_();const t=e?this.charToByteMapWebSafe_:this.charToByteMap_,r=[];for(let s=0;s<n.length;){const i=t[n.charAt(s++)],l=s<n.length?t[n.charAt(s)]:0;++s;const h=s<n.length?t[n.charAt(s)]:64;++s;const g=s<n.length?t[n.charAt(s)]:64;if(++s,i==null||l==null||h==null||g==null)throw new Rv;const y=i<<2|l>>4;if(r.push(y),h!==64){const w=l<<4&240|h>>2;if(r.push(w),g!==64){const k=h<<6&192|g;r.push(k)}}}return r},init_(){if(!this.byteToCharMap_){this.byteToCharMap_={},this.charToByteMap_={},this.byteToCharMapWebSafe_={},this.charToByteMapWebSafe_={};for(let n=0;n<this.ENCODED_VALS.length;n++)this.byteToCharMap_[n]=this.ENCODED_VALS.charAt(n),this.charToByteMap_[this.byteToCharMap_[n]]=n,this.byteToCharMapWebSafe_[n]=this.ENCODED_VALS_WEBSAFE.charAt(n),this.charToByteMapWebSafe_[this.byteToCharMapWebSafe_[n]]=n,n>=this.ENCODED_VALS_BASE.length&&(this.charToByteMap_[this.ENCODED_VALS_WEBSAFE.charAt(n)]=n,this.charToByteMapWebSafe_[this.ENCODED_VALS.charAt(n)]=n)}}};class Rv extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const Sv=function(n){const e=_p(n);return yp.encodeByteArray(e,!0)},bo=function(n){return Sv(n).replace(/\./g,"")},vp=function(n){try{return yp.decodeString(n,!0)}catch(e){console.error("base64Decode failed: ",e)}return null};/**
 * @license
...
*/var pr,Cp;(function(){var n;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(T,m){function v(){}v.prototype=m.prototype,T.D=m.prototype,T.prototype=new v,T.prototype.constructor=T,T.C=function(I,b,S){for(var _=Array(arguments.length-2),Y=2;Y<arguments.length;Y++)_[Y-2]=arguments[Y];return m.prototype[b].apply(I,_)}}function t(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,t),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function s(T,m,v){v||(v=0);var I=Array(16);if(typeof m=="string")for(var b=0;16>b;++b)I[b]=m.charCodeAt(v++)|m.charCodeAt(v++)<<8|m.charCodeAt(v++)<<16|m.charCodeAt(v++)<<24;else for(b=0;16>b;++b)I[b]=m[v++]|m[v++]<<8|m[v++]<<16|m[v++]<<24;m=T.g[0],v=T.g[1],b=T.g[2];var S=T.g[3],_=m+(S^v&(b^S))+I[0]+3614090360&4294967295;m=v+(_<<7&4294967295|_>>>25),_=S+(b^m&(v^b))+I[1]+3905402710&4294967295,S=m+(_<<12&4294967295|_>>>20),_=b+(v^S&(m^v))+I[2]+606105819&4294967295,b=S+(_<<17&4294967295|_>>>15),_=v+(m^b&(S^m))+I[3]+3250441966&4294967295,v=b+(_<<22&4294967295|_>>>10),_=m+(S^v&(b^S))+I[4]+4118548399&4294967295,m=v+(_<<7&4294967295|_>>>25),_=S+(b^m&(v^b))+I[5]+1200080426&4294967295,S=m+(_<<12&4294967295|_>>>20),_=b+(v^S&(m^v))+I[6]+2821735955&4294967295,b=S+(_<<17&4294967295|_>>>15),_=v+(m^b&(S^m))+I[7]+4249261313&4294967295,v=b+(_<<22&4294967295|_>>>10),_=m+(S^v&(b^S))+I[8]+1770035416&4294967295,m=v+(_<<7&4294967295|_>>>25),_=S+(b^m&(v^b))+I[9]+2336552879&4294967295,S=m+(_<<12&4294967295|_>>>20),_=b+(v^S&(m^v))+I[10]+4294925233&4294967295,b=S+(_<<17&4294967295|_>>>15),_=v+(m^b&(S^m))+I[11]+2304563134&4294967295,v=b+(_<<22&4294967295|_>>>10),_=m+(S^v&(b^S))+I[12]+1804603682&4294967295,m=v+(_<<7&4294967295|_>>>25),_=S+(b^m&(v^b))+I[13]+4254626195&4294967295,S=m+(_<<12&4294967295|_>>>20),_=b+(v^S&(m^v))+I[14]+2792965006&4294967295,b=S+(_<<17&4294967295|_>>>15),_=v+(m^b&(S^m))+I[15]+1236535329&4294967295,v=b+(_<<22&4294967295|_>>>10),_=m+(b^S&(v^b))+I[1]+4129170786&4294967295,m=v+(_<<5&4294967295|_>>>27),_=S+(v^b&(m^v))+I[6]+3225465664&4294967295,S=m+(_<<9&4294967295|_>>>23),_=b+(m^v&(S^m))+I[11]+643717713&4294967295,b=S+(_<<14&4294967295|_>>>18),_=v+(S^m&(b^S))+I[0]+3921069994&4294967295,v=b+(_<<20&4294967295|_>>>12),_=m+(b^S&(v^b))+I[5]+3593408605&4294967295,m=v+(_<<5&4294967295|_>>>27),_=S+(v^b&(m^v))+I[10]+38016083&4294967295,S=m+(_<<9&4294967295|_>>>23),_=b+(m^v&(S^m))+I[15]+3634488961&4294967295,b=S+(_<<14&4294967295|_>>>18),_=v+(S^m&(b^S))+I[4]+3889429448&4294967295,v=b+(_<<20&4294967295|_>>>12),_=m+(b^S&(v^b))+I[9]+568446438&4294967295,m=v+(_<<5&4294967295|_>>>27),_=S+(v^b&(m^v))+I[14]+3275163606&4294967295,S=m+(_<<9&4294967295|_>>>23),_=b+(m^v&(S^m))+I[3]+4107603335&4294967295,b=S+(_<<14&4294967295|_>>>18),_=v+(S^m&(b^S))+I[8]+1163531501&4294967295,v=b+(_<<20&4294967295|_>>>12),_=m+(b^S&(v^b))+I[13]+2850285829&4294967295,m=v+(_<<5&4294967295|_>>>27),_=S+(v^b&(m^v))+I[2]+4243563512&4294967295,S=m+(_<<9&4294967295|_>>>23),_=b+(m^v&(S^m))+I[7]+1735328473&4294967295,b=S+(_<<14&4294967295|_>>>18),_=v+(S^m&(b^S))+I[12]+2368359562&4294967295,v=b+(_<<20&4294967295|_>>>12),_=m+(v^b^S)+I[5]+4294588738&4294967295,m=v+(_<<4&4294967295|_>>>28),_=S+(m^v^b)+I[8]+2272392833&4294967295,S=m+(_<<11&4294967295|_>>>21),_=b+(S^m^v)+I[11]+1839030562&4294967295,b=S+(_<<16&4294967295|_>>>16),_=v+(b^S^m)+I[14]+4259657740&4294967295,v=b+(_<<23&4294967295|_>>>9),_=m+(v^b^S)+I[1]+2763975236&4294967295,m=v+(_<<4&4294967295|_>>>28),_=S+(m^v^b)+I[4]+1272893353&4294967295,S=m+(_<<11&4294967295|_>>>21),_=b+(S^m^v)+I[7]+4139469664&4294967295,b=S+(_<<16&4294967295|_>>>16),_=v+(b^S^m)+I[10]+3200236656&4294967295,v=b+(_<<23&4294967295|_>>>9),_=m+(v^b^S)+I[13]+681279174&4294967295,m=v+(_<<4&4294967295|_>>>28),_=S+(m^v^b)+I[0]+3936430074&4294967295,S=m+(_<<11&4294967295|_>>>21),_=b+(S^m^v)+I[3]+3572445317&4294967295,b=S+(_<<16&4294967295|_>>>16),_=v+(b^S^m)+I[6]+76029189&4294967295,v=b+(_<<23&4294967295|_>>>9),_=m+(v^b^S)+I[9]+3654602809&4294967295,m=v+(_<<4&4294967295|_>>>28),_=S+(m^v^b)+I[12]+3873151461&4294967295,S=m+(_<<11&4294967295|_>>>21),_=b+(S^m^v)+I[15]+530742520&4294967295,b=S+(_<<16&4294967295|_>>>16),_=v+(b^S^m)+I[2]+3299628645&4294967295,v=b+(_<<23&4294967295|_>>>9),_=m+(b^(v|~S))+I[0]+4096336452&4294967295,m=v+(_<<6&4294967295|_>>>26),_=S+(v^(m|~b))+I[7]+1126891415&4294967295,S=m+(_<<10&4294967295|_>>>22),_=b+(m^(S|~v))+I[14]+2878612391&4294967295,b=S+(_<<15&4294967295|_>>>17),_=v+(S^(b|~m))+I[5]+4237533241&4294967295,v=b+(_<<21&4294967295|_>>>11),_=m+(b^(v|~S))+I[12]+1700485571&4294967295,m=v+(_<<6&4294967295|_>>>26),_=S+(v^(m|~b))+I[3]+2399980690&4294967295,S=m+(_<<10&4294967295|_>>>22),_=b+(m^(S|~v))+I[10]+4293915773&4294967295,b=S+(_<<15&4294967295|_>>>17),_=v+(S^(b|~m))+I[1]+2240044497&4294967295,v=b+(_<<21&4294967295|_>>>11),_=m+(b^(v|~S))+I[8]+1873313359&4294967295,m=v+(_<<6&4294967295|_>>>26),_=S+(v^(m|~b))+I[15]+4264355552&4294967295,S=m+(_<<10&4294967295|_>>>22),_=b+(m^(S|~v))+I[6]+2734768916&4294967295,b=S+(_<<15&4294967295|_>>>17),_=v+(S^(b|~m))+I[13]+1309151649&4294967295,v=b+(_<<21&4294967295|_>>>11),_=m+(b^(v|~S))+I[4]+4149444226&4294967295,m=v+(_<<6&4294967295|_>>>26),_=S+(v^(m|~b))+I[11]+3174756917&4294967295,S=m+(_<<10&4294967295|_>>>22),_=b+(m^(S|~v))+I[2]+718787259&4294967295,b=S+(_<<15&4294967295|_>>>17),_=v+(S^(b|~m))+I[9]+3951481745&4294967295,T.g[0]=T.g[0]+m&4294967295,T.g[1]=T.g[1]+(b+(_<<21&4294967295|_>>>11))&4294967295,T.g[2]=T.g[2]+b&4294967295,T.g[3]=T.g[3]+S&4294967295}r.prototype.u=function(T,m){m===void 0&&(m=T.length);for(var v=m-this.blockSize,I=this.B,b=this.h,S=0;S<m;){if(b==0)for(;S<=v;)s(this,T,S),S+=this.blockSize;if(typeof T=="string"){for(;S<m;)if(I[b++]=T.charCodeAt(S++),b==this.blockSize){s(this,I),b=0;break}}else for(;S<m;)if(I[b++]=T[S++],b==this.blockSize){s(this,I),b=0;break}}this.h=b,this.o+=m},r.prototype.v=function(){var T=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);T[0]=128;for(var m=1;m<T.length-8;++m)T[m]=0;var v=8*this.o;for(m=T.length-8;m<T.length;++m)T[m]=v&255,v/=256;for(this.u(T),T=Array(16),m=v=0;4>m;++m)for(var I=0;32>I;I+=8)T[v++]=this.g[m]>>>I&255;return T};function i(T,m){var v=l;return Object.prototype.hasOwnProperty.call(v,T)?v[T]:v[T]=m(T)}function a(T,m){this.h=m;for(var v=[],I=!0,b=T.length-1;0<=b;b--){var S=T[b]|0;I&&S==m||(v[b]=S,I=!1)}this.g=v}var l={};function c(T){return-128<=T&&128>T?i(T,function(m){return new a([m|0],0>m?-1:0)}):new a([T|0],0>T?-1:0)}function h(T){if(isNaN(T)||!isFinite(T))return g;if(0>T)return P(h(-T));for(var m=[],v=1,I=0;T>=v;I++)m[I]=T/v|0,v*=4294967296;return new a(m,0)}function d(T,m){if(T.length==0)throw Error("number format error: empty string");if(m=m||10,2>m||36<m)throw Error("radix out of range: "+m);if(T.charAt(0)=="-")return P(d(T.substring(1),m));if(0<=T.indexOf("-"))throw Error('number format error: interior "-" character');for(var v=h(Math.pow(m,8)),I=g,b=0;b<T.length;b+=8){var S=Math.min(8,T.length-b),_=parseInt(T.substring(b,b+S),m);8>S?(S=h(Math.pow(m,S)),I=I.j(S).add(h(_))):(I=I.j(v),I=I.add(h(_)))}return I}var g=c(0),y=c(1),w=c(16777216);n=a.prototype,n.m=function(){if(R(this))return-P(this).m();for(var T=0,m=1,v=0;v<this.g.length;v++){var I=this.i(v);T+=(0<=I?I:4294967296+I)*m,m*=4294967296}return T},n.toString=function(T){if(T=T||10,2>T||36<T)throw Error("radix out of range: "+T);if(k(this))return"0";if(R(this))return"-"+P(this).toString(T);for(var m=h(Math.pow(T,6)),v=this,I="";;){var b=z(v,m).g;v=U(v,b.j(m));var S=((0<v.g.length?v.g[0]:v.h)>>>0).toString(T);if(v=b,k(v))return S+I;for(;6>S.length;)S="0"+S;I=S+I}},n.i=function(T){return 0>T?0:T<this.g.length?this.g[T]:this.h};function k(T){if(T.h!=0)return!1;for(var m=0;m<T.g.length;m++)if(T.g[m]!=0)return!1;return!0}function R(T){return T.h==-1}n.l=function(T){return T=U(this,T),R(T)?-1:k(T)?0:1};function P(T){for(var m=T.g.length,v=[],I=0;I<m;I++)v[I]=~T.g[I];return new a(v,~T.h).add(y)}n.abs=function(){return R(this)?P(this):this},n.add=function(T){for(var m=Math.max(this.g.length,T.g.length),v=[],I=0,b=0;b<=m;b++){var S=I+(this.i(b)&65535)+(T.i(b)&65535),_=(S>>>16)+(this.i(b)>>>16)+(T.i(b)>>>16);I=_>>>16,S&=65535,_&=65535,v[b]=_<<16|S}return new a(v,v[v.length-1]&-2147483648?-1:0)};function U(T,m){return T.add(P(m))}n.j=function(T){if(k(this)||k(T))return g;if(R(this))return R(T)?P(this).j(P(T)):P(P(this).j(T));if(R(T))return P(this.j(P(T)));if(0>this.l(w)&&0>T.l(w))return h(this.m()*T.m());for(var m=this.g.length+T.g.length,v=[],I=0;I<2*m;I++)v[I]=0;for(I=0;I<this.g.length;I++)for(var b=0;b<T.g.length;b++){var S=this.i(I)>>>16,_=this.i(I)&65535,Y=T.i(b)>>>16,ue=T.i(b)&65535;v[2*I+2*b]+=_*ue,B(v,2*I+2*b),v[2*I+2*b+1]+=S*ue,B(v,2*I+2*b+1),v[2*I+2*b+1]+=_*Y,B(v,2*I+2*b+1),v[2*I+2*b+2]+=S*Y,B(v,2*I+2*b+2)}for(I=0;I<m;I++)v[I]=v[2*I+1]<<16|v[2*I];for(I=m;I<2*m;I++)v[I]=0;return new a(v,0)};function B(T,m){for(;(T[m]&65535)!=T[m];)T[m+1]+=T[m]>>>16,T[m]&=65535,m++}function Q(T,m){this.g=T,this.h=m}function z(T,m){if(k(m))throw Error("division by zero");if(k(T))return new Q(g,g);if(R(T))return m=z(P(T),m),new Q(P(m.g),P(m.h));if(R(m))return m=z(T,P(m)),new Q(P(m.g),m.h);if(30<T.g.length){if(R(T)||R(m))throw Error("slowDivide_ only works with positive integers.");for(var v=y,I=m;0>=I.l(T);)v=fe(v),I=fe(I);var b=he(v,1),S=he(I,1);for(I=he(I,2),v=he(v,2);!k(I);){var _=S.add(I);0>=_.l(T)&&(b=b.add(v),S=_),I=he(I,1),v=he(v,1)}return m=U(T,b.j(m)),new Q(b,m)}for(b=g;0<=T.l(m);){for(v=Math.max(1,Math.floor(T.m()/m.m())),I=Math.ceil(Math.log(v)/Math.LN2),I=48>=I?1:Math.pow(2,I-48),S=h(v),_=S.j(m);R(_)||0<_.l(T);)v-=I,S=h(v),_=S.j(m);k(S)&&(S=y),b=b.add(S),T=U(T,_)}return new Q(b,T)}n.A=function(T){return z(this,T).h},n.and=function(T){for(var m=Math.max(this.g.length,T.g.length),v=[],I=0;I<m;I++)v[I]=this.i(I)&T.i(I);return new a(v,this.h&T.h)},n.or=function(T){for(var m=Math.max(this.g.length,T.g.length),v=[],I=0;I<m;I++)v[I]=this.i(I)|T.i(I);return new a(v,this.h|T.h)},n.xor=function(T){for(var m=Math.max(this.g.length,T.g.length),v=[],I=0;I<m;I++)v[I]=this.i(I)^T.i(I);return new a(v,this.h^T.h)};function fe(T){for(var m=T.g.length+1,v=[],I=0;I<m;I++)v[I]=T.i(I)<<1|T.i(I-1)>>>31;return new a(v,T.h)}function he(T,m){var v=m>>5;m%=32;for(var I=T.g.length-v,b=[],S=0;S<I;S++)b[S]=0<m?T.i(S+v)>>>m|T.i(S+v+1)<<32-m:T.i(S+v);return new a(b,T.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,Cp=r,a.prototype.add=a.prototype.add,a.prototype.multiply=a.prototype.j,a.prototype.modulo=a.prototype.A,a.prototype.compare=a.prototype.l,a.prototype.toNumber=a.prototype.m,a.prototype.toString=a.prototype.toString,a.prototype.getBits=a.prototype.i,a.fromNumber=h,a.fromString=d,pr=a}).apply(typeof Xh<"u"?Xh:typeof self<"u"?self:typeof window<"u"?window:{});var Xi=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var kp,Ls,Vp,ao,Ml,Dp,Np,Op;(function(){var n,e=typeof Object.defineProperties=="function"?Object.defineProperty:function(o,u,f){return o==Array.prototype||o==Object.prototype||(o[u]=f.value),o};function t(o){o=[typeof globalThis=="object"&&globalThis,o,typeof window=="object"&&window,typeof self=="object"&&self,typeof Xi=="object"&&Xi];for(var u=0;u<o.length;++u){var f=o[u];if(f&&f.Math==Math)return f}throw Error("Cannot find global object")}var r=t(this);function s(o,u){if(u)e:{var f=r;o=o.split(".");for(var p=0;p<o.length-1;p++){var C=o[p];if(!(C in f))break e;f=f[C]}o=o[o.length-1],p=f[o],u=u(p),u!=p&&u!=null&&e(f,o,{configurable:!0,writable:!0,value:u})}}function i(o,u){o instanceof String&&(o+="");var f=0,p=!1,C={next:function(){if(!p&&f<o.length){var V=f++;return{value:u(V,o[V]),done:!1}}return p=!0,{done:!0,value:void 0}}};return C[Symbol.iterator]=function(){return C},C}s("Array.prototype.values",function(o){return o||function(){return i(this,function(u,f){return f})}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var a=a||{},l=this||self;function c(o){var u=typeof o;return u=u!="object"?u:o?Array.isArray(o)?"array":u:"null",u=="array"||u=="object"&&typeof o.length=="number"}function h(o){var u=typeof o;return u=="object"&&o!=null||u=="function"}function d(o,u,f){return o.call.apply(o.bind,arguments)}function g(o,u,f){if(!o)throw Error();if(2<arguments.length){var p=Array.prototype.slice.call(arguments,2);return function(){var C=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(C,p),o.apply(u,C)}}return function(){return o.apply(u,arguments)}}function y(o,u,f){return y=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?d:g,y.apply(null,arguments)}function w(o,u){var f=Array.prototype.slice.call(arguments,1);return function(){var p=f.slice();return p.push.apply(p,arguments),o.apply(this,p)}}function k(o,u){function f(){}f.prototype=u.prototype,o.aa=u.prototype,o.prototype=new f,o.prototype.constructor=o,o.Qb=function(p,C,V){for(var W=Array(arguments.length-2),Se=2;Se<arguments.length;Se++)W[Se-2]=arguments[Se];return u.prototype[C].apply(p,W)}}function R(o){const u=o.length;if(0<u){const f=Array(u);for(let p=0;p<u;p++)f[p]=o[p];return f}return[]}function P(o,u){for(let f=1;f<arguments.length;f++){const p=arguments[f];if(c(p)){const C=o.length||0,V=p.length||0;o.length=C+V;for(let W=0;W<V;W++)o[C+W]=p[W]}else o.push(p)}}class U{constructor(u,f){this.i=u,this.j=f,this.h=0,this.g=null}get(){let u;return 0<this.h?(this.h--,u=this.g,this.g=u.next,u.next=null):u=this.i(),u}}function B(o){return/^[\s\xa0]*$/.test(o)}function Q(){var o=l.navigator;return o&&(o=o.userAgent)?o:""}function z(o){return z[" "](o),o}z[" "]=function(){};var fe=Q().indexOf("Gecko")!=-1&&!(Q().toLowerCase().indexOf("webkit")!=-1&&Q().indexOf("Edge")==-1)&&!(Q().indexOf("Trident")!=-1||Q().indexOf("MSIE")!=-1)&&Q().indexOf("Edge")==-1;function he(o,u,f){for(const p in o)u.call(f,o[p],p,o)}function T(o,u){for(const f in o)u.call(void 0,o[f],f,o)}function m(o){const u={};for(const f in o)u[f]=o[f];return u}const v="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function I(o,u){let f,p;for(let C=1;C<arguments.length;C++){p=arguments[C];for(f in p)o[f]=p[f];for(let V=0;V<v.length;V++)f=v[V],Object.prototype.hasOwnProperty.call(p,f)&&(o[f]=p[f])}}function b(o){var u=1;o=o.split(":");const f=[];for(;0<u&&o.length;)f.push(o.shift()),u--;return o.length&&f.push(o.join(":")),f}function S(o){l.setTimeout(()=>{throw o},0)}function _(){var o=kt;let u=null;return o.g&&(u=o.g,o.g=o.g.next,o.g||(o.h=null),u.next=null),u}class Y{constructor(){this.h=this.g=null}add(u,f){const p=ue.get();p.set(u,f),this.h?this.h.next=p:this.g=p,this.h=p}}var ue=new U(()=>new $e,o=>o.reset());class $e{constructor(){this.next=this.g=this.h=null}set(u,f){this.h=u,this.g=f,this.next=null}reset(){this.next=this.g=this.h=null}}let Ae,ye=!1,kt=new Y,Jn=()=>{const o=l.Promise.resolve(void 0);Ae=()=>{o.then(tn)}};var tn=()=>{for(var o;o=_();){try{o.h.call(o.g)}catch(f){S(f)}var u=ue;u.j(o),100>u.h&&(u.h++,o.next=u.g,u.g=o)}ye=!1};function je(){this.s=this.s,this.C=this.C}je.prototype.s=!1,je.prototype.ma=function(){this.s||(this.s=!0,this.N())},je.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function qe(o,u){this.type=o,this.g=this.target=u,this.defaultPrevented=!1}qe.prototype.h=function(){this.defaultPrevented=!0};var Sa=function(){if(!l.addEventListener||!Object.defineProperty)return!1;var o=!1,u=Object.defineProperty({},"passive",{get:function(){o=!0}});try{const f=()=>{};l.addEventListener("test",f,u),l.removeEventListener("test",f,u)}catch{}return o}();function Xn(o,u){if(qe.call(this,o?o.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,o){var f=this.type=o.type,p=o.changedTouches&&o.changedTouches.length?o.changedTouches[0]:null;if(this.target=o.target||o.srcElement,this.g=u,u=o.relatedTarget){if(fe){e:{try{z(u.nodeName);var C=!0;break e}catch{}C=!1}C||(u=null)}}else f=="mouseover"?u=o.fromElement:f=="mouseout"&&(u=o.toElement);this.relatedTarget=u,p?(this.clientX=p.clientX!==void 0?p.clientX:p.pageX,this.clientY=p.clientY!==void 0?p.clientY:p.pageY,this.screenX=p.screenX||0,this.screenY=p.screenY||0):(this.clientX=o.clientX!==void 0?o.clientX:o.pageX,this.clientY=o.clientY!==void 0?o.clientY:o.pageY,this.screenX=o.screenX||0,this.screenY=o.screenY||0),this.button=o.button,this.key=o.key||"",this.ctrlKey=o.ctrlKey,this.altKey=o.altKey,this.shiftKey=o.shiftKey,this.metaKey=o.metaKey,this.pointerId=o.pointerId||0,this.pointerType=typeof o.pointerType=="string"?o.pointerType:Zn[o.pointerType]||"",this.state=o.state,this.i=o,o.defaultPrevented&&Xn.aa.h.call(this)}}k(Xn,qe);var Zn={2:"touch",3:"pen",4:"mouse"};Xn.prototype.h=function(){Xn.aa.h.call(this);var o=this.i;o.preventDefault?o.preventDefault():o.returnValue=!1};var nn="closure_listenable_"+(1e6*Math.random()|0),hs=0;function Vi(o,u,f,p,C){this.listener=o,this.proxy=null,this.src=u,this.type=f,this.capture=!!p,this.ha=C,this.key=++hs,this.da=this.fa=!1}function Ft(o){o.da=!0,o.listener=null,o.proxy=null,o.src=null,o.ha=null}function fs(o){this.src=o,this.g={},this.h=0}fs.prototype.add=function(o,u,f,p,C){var V=o.toString();o=this.g[V],o||(o=this.g[V]=[],this.h++);var W=A(o,u,p,C);return-1<W?(u=o[W],f||(u.fa=!1)):(u=new Vi(u,this.src,V,!!p,C),u.fa=f,o.push(u)),u};function E(o,u){var f=u.type;if(f in o.g){var p=o.g[f],C=Array.prototype.indexOf.call(p,u,void 0),V;(V=0<=C)&&Array.prototype.splice.call(p,C,1),V&&(Ft(u),o.g[f].length==0&&(delete o.g[f],o.h--))}}function A(o,u,f,p){for(var C=0;C<o.length;++C){var V=o[C];if(!V.da&&V.listener==u&&V.capture==!!f&&V.ha==p)return C}return-1}var D="closure_lm_"+(1e6*Math.random()|0),L={};function x(o,u,f,p,C){if(Array.isArray(u)){for(var V=0;V<u.length;V++)x(o,u[V],f,p,C);return null}return f=ne(f),o&&o[nn]?o.K(u,f,h(p)?!!p.capture:!1,C):O(o,u,f,!1,p,C)}function O(o,u,f,p,C,V){if(!u)throw Error("Invalid event type");var W=h(C)?!!C.capture:!!C,Se=G(o);if(Se||(o[D]=Se=new fs(o)),f=Se.add(u,f,p,W,V),f.proxy)return f;if(p=K(),f.proxy=p,p.src=o,p.listener=f,o.addEventListener)Sa||(C=W),C===void 0&&(C=!1),o.addEventListener(u.toString(),p,C);else if(o.attachEvent)o.attachEvent(M(u.toString()),p);else if(o.addListener&&o.removeListener)o.addListener(p);else throw Error("addEventListener and attachEvent are unavailable.");return f}function K(){function o(f){return u.call(o.src,o.listener,f)}const u=ee;return o}function j(o,u,f,p,C){if(Array.isArray(u))for(var V=0;V<u.length;V++)j(o,u[V],f,p,C);else p=h(p)?!!p.capture:!!p,f=ne(f),o&&o[nn]?(o=o.i,u=String(u).toString(),u in o.g&&(V=o.g[u],f=A(V,f,p,C),-1<f&&(Ft(V[f]),Array.prototype.splice.call(V,f,1),V.length==0&&(delete o.g[u],o.h--)))):o&&(o=G(o))&&(u=o.g[u.toString()],o=-1,u&&(o=A(u,f,p,C)),(f=-1<o?u[o]:null)&&$(f))}function $(o){if(typeof o!="number"&&o&&!o.da){var u=o.src;if(u&&u[nn])E(u.i,o);else{var f=o.type,p=o.proxy;u.removeEventListener?u.removeEventListener(f,p,o.capture):u.detachEvent?u.detachEvent(M(f),p):u.addListener&&u.removeListener&&u.removeListener(p),(f=G(u))?(E(f,o),f.h==0&&(f.src=null,u[D]=null)):Ft(o)}}}function M(o){return o in L?L[o]:L[o]="on"+o}function ee(o,u){if(o.da)o=!0;else{u=new Xn(u,this);var f=o.listener,p=o.ha||o.src;o.fa&&$(o),o=f.call(p,u)}return o}function G(o){return o=o[D],o instanceof fs?o:null}var X="__closure_events_fn_"+(1e9*Math.random()>>>0);function ne(o){return typeof o=="function"?o:(o[X]||(o[X]=function(u){return o.handleEvent(u)}),o[X])}function te(){je.call(this),this.i=new fs(this),this.M=this,this.F=null}k(te,je),te.prototype[nn]=!0,te.prototype.removeEventListener=function(o,u,f,p){j(this,o,u,f,p)};function le(o,u){var f,p=o.F;if(p)for(f=[];p;p=p.F)f.push(p);if(o=o.M,p=u.type||u,typeof u=="string")u=new qe(u,o);else if(u instanceof qe)u.target=u.target||o;else{var C=u;u=new qe(p,o),I(u,C)}if(C=!0,f)for(var V=f.length-1;0<=V;V--){var W=u.g=f[V];C=_e(W,p,!0,u)&&C}if(W=u.g=o,C=_e(W,p,!0,u)&&C,C=_e(W,p,!1,u)&&C,f)for(V=0;V<f.length;V++)W=u.g=f[V],C=_e(W,p,!1,u)&&C}te.prototype.N=function(){if(te.aa.N.call(this),this.i){var o=this.i,u;for(u in o.g){for(var f=o.g[u],p=0;p<f.length;p++)Ft(f[p]);delete o.g[u],o.h--}}this.F=null},te.prototype.K=function(o,u,f,p){return this.i.add(String(o),u,!1,f,p)},te.prototype.L=function(o,u,f,p){return this.i.add(String(o),u,!0,f,p)};function _e(o,u,f,p){if(u=o.i.g[String(u)],!u)return!0;u=u.concat();for(var C=!0,V=0;V<u.length;++V){var W=u[V];if(W&&!W.da&&W.capture==f){var Se=W.listener,Qe=W.ha||W.src;W.fa&&E(o.i,W),C=Se.call(Qe,p)!==!1&&C}}return C&&!p.defaultPrevented}function De(o,u,f){if(typeof o=="function")f&&(o=y(o,f));else if(o&&typeof o.handleEvent=="function")o=y(o.handleEvent,o);else throw Error("Invalid listener argument");return 2147483647<Number(u)?-1:l.setTimeout(o,u||0)}function Fe(o){o.g=De(()=>{o.g=null,o.i&&(o.i=!1,Fe(o))},o.l);const u=o.h;o.h=null,o.m.apply(null,u)}class bt extends je{constructor(u,f){super(),this.m=u,this.l=f,this.h=null,this.i=!1,this.g=null}j(u){this.h=arguments,this.g?this.i=!0:Fe(this)}N(){super.N(),this.g&&(l.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function nt(o){je.call(this),this.h=o,this.g={}}k(nt,je);var Rn=[];function ds(o){he(o.g,function(u,f){this.g.hasOwnProperty(f)&&$(u)},o),o.g={}}nt.prototype.N=function(){nt.aa.N.call(this),ds(this)},nt.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var Ge=l.JSON.stringify,Rt=l.JSON.parse,Di=class{stringify(o){return l.JSON.stringify(o,void 0)}parse(o){return l.JSON.parse(o,void 0)}};function Ar(){}Ar.prototype.h=null;function _u(o){return o.h||(o.h=o.i())}function yu(){}var ps={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function Pa(){qe.call(this,"d")}k(Pa,qe);function Ca(){qe.call(this,"c")}k(Ca,qe);var er={},vu=null;function Ni(){return vu=vu||new te}er.La="serverreachability";function Eu(o){qe.call(this,er.La,o)}k(Eu,qe);function gs(o){const u=Ni();le(u,new Eu(u))}er.STAT_EVENT="statevent";function Tu(o,u){qe.call(this,er.STAT_EVENT,o),this.stat=u}k(Tu,qe);function ft(o){const u=Ni();le(u,new Tu(u,o))}er.Ma="timingevent";function wu(o,u){qe.call(this,er.Ma,o),this.size=u}k(wu,qe);function ms(o,u){if(typeof o!="function")throw Error("Fn must not be null and must be a function");return l.setTimeout(function(){o()},u)}function _s(){this.g=!0}_s.prototype.xa=function(){this.g=!1};function km(o,u,f,p,C,V){o.info(function(){if(o.g)if(V)for(var W="",Se=V.split("&"),Qe=0;Qe<Se.length;Qe++){var ve=Se[Qe].split("=");if(1<ve.length){var rt=ve[0];ve=ve[1];var st=rt.split("_");W=2<=st.length&&st[1]=="type"?W+(rt+"="+ve+"&"):W+(rt+"=redacted&")}}else W=null;else W=V;return"XMLHTTP REQ ("+p+") [attempt "+C+"]: "+u+`
`+f+`
`+W})}function Vm(o,u,f,p,C,V,W){o.info(function(){return"XMLHTTP RESP ("+p+") [ attempt "+C+"]: "+u+`
`+f+`
`+V+" "+W})}function br(o,u,f,p){o.info(function(){return"XMLHTTP TEXT ("+u+"): "+Nm(o,f)+(p?" "+p:"")})}function Dm(o,u){o.info(function(){return"TIMEOUT: "+u})}_s.prototype.info=function(){};function Nm(o,u){if(!o.g)return u;if(!u)return null;try{var f=JSON.parse(u);if(f){for(o=0;o<f.length;o++)if(Array.isArray(f[o])){var p=f[o];if(!(2>p.length)){var C=p[1];if(Array.isArray(C)&&!(1>C.length)){var V=C[0];if(V!="noop"&&V!="stop"&&V!="close")for(var W=1;W<C.length;W++)C[W]=""}}}}return Ge(f)}catch{return u}}var Oi={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},Iu={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},ka;function Mi(){}k(Mi,Ar),Mi.prototype.g=function(){return new XMLHttpRequest},Mi.prototype.i=function(){return{}},ka=new Mi;function Sn(o,u,f,p){this.j=o,this.i=u,this.l=f,this.R=p||1,this.U=new nt(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new Au}function Au(){this.i=null,this.g="",this.h=!1}var bu={},Va={};function Da(o,u,f){o.L=1,o.v=Ui(rn(u)),o.m=f,o.P=!0,Ru(o,null)}function Ru(o,u){o.F=Date.now(),xi(o),o.A=rn(o.v);var f=o.A,p=o.R;Array.isArray(p)||(p=[String(p)]),Bu(f.i,"t",p),o.C=0,f=o.j.J,o.h=new Au,o.g=sh(o.j,f?u:null,!o.m),0<o.O&&(o.M=new bt(y(o.Y,o,o.g),o.O)),u=o.U,f=o.g,p=o.ca;var C="readystatechange";Array.isArray(C)||(C&&(Rn[0]=C.toString()),C=Rn);for(var V=0;V<C.length;V++){var W=x(f,C[V],p||u.handleEvent,!1,u.h||u);if(!W)break;u.g[W.key]=W}u=o.H?m(o.H):{},o.m?(o.u||(o.u="POST"),u["Content-Type"]="application/x-www-form-urlencoded",o.g.ea(o.A,o.u,o.m,u)):(o.u="GET",o.g.ea(o.A,o.u,null,u)),gs(),km(o.i,o.u,o.A,o.l,o.R,o.m)}Sn.prototype.ca=function(o){o=o.target;const u=this.M;u&&sn(o)==3?u.j():this.Y(o)},Sn.prototype.Y=function(o){try{if(o==this.g)e:{const st=sn(this.g);var u=this.g.Ba();const Pr=this.g.Z();if(!(3>st)&&(st!=3||this.g&&(this.h.h||this.g.oa()||zu(this.g)))){this.J||st!=4||u==7||(u==8||0>=Pr?gs(3):gs(2)),Na(this);var f=this.g.Z();this.X=f;t:if(Su(this)){var p=zu(this.g);o="";var C=p.length,V=sn(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){tr(this),ys(this);var W="";break t}this.h.i=new l.TextDecoder}for(u=0;u<C;u++)this.h.h=!0,o+=this.h.i.decode(p[u],{stream:!(V&&u==C-1)});p.length=0,this.h.g+=o,this.C=0,W=this.h.g}else W=this.g.oa();if(this.o=f==200,Vm(this.i,this.u,this.A,this.l,this.R,st,f),this.o){if(this.T&&!this.K){t:{if(this.g){var Se,Qe=this.g;if((Se=Qe.g?Qe.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!B(Se)){var ve=Se;break t}}ve=null}if(f=ve)br(this.i,this.l,f,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,Oa(this,f);else{this.o=!1,this.s=3,ft(12),tr(this),ys(this);break e}}if(this.P){f=!0;let Vt;for(;!this.J&&this.C<W.length;)if(Vt=Om(this,W),Vt==Va){st==4&&(this.s=4,ft(14),f=!1),br(this.i,this.l,null,"[Incomplete Response]");break}else if(Vt==bu){this.s=4,ft(15),br(this.i,this.l,W,"[Invalid Chunk]"),f=!1;break}else br(this.i,this.l,Vt,null),Oa(this,Vt);if(Su(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),st!=4||W.length!=0||this.h.h||(this.s=1,ft(16),f=!1),this.o=this.o&&f,!f)br(this.i,this.l,W,"[Invalid Chunked Response]"),tr(this),ys(this);else if(0<W.length&&!this.W){this.W=!0;var rt=this.j;rt.g==this&&rt.ba&&!rt.M&&(rt.j.info("Great, no buffering proxy detected. Bytes received: "+W.length),Ba(rt),rt.M=!0,ft(11))}}else br(this.i,this.l,W,null),Oa(this,W);st==4&&tr(this),this.o&&!this.J&&(st==4?eh(this.j,this):(this.o=!1,xi(this)))}else Jm(this.g),f==400&&0<W.indexOf("Unknown SID")?(this.s=3,ft(12)):(this.s=0,ft(13)),tr(this),ys(this)}}}catch{}finally{}};function Su(o){return o.g?o.u=="GET"&&o.L!=2&&o.j.Ca:!1}function Om(o,u){var f=o.C,p=u.indexOf(`
`,f);return p==-1?Va:(f=Number(u.substring(f,p)),isNaN(f)?bu:(p+=1,p+f>u.length?Va:(u=u.slice(p,p+f),o.C=p+f,u)))}Sn.prototype.cancel=function(){this.J=!0,tr(this)};function xi(o){o.S=Date.now()+o.I,Pu(o,o.I)}function Pu(o,u){if(o.B!=null)throw Error("WatchDog timer not null");o.B=ms(y(o.ba,o),u)}function Na(o){o.B&&(l.clearTimeout(o.B),o.B=null)}Sn.prototype.ba=function(){this.B=null;const o=Date.now();0<=o-this.S?(Dm(this.i,this.A),this.L!=2&&(gs(),ft(17)),tr(this),this.s=2,ys(this)):Pu(this,this.S-o)};function ys(o){o.j.G==0||o.J||eh(o.j,o)}function tr(o){Na(o);var u=o.M;u&&typeof u.ma=="function"&&u.ma(),o.M=null,ds(o.U),o.g&&(u=o.g,o.g=null,u.abort(),u.ma())}function Oa(o,u){try{var f=o.j;if(f.G!=0&&(f.g==o||Ma(f.h,o))){if(!o.K&&Ma(f.h,o)&&f.G==3){try{var p=f.Da.g.parse(u)}catch{p=null}if(Array.isArray(p)&&p.length==3){var C=p;if(C[0]==0){e:if(!f.u){if(f.g)if(f.g.F+3e3<o.F)Hi(f),qi(f);else break e;Ua(f),ft(18)}}else f.za=C[1],0<f.za-f.T&&37500>C[2]&&f.F&&f.v==0&&!f.C&&(f.C=ms(y(f.Za,f),6e3));if(1>=Vu(f.h)&&f.ca){try{f.ca()}catch{}f.ca=void 0}}else rr(f,11)}else if((o.K||f.g==o)&&Hi(f),!B(u))for(C=f.Da.g.parse(u),u=0;u<C.length;u++){let ve=C[u];if(f.T=ve[0],ve=ve[1],f.G==2)if(ve[0]=="c"){f.K=ve[1],f.ia=ve[2];const rt=ve[3];rt!=null&&(f.la=rt,f.j.info("VER="+f.la));const st=ve[4];st!=null&&(f.Aa=st,f.j.info("SVER="+f.Aa));const Pr=ve[5];Pr!=null&&typeof Pr=="number"&&0<Pr&&(p=1.5*Pr,f.L=p,f.j.info("backChannelRequestTimeoutMs_="+p)),p=f;const Vt=o.g;if(Vt){const zi=Vt.g?Vt.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(zi){var V=p.h;V.g||zi.indexOf("spdy")==-1&&zi.indexOf("quic")==-1&&zi.indexOf("h2")==-1||(V.j=V.l,V.g=new Set,V.h&&(xa(V,V.h),V.h=null))}if(p.D){const $a=Vt.g?Vt.g.getResponseHeader("X-HTTP-Session-Id"):null;$a&&(p.ya=$a,Ve(p.I,p.D,$a))}}f.G=3,f.l&&f.l.ua(),f.ba&&(f.R=Date.now()-o.F,f.j.info("Handshake RTT: "+f.R+"ms")),p=f;var W=o;if(p.qa=rh(p,p.J?p.ia:null,p.W),W.K){Du(p.h,W);var Se=W,Qe=p.L;Qe&&(Se.I=Qe),Se.B&&(Na(Se),xi(Se)),p.g=W}else Xu(p);0<f.i.length&&Wi(f)}else ve[0]!="stop"&&ve[0]!="close"||rr(f,7);else f.G==3&&(ve[0]=="stop"||ve[0]=="close"?ve[0]=="stop"?rr(f,7):Fa(f):ve[0]!="noop"&&f.l&&f.l.ta(ve),f.v=0)}}gs(4)}catch{}}var Mm=class{constructor(o,u){this.g=o,this.map=u}};function Cu(o){this.l=o||10,l.PerformanceNavigationTiming?(o=l.performance.getEntriesByType("navigation"),o=0<o.length&&(o[0].nextHopProtocol=="hq"||o[0].nextHopProtocol=="h2")):o=!!(l.chrome&&l.chrome.loadTimes&&l.chrome.loadTimes()&&l.chrome.loadTimes().wasFetchedViaSpdy),this.j=o?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function ku(o){return o.h?!0:o.g?o.g.size>=o.j:!1}function Vu(o){return o.h?1:o.g?o.g.size:0}function Ma(o,u){return o.h?o.h==u:o.g?o.g.has(u):!1}function xa(o,u){o.g?o.g.add(u):o.h=u}function Du(o,u){o.h&&o.h==u?o.h=null:o.g&&o.g.has(u)&&o.g.delete(u)}Cu.prototype.cancel=function(){if(this.i=Nu(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const o of this.g.values())o.cancel();this.g.clear()}};function Nu(o){if(o.h!=null)return o.i.concat(o.h.D);if(o.g!=null&&o.g.size!==0){let u=o.i;for(const f of o.g.values())u=u.concat(f.D);return u}return R(o.i)}function xm(o){if(o.V&&typeof o.V=="function")return o.V();if(typeof Map<"u"&&o instanceof Map||typeof Set<"u"&&o instanceof Set)return Array.from(o.values());if(typeof o=="string")return o.split("");if(c(o)){for(var u=[],f=o.length,p=0;p<f;p++)u.push(o[p]);return u}u=[],f=0;for(p in o)u[f++]=o[p];return u}function Lm(o){if(o.na&&typeof o.na=="function")return o.na();if(!o.V||typeof o.V!="function"){if(typeof Map<"u"&&o instanceof Map)return Array.from(o.keys());if(!(typeof Set<"u"&&o instanceof Set)){if(c(o)||typeof o=="string"){var u=[];o=o.length;for(var f=0;f<o;f++)u.push(f);return u}u=[],f=0;for(const p in o)u[f++]=p;return u}}}function Ou(o,u){if(o.forEach&&typeof o.forEach=="function")o.forEach(u,void 0);else if(c(o)||typeof o=="string")Array.prototype.forEach.call(o,u,void 0);else for(var f=Lm(o),p=xm(o),C=p.length,V=0;V<C;V++)u.call(void 0,p[V],f&&f[V],o)}var Mu=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function Fm(o,u){if(o){o=o.split("&");for(var f=0;f<o.length;f++){var p=o[f].indexOf("="),C=null;if(0<=p){var V=o[f].substring(0,p);C=o[f].substring(p+1)}else V=o[f];u(V,C?decodeURIComponent(C.replace(/\+/g," ")):"")}}}function nr(o){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,o instanceof nr){this.h=o.h,Li(this,o.j),this.o=o.o,this.g=o.g,Fi(this,o.s),this.l=o.l;var u=o.i,f=new Ts;f.i=u.i,u.g&&(f.g=new Map(u.g),f.h=u.h),xu(this,f),this.m=o.m}else o&&(u=String(o).match(Mu))?(this.h=!1,Li(this,u[1]||"",!0),this.o=vs(u[2]||""),this.g=vs(u[3]||"",!0),Fi(this,u[4]),this.l=vs(u[5]||"",!0),xu(this,u[6]||"",!0),this.m=vs(u[7]||"")):(this.h=!1,this.i=new Ts(null,this.h))}nr.prototype.toString=function(){var o=[],u=this.j;u&&o.push(Es(u,Lu,!0),":");var f=this.g;return(f||u=="file")&&(o.push("//"),(u=this.o)&&o.push(Es(u,Lu,!0),"@"),o.push(encodeURIComponent(String(f)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),f=this.s,f!=null&&o.push(":",String(f))),(f=this.l)&&(this.g&&f.charAt(0)!="/"&&o.push("/"),o.push(Es(f,f.charAt(0)=="/"?$m:Bm,!0))),(f=this.i.toString())&&o.push("?",f),(f=this.m)&&o.push("#",Es(f,qm)),o.join("")};function rn(o){return new nr(o)}function Li(o,u,f){o.j=f?vs(u,!0):u,o.j&&(o.j=o.j.replace(/:$/,""))}function Fi(o,u){if(u){if(u=Number(u),isNaN(u)||0>u)throw Error("Bad port number "+u);o.s=u}else o.s=null}function xu(o,u,f){u instanceof Ts?(o.i=u,Wm(o.i,o.h)):(f||(u=Es(u,jm)),o.i=new Ts(u,o.h))}function Ve(o,u,f){o.i.set(u,f)}function Ui(o){return Ve(o,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),o}function vs(o,u){return o?u?decodeURI(o.replace(/%25/g,"%2525")):decodeURIComponent(o):""}function Es(o,u,f){return typeof o=="string"?(o=encodeURI(o).replace(u,Um),f&&(o=o.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),o):null}function Um(o){return o=o.charCodeAt(0),"%"+(o>>4&15).toString(16)+(o&15).toString(16)}var Lu=/[#\/\?@]/g,Bm=/[#\?:]/g,$m=/[#\?]/g,jm=/[#\?@]/g,qm=/#/g;function Ts(o,u){this.h=this.g=null,this.i=o||null,this.j=!!u}function Pn(o){o.g||(o.g=new Map,o.h=0,o.i&&Fm(o.i,function(u,f){o.add(decodeURIComponent(u.replace(/\+/g," ")),f)}))}n=Ts.prototype,n.add=function(o,u){Pn(this),this.i=null,o=Rr(this,o);var f=this.g.get(o);return f||this.g.set(o,f=[]),f.push(u),this.h+=1,this};function Fu(o,u){Pn(o),u=Rr(o,u),o.g.has(u)&&(o.i=null,o.h-=o.g.get(u).length,o.g.delete(u))}function Uu(o,u){return Pn(o),u=Rr(o,u),o.g.has(u)}n.forEach=function(o,u){Pn(this),this.g.forEach(function(f,p){f.forEach(function(C){o.call(u,C,p,this)},this)},this)},n.na=function(){Pn(this);const o=Array.from(this.g.values()),u=Array.from(this.g.keys()),f=[];for(let p=0;p<u.length;p++){const C=o[p];for(let V=0;V<C.length;V++)f.push(u[p])}return f},n.V=function(o){Pn(this);let u=[];if(typeof o=="string")Uu(this,o)&&(u=u.concat(this.g.get(Rr(this,o))));else{o=Array.from(this.g.values());for(let f=0;f<o.length;f++)u=u.concat(o[f])}return u},n.set=function(o,u){return Pn(this),this.i=null,o=Rr(this,o),Uu(this,o)&&(this.h-=this.g.get(o).length),this.g.set(o,[u]),this.h+=1,this},n.get=function(o,u){return o?(o=this.V(o),0<o.length?String(o[0]):u):u};function Bu(o,u,f){Fu(o,u),0<f.length&&(o.i=null,o.g.set(Rr(o,u),R(f)),o.h+=f.length)}n.toString=function(){if(this.i)return this.i;if(!this.g)return"";const o=[],u=Array.from(this.g.keys());for(var f=0;f<u.length;f++){var p=u[f];const V=encodeURIComponent(String(p)),W=this.V(p);for(p=0;p<W.length;p++){var C=V;W[p]!==""&&(C+="="+encodeURIComponent(String(W[p]))),o.push(C)}}return this.i=o.join("&")};function Rr(o,u){return u=String(u),o.j&&(u=u.toLowerCase()),u}function Wm(o,u){u&&!o.j&&(Pn(o),o.i=null,o.g.forEach(function(f,p){var C=p.toLowerCase();p!=C&&(Fu(this,p),Bu(this,C,f))},o)),o.j=u}function Hm(o,u){const f=new _s;if(l.Image){const p=new Image;p.onload=w(Cn,f,"TestLoadImage: loaded",!0,u,p),p.onerror=w(Cn,f,"TestLoadImage: error",!1,u,p),p.onabort=w(Cn,f,"TestLoadImage: abort",!1,u,p),p.ontimeout=w(Cn,f,"TestLoadImage: timeout",!1,u,p),l.setTimeout(function(){p.ontimeout&&p.ontimeout()},1e4),p.src=o}else u(!1)}function Km(o,u){const f=new _s,p=new AbortController,C=setTimeout(()=>{p.abort(),Cn(f,"TestPingServer: timeout",!1,u)},1e4);fetch(o,{signal:p.signal}).then(V=>{clearTimeout(C),V.ok?Cn(f,"TestPingServer: ok",!0,u):Cn(f,"TestPingServer: server error",!1,u)}).catch(()=>{clearTimeout(C),Cn(f,"TestPingServer: error",!1,u)})}function Cn(o,u,f,p,C){try{C&&(C.onload=null,C.onerror=null,C.onabort=null,C.ontimeout=null),p(f)}catch{}}function zm(){this.g=new Di}function Gm(o,u,f){const p=f||"";try{Ou(o,function(C,V){let W=C;h(C)&&(W=Ge(C)),u.push(p+V+"="+encodeURIComponent(W))})}catch(C){throw u.push(p+"type="+encodeURIComponent("_badmap")),C}}function Bi(o){this.l=o.Ub||null,this.j=o.eb||!1}k(Bi,Ar),Bi.prototype.g=function(){return new $i(this.l,this.j)},Bi.prototype.i=function(o){return function(){return o}}({});function $i(o,u){te.call(this),this.D=o,this.o=u,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}k($i,te),n=$i.prototype,n.open=function(o,u){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=o,this.A=u,this.readyState=1,Is(this)},n.send=function(o){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const u={headers:this.u,method:this.B,credentials:this.m,cache:void 0};o&&(u.body=o),(this.D||l).fetch(new Request(this.A,u)).then(this.Sa.bind(this),this.ga.bind(this))},n.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,ws(this)),this.readyState=0},n.Sa=function(o){if(this.g&&(this.l=o,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=o.headers,this.readyState=2,Is(this)),this.g&&(this.readyState=3,Is(this),this.g)))if(this.responseType==="arraybuffer")o.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof l.ReadableStream<"u"&&"body"in o){if(this.j=o.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;$u(this)}else o.text().then(this.Ra.bind(this),this.ga.bind(this))};function $u(o){o.j.read().then(o.Pa.bind(o)).catch(o.ga.bind(o))}n.Pa=function(o){if(this.g){if(this.o&&o.value)this.response.push(o.value);else if(!this.o){var u=o.value?o.value:new Uint8Array(0);(u=this.v.decode(u,{stream:!o.done}))&&(this.response=this.responseText+=u)}o.done?ws(this):Is(this),this.readyState==3&&$u(this)}},n.Ra=function(o){this.g&&(this.response=this.responseText=o,ws(this))},n.Qa=function(o){this.g&&(this.response=o,ws(this))},n.ga=function(){this.g&&ws(this)};function ws(o){o.readyState=4,o.l=null,o.j=null,o.v=null,Is(o)}n.setRequestHeader=function(o,u){this.u.append(o,u)},n.getResponseHeader=function(o){return this.h&&this.h.get(o.toLowerCase())||""},n.getAllResponseHeaders=function(){if(!this.h)return"";const o=[],u=this.h.entries();for(var f=u.next();!f.done;)f=f.value,o.push(f[0]+": "+f[1]),f=u.next();return o.join(`\r
`)};function Is(o){o.onreadystatechange&&o.onreadystatechange.call(o)}Object.defineProperty($i.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(o){this.m=o?"include":"same-origin"}});function ju(o){let u="";return he(o,function(f,p){u+=p,u+=":",u+=f,u+=`\r
`}),u}function La(o,u,f){e:{for(p in f){var p=!1;break e}p=!0}p||(f=ju(f),typeof o=="string"?f!=null&&encodeURIComponent(String(f)):Ve(o,u,f))}function Me(o){te.call(this),this.headers=new Map,this.o=o||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}k(Me,te);var Qm=/^https?$/i,Ym=["POST","PUT"];n=Me.prototype,n.Ha=function(o){this.J=o},n.ea=function(o,u,f,p){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+o);u=u?u.toUpperCase():"GET",this.D=o,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():ka.g(),this.v=this.o?_u(this.o):_u(ka),this.g.onreadystatechange=y(this.Ea,this);try{this.B=!0,this.g.open(u,String(o),!0),this.B=!1}catch(V){qu(this,V);return}if(o=f||"",f=new Map(this.headers),p)if(Object.getPrototypeOf(p)===Object.prototype)for(var C in p)f.set(C,p[C]);else if(typeof p.keys=="function"&&typeof p.get=="function")for(const V of p.keys())f.set(V,p.get(V));else throw Error("Unknown input type for opt_headers: "+String(p));p=Array.from(f.keys()).find(V=>V.toLowerCase()=="content-type"),C=l.FormData&&o instanceof l.FormData,!(0<=Array.prototype.indexOf.call(Ym,u,void 0))||p||C||f.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[V,W]of f)this.g.setRequestHeader(V,W);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{Ku(this),this.u=!0,this.g.send(o),this.u=!1}catch(V){qu(this,V)}};function qu(o,u){o.h=!1,o.g&&(o.j=!0,o.g.abort(),o.j=!1),o.l=u,o.m=5,Wu(o),ji(o)}function Wu(o){o.A||(o.A=!0,le(o,"complete"),le(o,"error"))}n.abort=function(o){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=o||7,le(this,"complete"),le(this,"abort"),ji(this))},n.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),ji(this,!0)),Me.aa.N.call(this)},n.Ea=function(){this.s||(this.B||this.u||this.j?Hu(this):this.bb())},n.bb=function(){Hu(this)};function Hu(o){if(o.h&&typeof a<"u"&&(!o.v[1]||sn(o)!=4||o.Z()!=2)){if(o.u&&sn(o)==4)De(o.Ea,0,o);else if(le(o,"readystatechange"),sn(o)==4){o.h=!1;try{const W=o.Z();e:switch(W){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var u=!0;break e;default:u=!1}var f;if(!(f=u)){var p;if(p=W===0){var C=String(o.D).match(Mu)[1]||null;!C&&l.self&&l.self.location&&(C=l.self.location.protocol.slice(0,-1)),p=!Qm.test(C?C.toLowerCase():"")}f=p}if(f)le(o,"complete"),le(o,"success");else{o.m=6;try{var V=2<sn(o)?o.g.statusText:""}catch{V=""}o.l=V+" ["+o.Z()+"]",Wu(o)}}finally{ji(o)}}}}function ji(o,u){if(o.g){Ku(o);const f=o.g,p=o.v[0]?()=>{}:null;o.g=null,o.v=null,u||le(o,"ready");try{f.onreadystatechange=p}catch{}}}function Ku(o){o.I&&(l.clearTimeout(o.I),o.I=null)}n.isActive=function(){return!!this.g};function sn(o){return o.g?o.g.readyState:0}n.Z=function(){try{return 2<sn(this)?this.g.status:-1}catch{return-1}},n.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},n.Oa=function(o){if(this.g){var u=this.g.responseText;return o&&u.indexOf(o)==0&&(u=u.substring(o.length)),Rt(u)}};function zu(o){try{if(!o.g)return null;if("response"in o.g)return o.g.response;switch(o.H){case"":case"text":return o.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in o.g)return o.g.mozResponseArrayBuffer}return null}catch{return null}}function Jm(o){const u={};o=(o.g&&2<=sn(o)&&o.g.getAllResponseHeaders()||"").split(`\r
`);for(let p=0;p<o.length;p++){if(B(o[p]))continue;var f=b(o[p]);const C=f[0];if(f=f[1],typeof f!="string")continue;f=f.trim();const V=u[C]||[];u[C]=V,V.push(f)}T(u,function(p){return p.join(", ")})}n.Ba=function(){return this.m},n.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function As(o,u,f){return f&&f.internalChannelParams&&f.internalChannelParams[o]||u}function Gu(o){this.Aa=0,this.i=[],this.j=new _s,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=As("failFast",!1,o),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=As("baseRetryDelayMs",5e3,o),this.cb=As("retryDelaySeedMs",1e4,o),this.Wa=As("forwardChannelMaxRetries",2,o),this.wa=As("forwardChannelRequestTimeoutMs",2e4,o),this.pa=o&&o.xmlHttpFactory||void 0,this.Xa=o&&o.Tb||void 0,this.Ca=o&&o.useFetchStreams||!1,this.L=void 0,this.J=o&&o.supportsCrossDomainXhr||!1,this.K="",this.h=new Cu(o&&o.concurrentRequestLimit),this.Da=new zm,this.P=o&&o.fastHandshake||!1,this.O=o&&o.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=o&&o.Rb||!1,o&&o.xa&&this.j.xa(),o&&o.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&o&&o.detectBufferingProxy||!1,this.ja=void 0,o&&o.longPollingTimeout&&0<o.longPollingTimeout&&(this.ja=o.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}n=Gu.prototype,n.la=8,n.G=1,n.connect=function(o,u,f,p){ft(0),this.W=o,this.H=u||{},f&&p!==void 0&&(this.H.OSID=f,this.H.OAID=p),this.F=this.X,this.I=rh(this,null,this.W),Wi(this)};function Fa(o){if(Qu(o),o.G==3){var u=o.U++,f=rn(o.I);if(Ve(f,"SID",o.K),Ve(f,"RID",u),Ve(f,"TYPE","terminate"),bs(o,f),u=new Sn(o,o.j,u),u.L=2,u.v=Ui(rn(f)),f=!1,l.navigator&&l.navigator.sendBeacon)try{f=l.navigator.sendBeacon(u.v.toString(),"")}catch{}!f&&l.Image&&(new Image().src=u.v,f=!0),f||(u.g=sh(u.j,null),u.g.ea(u.v)),u.F=Date.now(),xi(u)}nh(o)}function qi(o){o.g&&(Ba(o),o.g.cancel(),o.g=null)}function Qu(o){qi(o),o.u&&(l.clearTimeout(o.u),o.u=null),Hi(o),o.h.cancel(),o.s&&(typeof o.s=="number"&&l.clearTimeout(o.s),o.s=null)}function Wi(o){if(!ku(o.h)&&!o.s){o.s=!0;var u=o.Ga;Ae||Jn(),ye||(Ae(),ye=!0),kt.add(u,o),o.B=0}}function Xm(o,u){return Vu(o.h)>=o.h.j-(o.s?1:0)?!1:o.s?(o.i=u.D.concat(o.i),!0):o.G==1||o.G==2||o.B>=(o.Va?0:o.Wa)?!1:(o.s=ms(y(o.Ga,o,u),th(o,o.B)),o.B++,!0)}n.Ga=function(o){if(this.s)if(this.s=null,this.G==1){if(!o){this.U=Math.floor(1e5*Math.random()),o=this.U++;const C=new Sn(this,this.j,o);let V=this.o;if(this.S&&(V?(V=m(V),I(V,this.S)):V=this.S),this.m!==null||this.O||(C.H=V,V=null),this.P)e:{for(var u=0,f=0;f<this.i.length;f++){t:{var p=this.i[f];if("__data__"in p.map&&(p=p.map.__data__,typeof p=="string")){p=p.length;break t}p=void 0}if(p===void 0)break;if(u+=p,4096<u){u=f;break e}if(u===4096||f===this.i.length-1){u=f+1;break e}}u=1e3}else u=1e3;u=Ju(this,C,u),f=rn(this.I),Ve(f,"RID",o),Ve(f,"CVER",22),this.D&&Ve(f,"X-HTTP-Session-Id",this.D),bs(this,f),V&&(this.O?u="headers="+encodeURIComponent(String(ju(V)))+"&"+u:this.m&&La(f,this.m,V)),xa(this.h,C),this.Ua&&Ve(f,"TYPE","init"),this.P?(Ve(f,"$req",u),Ve(f,"SID","null"),C.T=!0,Da(C,f,null)):Da(C,f,u),this.G=2}}else this.G==3&&(o?Yu(this,o):this.i.length==0||ku(this.h)||Yu(this))};function Yu(o,u){var f;u?f=u.l:f=o.U++;const p=rn(o.I);Ve(p,"SID",o.K),Ve(p,"RID",f),Ve(p,"AID",o.T),bs(o,p),o.m&&o.o&&La(p,o.m,o.o),f=new Sn(o,o.j,f,o.B+1),o.m===null&&(f.H=o.o),u&&(o.i=u.D.concat(o.i)),u=Ju(o,f,1e3),f.I=Math.round(.5*o.wa)+Math.round(.5*o.wa*Math.random()),xa(o.h,f),Da(f,p,u)}function bs(o,u){o.H&&he(o.H,function(f,p){Ve(u,p,f)}),o.l&&Ou({},function(f,p){Ve(u,p,f)})}function Ju(o,u,f){f=Math.min(o.i.length,f);var p=o.l?y(o.l.Na,o.l,o):null;e:{var C=o.i;let V=-1;for(;;){const W=["count="+f];V==-1?0<f?(V=C[0].g,W.push("ofs="+V)):V=0:W.push("ofs="+V);let Se=!0;for(let Qe=0;Qe<f;Qe++){let ve=C[Qe].g;const rt=C[Qe].map;if(ve-=V,0>ve)V=Math.max(0,C[Qe].g-100),Se=!1;else try{Gm(rt,W,"req"+ve+"_")}catch{p&&p(rt)}}if(Se){p=W.join("&");break e}}}return o=o.i.splice(0,f),u.D=o,p}function Xu(o){if(!o.g&&!o.u){o.Y=1;var u=o.Fa;Ae||Jn(),ye||(Ae(),ye=!0),kt.add(u,o),o.v=0}}function Ua(o){return o.g||o.u||3<=o.v?!1:(o.Y++,o.u=ms(y(o.Fa,o),th(o,o.v)),o.v++,!0)}n.Fa=function(){if(this.u=null,Zu(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var o=2*this.R;this.j.info("BP detection timer enabled: "+o),this.A=ms(y(this.ab,this),o)}},n.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,ft(10),qi(this),Zu(this))};function Ba(o){o.A!=null&&(l.clearTimeout(o.A),o.A=null)}function Zu(o){o.g=new Sn(o,o.j,"rpc",o.Y),o.m===null&&(o.g.H=o.o),o.g.O=0;var u=rn(o.qa);Ve(u,"RID","rpc"),Ve(u,"SID",o.K),Ve(u,"AID",o.T),Ve(u,"CI",o.F?"0":"1"),!o.F&&o.ja&&Ve(u,"TO",o.ja),Ve(u,"TYPE","xmlhttp"),bs(o,u),o.m&&o.o&&La(u,o.m,o.o),o.L&&(o.g.I=o.L);var f=o.g;o=o.ia,f.L=1,f.v=Ui(rn(u)),f.m=null,f.P=!0,Ru(f,o)}n.Za=function(){this.C!=null&&(this.C=null,qi(this),Ua(this),ft(19))};function Hi(o){o.C!=null&&(l.clearTimeout(o.C),o.C=null)}function eh(o,u){var f=null;if(o.g==u){Hi(o),Ba(o),o.g=null;var p=2}else if(Ma(o.h,u))f=u.D,Du(o.h,u),p=1;else return;if(o.G!=0){if(u.o)if(p==1){f=u.m?u.m.length:0,u=Date.now()-u.F;var C=o.B;p=Ni(),le(p,new wu(p,f)),Wi(o)}else Xu(o);else if(C=u.s,C==3||C==0&&0<u.X||!(p==1&&Xm(o,u)||p==2&&Ua(o)))switch(f&&0<f.length&&(u=o.h,u.i=u.i.concat(f)),C){case 1:rr(o,5);break;case 4:rr(o,10);break;case 3:rr(o,6);break;default:rr(o,2)}}}function th(o,u){let f=o.Ta+Math.floor(Math.random()*o.cb);return o.isActive()||(f*=2),f*u}function rr(o,u){if(o.j.info("Error code "+u),u==2){var f=y(o.fb,o),p=o.Xa;const C=!p;p=new nr(p||"//www.google.com/images/cleardot.gif"),l.location&&l.location.protocol=="http"||Li(p,"https"),Ui(p),C?Hm(p.toString(),f):Km(p.toString(),f)}else ft(2);o.G=0,o.l&&o.l.sa(u),nh(o),Qu(o)}n.fb=function(o){o?(this.j.info("Successfully pinged google.com"),ft(2)):(this.j.info("Failed to ping google.com"),ft(1))};function nh(o){if(o.G=0,o.ka=[],o.l){const u=Nu(o.h);(u.length!=0||o.i.length!=0)&&(P(o.ka,u),P(o.ka,o.i),o.h.i.length=0,R(o.i),o.i.length=0),o.l.ra()}}function rh(o,u,f){var p=f instanceof nr?rn(f):new nr(f);if(p.g!="")u&&(p.g=u+"."+p.g),Fi(p,p.s);else{var C=l.location;p=C.protocol,u=u?u+"."+C.hostname:C.hostname,C=+C.port;var V=new nr(null);p&&Li(V,p),u&&(V.g=u),C&&Fi(V,C),f&&(V.l=f),p=V}return f=o.D,u=o.ya,f&&u&&Ve(p,f,u),Ve(p,"VER",o.la),bs(o,p),p}function sh(o,u,f){if(u&&!o.J)throw Error("Can't create secondary domain capable XhrIo object.");return u=o.Ca&&!o.pa?new Me(new Bi({eb:f})):new Me(o.pa),u.Ha(o.J),u}n.isActive=function(){return!!this.l&&this.l.isActive(this)};function ih(){}n=ih.prototype,n.ua=function(){},n.ta=function(){},n.sa=function(){},n.ra=function(){},n.isActive=function(){return!0},n.Na=function(){};function Ki(){}Ki.prototype.g=function(o,u){return new vt(o,u)};function vt(o,u){te.call(this),this.g=new Gu(u),this.l=o,this.h=u&&u.messageUrlParams||null,o=u&&u.messageHeaders||null,u&&u.clientProtocolHeaderRequired&&(o?o["X-Client-Protocol"]="webchannel":o={"X-Client-Protocol":"webchannel"}),this.g.o=o,o=u&&u.initMessageHeaders||null,u&&u.messageContentType&&(o?o["X-WebChannel-Content-Type"]=u.messageContentType:o={"X-WebChannel-Content-Type":u.messageContentType}),u&&u.va&&(o?o["X-WebChannel-Client-Profile"]=u.va:o={"X-WebChannel-Client-Profile":u.va}),this.g.S=o,(o=u&&u.Sb)&&!B(o)&&(this.g.m=o),this.v=u&&u.supportsCrossDomainXhr||!1,this.u=u&&u.sendRawJson||!1,(u=u&&u.httpSessionIdParam)&&!B(u)&&(this.g.D=u,o=this.h,o!==null&&u in o&&(o=this.h,u in o&&delete o[u])),this.j=new Sr(this)}k(vt,te),vt.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},vt.prototype.close=function(){Fa(this.g)},vt.prototype.o=function(o){var u=this.g;if(typeof o=="string"){var f={};f.__data__=o,o=f}else this.u&&(f={},f.__data__=Ge(o),o=f);u.i.push(new Mm(u.Ya++,o)),u.G==3&&Wi(u)},vt.prototype.N=function(){this.g.l=null,delete this.j,Fa(this.g),delete this.g,vt.aa.N.call(this)};function oh(o){Pa.call(this),o.__headers__&&(this.headers=o.__headers__,this.statusCode=o.__status__,delete o.__headers__,delete o.__status__);var u=o.__sm__;if(u){e:{for(const f in u){o=f;break e}o=void 0}(this.i=o)&&(o=this.i,u=u!==null&&o in u?u[o]:void 0),this.data=u}else this.data=o}k(oh,Pa);function ah(){Ca.call(this),this.status=1}k(ah,Ca);function Sr(o){this.g=o}k(Sr,ih),Sr.prototype.ua=function(){le(this.g,"a")},Sr.prototype.ta=function(o){le(this.g,new oh(o))},Sr.prototype.sa=function(o){le(this.g,new ah)},Sr.prototype.ra=function(){le(this.g,"b")},Ki.prototype.createWebChannel=Ki.prototype.g,vt.prototype.send=vt.prototype.o,vt.prototype.open=vt.prototype.m,vt.prototype.close=vt.prototype.close,Op=function(){return new Ki},Np=function(){return Ni()},Dp=er,Ml={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},Oi.NO_ERROR=0,Oi.TIMEOUT=8,Oi.HTTP_ERROR=6,ao=Oi,Iu.COMPLETE="complete",Vp=Iu,yu.EventType=ps,ps.OPEN="a",ps.CLOSE="b",ps.ERROR="c",ps.MESSAGE="d",te.prototype.listen=te.prototype.K,Ls=yu,Me.prototype.listenOnce=Me.prototype.L,Me.prototype.getLastError=Me.prototype.Ka,Me.prototype.getLastErrorCode=Me.prototype.Ba,Me.prototype.getStatus=Me.prototype.Z,Me.prototype.getResponseJson=Me.prototype.Oa,Me.prototype.getResponseText=Me.prototype.oa,Me.prototype.send=Me.prototype.ea,Me.prototype.setWithCredentials=Me.prototype.Ha,kp=Me}).apply(typeof Xi<"u"?Xi:typeof self<"u"?self:typeof window<"u"?window:{});const Zh="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class F{constructor(e){this.nextCallback=null,this.catchCallback=null,this.result=void 0,this.error=void 0,this.isDone=!1,this.callbackAttached=!1,e(t=>{this.isDone=!0,this.result=t,this.nextCallback&&this.nextCallback(t)},t=>{this.isDone=!0,this.error=t,this.catchCallback&&this.catchCallback(t)})}catch(e){return this.next(void 0,e)}next(e,t){return this.callbackAttached&&se(),this.callbackAttached=!0,this.isDone?this.error?this.wrapFailure(t,this.error):this.wrapSuccess(e,this.result):new F((r,s)=>{this.nextCallback=i=>{this.wrapSuccess(e,i).next(r,s)},this.catchCallback=i=>{this.wrapFailure(t,i).next(r,s)}})}toPromise(){return new Promise((e,t)=>{this.next(e,t)})}wrapUserFunction(e){try{const t=e();return t instanceof F?t:F.resolve(t)}catch(t){return F.reject(t)}}wrapSuccess(e,t){return e?this.wrapUserFunction(()=>e(t)):F.resolve(t)}wrapFailure(e,t){return e?this.wrapUserFunction(()=>e(t)):F.reject(t)}static resolve(e){return new F((t,r)=>{t(e)})}static reject(e){return new F((t,r)=>{r(e)})}static waitFor(e){return new F((t,r)=>{let s=0,i=0,a=!1;e.forEach(l=>{++s,l.next(()=>{++i,a&&i===s&&t()},c=>r(c))}),a=!0,i===s&&t()})}static or(e){let t=F.resolve(!1);for(const r of e)t=t.next(s=>s?F.resolve(s):r());return t}static forEach(e,t){const r=[];return e.forEach((s,i)=>{r.push(t.call(this,s,i))}),this.waitFor(r)}static mapArray(e,t){return new F((r,s)=>{const i=e.length,a=new Array(i);let l=0;for(let c=0;c<i;c++){const h=c;t(e[h]).next(d=>{a[h]=d,++l,l===i&&r(a)},d=>s(d))}})}static doWhile(e,t){return new F((r,s)=>{const i=()=>{e()===!0?t().next(()=>{i()},s):r()};i()})}}function yT(n){const e=n.match(/Android ([\d.]+)/i),t=e?e[1].split(".").slice(0,2).join("."):"-1";return Number(t)}function Ti(n){return n.name==="IndexedDbTransactionError"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ef(n){let e=0;for(const t in n)Object.prototype.hasOwnProperty.call(n,t)&&e++;return e}function Er(n,e){for(const t in n)Object.prototype.hasOwnProperty.call(n,t)&&e(t,n[t])}function Lp(n){for(const e in n)if(Object.prototype.hasOwnProperty.call(n,e))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bp{}class Be extends Bp{constructor(e,t,r){super(),this.field=e,this.op=t,this.value=r}static create(e,t,r){return e.isKeyField()?t==="in"||t==="not-in"?this.createKeyFieldInFilter(e,t,r):new RT(e,t,r):t==="array-contains"?new CT(e,r):t==="in"?new kT(e,r):t==="not-in"?new VT(e,r):t==="array-contains-any"?new DT(e,r):new Be(e,t,r)}static createKeyFieldInFilter(e,t,r){return t==="in"?new ST(e,r):new PT(e,r)}matches(e){const t=e.data.field(this.field);return this.op==="!="?t!==null&&this.matchesComparison(Xr(t,this.value)):t!==null&&yr(this.value)===yr(t)&&this.matchesComparison(Xr(t,this.value))}matchesComparison(e){switch(this.op){case"<":return e<0;case"<=":return e<=0;case"==":return e===0;case"!=":return e!==0;case">":return e>0;case">=":return e>=0;default:return se()}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class xt extends Bp{constructor(e,t){super(),this.filters=e,this.op=t,this.ae=null}static create(e,t){return new xt(e,t)}matches(e){return $p(this)?this.filters.find(t=>!t.matches(e))===void 0:this.filters.find(t=>t.matches(e))!==void 0}getFlattenedFilters(){return this.ae!==null||(this.ae=this.filters.reduce((e,t)=>e.concat(t.getFlattenedFilters()),[])),this.ae}getFilters(){return Object.assign([],this.filters)}}function $p(n){return n.op==="and"}function jp(n){return bT(n)&&$p(n)}function bT(n){for(const e of n.filters)if(e instanceof xt)return!1;return!0}function Fl(n){if(n instanceof Be)return n.field.canonicalString()+n.op.toString()+Zr(n.value);if(jp(n))return n.filters.map(e=>Fl(e)).join(",");{const e=n.filters.map(t=>Fl(t)).join(",");return`${n.op}(${e})`}}function qp(n,e){return n instanceof Be?function(r,s){return s instanceof Be&&r.op===s.op&&r.field.isEqual(s.field)&&Zt(r.value,s.value)}(n,e):n instanceof xt?function(r,s){return s instanceof xt&&r.op===s.op&&r.filters.length===s.filters.length?r.filters.reduce((i,a,l)=>i&&qp(a,s.filters[l]),!0):!1}(n,e):void se()}function Wp(n){return n instanceof Be?function(t){return`${t.field.canonicalString()} ${t.op} ${Zr(t.value)}`}(n):n instanceof xt?function(t){return t.op.toString()+" {"+t.getFilters().map(Wp).join(" ,")+"}"}(n):"Filter"}class RT extends Be{constructor(e,t,r){super(e,t,r),this.key=Z.fromName(r.referenceValue)}matches(e){const t=Z.comparator(e.key,this.key);return this.matchesComparison(t)}}class ST extends Be{constructor(e,t){super(e,"in",t),this.keys=Hp("in",t)}matches(e){return this.keys.some(t=>t.isEqual(e.key))}}class PT extends Be{constructor(e,t){super(e,"not-in",t),this.keys=Hp("not-in",t)}matches(e){return!this.keys.some(t=>t.isEqual(e.key))}}function Hp(n,e){var t;return(((t=e.arrayValue)===null||t===void 0?void 0:t.values)||[]).map(r=>Z.fromName(r.referenceValue))}class CT extends Be{constructor(e,t){super(e,"array-contains",t)}matches(e){const t=e.data.field(this.field);return bc(t)&&li(t.arrayValue,this.value)}}class kT extends Be{constructor(e,t){super(e,"in",t)}matches(e){const t=e.data.field(this.field);return t!==null&&li(this.value.arrayValue,t)}}class VT extends Be{constructor(e,t){super(e,"not-in",t)}matches(e){if(li(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const t=e.data.field(this.field);return t!==null&&!li(this.value.arrayValue,t)}}class DT extends Be{constructor(e,t){super(e,"array-contains-any",t)}matches(e){const t=e.data.field(this.field);return!(!bc(t)||!t.arrayValue.values)&&t.arrayValue.values.some(r=>li(this.value.arrayValue,r))}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const FT=new Oe(Z.comparator);function wn(){return FT}const Gp=new Oe(Z.comparator);function Fs(...n){let e=Gp;for(const t of n)e=e.insert(t.key,t);return e}function Qp(n){let e=Gp;return n.forEach((t,r)=>e=e.insert(t,r.overlayedDocument)),e}function hr(){return Ys()}function Yp(){return Ys()}function Ys(){return new as(n=>n.toString(),(n,e)=>n.isEqual(e))}const UT=new Oe(Z.comparator),BT=new Ze(Z.comparator);function pe(...n){let e=BT;for(const t of n)e=e.add(t);return e}const $T=new Ze(Ee);function jT(){return $T}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Cc(n,e){if(n.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Po(e)?"-0":e}}function Jp(n){return{integerValue:""+n}}function qT(n,e){return vT(e)?Jp(e):Cc(n,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class aa{constructor(){this._=void 0}}function WT(n,e,t){return n instanceof ui?function(s,i){const a={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return i&&ra(i)&&(i=Ac(i)),i&&(a.fields.__previous_value__=i),{mapValue:a}}(t,e):n instanceof hi?Zp(n,e):n instanceof fi?eg(n,e):function(s,i){const a=Xp(s,i),l=hf(a)+hf(s.Pe);return Ll(a)&&Ll(s.Pe)?Jp(l):Cc(s.serializer,l)}(n,e)}function HT(n,e,t){return n instanceof hi?Zp(n,e):n instanceof fi?eg(n,e):t}function Xp(n,e){return n instanceof Vo?function(r){return Ll(r)||function(i){return!!i&&"doubleValue"in i}(r)}(e)?e:{integerValue:0}:null}class ui extends aa{}class hi extends aa{constructor(e){super(),this.elements=e}}function Zp(n,e){const t=tg(e);for(const r of n.elements)t.some(s=>Zt(s,r))||t.push(r);return{arrayValue:{values:t}}}class fi extends aa{constructor(e){super(),this.elements=e}}function eg(n,e){let t=tg(e);for(const r of n.elements)t=t.filter(s=>!Zt(s,r));return{arrayValue:{values:t}}}class Vo extends aa{constructor(e,t){super(),this.serializer=e,this.Pe=t}}function hf(n){return xe(n.integerValue||n.doubleValue)}function tg(n){return bc(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rw{constructor(){this.changes=new as(e=>e.toString(),(e,t)=>e.isEqual(t)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,ct.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const r=this.changes.get(t);return r!==void 0?F.resolve(r):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cw{constructor(e){this.serializer=e,this.hr=new Map,this.Pr=new Map}getBundleMetadata(e,t){return F.resolve(this.hr.get(t))}saveBundleMetadata(e,t){return this.hr.set(t.id,function(s){return{id:s.id,version:s.version,createTime:zt(s.createTime)}}(t)),F.resolve()}getNamedQuery(e,t){return F.resolve(this.Pr.get(t))}saveNamedQuery(e,t){return this.Pr.set(t.name,function(s){return{name:s.name,query:Iw(s.bundledQuery),readTime:zt(s.readTime)}}(t)),F.resolve()}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kw{constructor(){this.overlays=new Oe(Z.comparator),this.Ir=new Map}getOverlay(e,t){return F.resolve(this.overlays.get(t))}getOverlays(e,t){const r=hr();return F.forEach(t,s=>this.getOverlay(e,s).next(i=>{i!==null&&r.set(s,i)})).next(()=>r)}saveOverlays(e,t,r){return r.forEach((s,i)=>{this.ht(e,t,i)}),F.resolve()}removeOverlaysForBatchId(e,t,r){const s=this.Ir.get(r);return s!==void 0&&(s.forEach(i=>this.overlays=this.overlays.remove(i)),this.Ir.delete(r)),F.resolve()}getOverlaysForCollection(e,t,r){const s=hr(),i=t.length+1,a=new Z(t.child("")),l=this.overlays.getIteratorFrom(a);for(;l.hasNext();){const c=l.getNext().value,h=c.getKey();if(!t.isPrefixOf(h.path))break;h.path.length===i&&c.largestBatchId>r&&s.set(c.getKey(),c)}return F.resolve(s)}getOverlaysForCollectionGroup(e,t,r,s){let i=new Oe((h,d)=>h-d);const a=this.overlays.getIterator();for(;a.hasNext();){const h=a.getNext().value;if(h.getKey().getCollectionGroup()===t&&h.largestBatchId>r){let d=i.get(h.largestBatchId);d===null&&(d=hr(),i=i.insert(h.largestBatchId,d)),d.set(h.getKey(),h)}}const l=hr(),c=i.getIterator();for(;c.hasNext()&&(c.getNext().value.forEach((h,d)=>l.set(h,d)),!(l.size()>=s)););return F.resolve(l)}ht(e,t,r){const s=this.overlays.get(r.key);if(s!==null){const a=this.Ir.get(s.largestBatchId).delete(r.key);this.Ir.set(s.largestBatchId,a)}this.overlays=this.overlays.insert(r.key,new ZT(t,r));let i=this.Ir.get(t);i===void 0&&(i=pe(),this.Ir.set(t,i)),this.Ir.set(t,i.add(r.key))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vw{constructor(){this.sessionToken=tt.EMPTY_BYTE_STRING}getSessionToken(e){return F.resolve(this.sessionToken)}setSessionToken(e,t){return this.sessionToken=t,F.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xw{constructor(e,t){this.qr={},this.overlays={},this.Qr=new Ic(0),this.Kr=!1,this.Kr=!0,this.$r=new Vw,this.referenceDelegate=e(this),this.Ur=new Mw(this),this.indexManager=new Aw,this.remoteDocumentCache=function(s){return new Nw(s)}(r=>this.referenceDelegate.Wr(r)),this.serializer=new ww(t),this.Gr=new Cw(this.serializer)}start(){return Promise.resolve()}shutdown(){return this.Kr=!1,Promise.resolve()}get started(){return this.Kr}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(e){return this.indexManager}getDocumentOverlayCache(e){let t=this.overlays[e.toKey()];return t||(t=new kw,this.overlays[e.toKey()]=t),t}getMutationQueue(e,t){let r=this.qr[e.toKey()];return r||(r=new Dw(t,this.referenceDelegate),this.qr[e.toKey()]=r),r}getGlobalsCache(){return this.$r}getTargetCache(){return this.Ur}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.Gr}runTransaction(e,t,r){J("MemoryPersistence","Starting transaction:",e);const s=new Lw(this.Qr.next());return this.referenceDelegate.zr(),r(s).next(i=>this.referenceDelegate.jr(s).next(()=>i)).toPromise().then(i=>(s.raiseOnCommittedEvent(),i))}Hr(e,t){return F.or(Object.values(this.qr).map(r=>()=>r.containsKey(e,t)))}}class Lw extends _T{constructor(e){super(),this.currentSequenceNumber=e}}class Oc{constructor(e){this.persistence=e,this.Jr=new Nc,this.Yr=null}static Zr(e){return new Oc(e)}get Xr(){if(this.Yr)return this.Yr;throw se()}addReference(e,t,r){return this.Jr.addReference(r,t),this.Xr.delete(r.toString()),F.resolve()}removeReference(e,t,r){return this.Jr.removeReference(r,t),this.Xr.add(r.toString()),F.resolve()}markPotentiallyOrphaned(e,t){return this.Xr.add(t.toString()),F.resolve()}removeTarget(e,t){this.Jr.gr(t.targetId).forEach(s=>this.Xr.add(s.toString()));const r=this.persistence.getTargetCache();return r.getMatchingKeysForTargetId(e,t.targetId).next(s=>{s.forEach(i=>this.Xr.add(i.toString()))}).next(()=>r.removeTargetData(e,t))}zr(){this.Yr=new Set}jr(e){const t=this.persistence.getRemoteDocumentCache().newChangeBuffer();return F.forEach(this.Xr,r=>{const s=Z.fromPath(r);return this.ei(e,s).next(i=>{i||t.removeEntry(s,oe.min())})}).next(()=>(this.Yr=null,t.apply(e)))}updateLimboDocument(e,t){return this.ei(e,t).next(r=>{r?this.Xr.delete(t.toString()):this.Xr.add(t.toString())})}Wr(e){return 0}ei(e,t){return F.or([()=>F.resolve(this.Jr.containsKey(t)),()=>this.persistence.getTargetCache().containsKey(e,t),()=>this.persistence.Hr(e,t)])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Fo(n){var e;const t=n.auth,r=await n.getIdToken(),s=await di(n,em(t,{idToken:r}));re(s==null?void 0:s.users.length,t,"internal-error");const i=s.users[0];n._notifyReloadListener(i);const a=!((e=i.providerUserInfo)===null||e===void 0)&&e.length?tm(i.providerUserInfo):[],l=RA(n.providerData,a),c=n.isAnonymous,h=!(n.email&&i.passwordHash)&&!(l!=null&&l.length),d=c?h:!1,g={uid:i.localId,displayName:i.displayName||null,photoURL:i.photoUrl||null,email:i.email||null,emailVerified:i.emailVerified||!1,phoneNumber:i.phoneNumber||null,tenantId:i.tenantId||null,providerData:l,metadata:new Jl(i.createdAt,i.lastLoginAt),isAnonymous:d};Object.assign(n,g)}async function bA(n){const e=Le(n);await Fo(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function RA(n,e){return[...n.filter(r=>!e.some(s=>s.providerId===r.providerId)),...e]}function tm(n){return n.map(e=>{var{providerId:t}=e,r=lu(e,["providerId"]);return{providerId:t,uid:r.rawId||"",displayName:r.displayName||null,email:r.email||null,phoneNumber:r.phoneNumber||null,photoURL:r.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nm{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(e,t){this.storage[e]=t}async _get(e){const t=this.storage[e];return t===void 0?null:t}async _remove(e){delete this.storage[e]}_addListener(e,t){}_removeListener(e,t){}}nm.type="NONE";const Gf=nm;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qf(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(om(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(rm(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(lm(e))return"Blackberry";if(cm(e))return"Webos";if(sm(e))return"Safari";if((e.includes("chrome/")||im(e))&&!e.includes("edge/"))return"Chrome";if(am(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=n.match(t);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function rm(n=ht()){return/firefox\//i.test(n)}function sm(n=ht()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function im(n=ht()){return/crios\//i.test(n)}function om(n=ht()){return/iemobile/i.test(n)}function am(n=ht()){return/android/i.test(n)}function lm(n=ht()){return/blackberry/i.test(n)}function cm(n=ht()){return/webos/i.test(n)}function fu(n=ht()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function CA(n=ht()){var e;return fu(n)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function kA(){return Bv()&&document.documentMode===10}function um(n=ht()){return fu(n)||am(n)||cm(n)||lm(n)||/windows phone/i.test(n)||om(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function hm(n,e=[]){let t;switch(n){case"Browser":t=Qf(ht());break;case"Worker":t=`${Qf(ht())}-${n}`;break;default:t=n}const r=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${is}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qA(n,e){const t=Tc(n,"auth");if(t.isInitialized()){const s=t.getImmediate(),i=t.getOptions();if(Ro(i,e??{}))return s;Lt(s,"already-initialized")}return t.initialize({options:e})}function WA(n,e){const t=(e==null?void 0:e.persistence)||[],r=(Array.isArray(t)?t:[t]).map(gn);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function HA(n,e,t){const r=cs(n);re(r._canInitEmulator,r,"emulator-config-failed"),re(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!1,i=dm(e),{host:a,port:l}=KA(e),c=l===null?"":`:${l}`;r.config.emulator={url:`${i}//${a}${c}/`},r.settings.appVerificationDisabledForTesting=!0,r.emulatorConfig=Object.freeze({host:a,port:l,protocol:i.replace(":",""),options:Object.freeze({disableWarnings:s})}),zA()}function dm(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function KA(n){const e=dm(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const r=t[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(r);if(s){const i=s[1];return{host:i,port:Zf(r.substr(i.length+1))}}else{const[i,a]=r.split(":");return{host:i,port:Zf(a)}}}function Zf(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function zA(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bm{constructor(e,t,r,s,i=!1){this.auth=e,this.resolver=r,this.user=s,this.bypassAuthState=i,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise(async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(r){this.reject(r)}})}async onAuthEvent(e){const{urlResponse:t,sessionId:r,postBody:s,tenantId:i,error:a,type:l}=e;if(a){this.reject(a);return}const c={auth:this.auth,requestUri:t,sessionId:r,tenantId:i||void 0,postBody:s||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(l)(c))}catch(h){this.reject(h)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return Rb;case"linkViaPopup":case"linkViaRedirect":return Pb;case"reauthViaPopup":case"reauthViaRedirect":return Sb;default:Lt(this.auth,"internal-error")}}resolve(e){In(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){In(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _R=5*60,yR=wp("authIdTokenMaxAge")||_R;let cd=null;const vR=n=>async e=>{const t=e&&await e.getIdTokenResult(),r=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(r&&r>yR)return;const s=t==null?void 0:t.token;cd!==s&&(cd=s,await fetch(n,{method:s?"POST":"DELETE",headers:s?{Authorization:`Bearer ${s}`}:{}}))};function ER(n=Rp()){const e=Tc(n,"auth");if(e.isInitialized())return e.getImmediate();const t=qA(n,{popupRedirectResolver:dR,persistence:[Ab,fb,Em]}),r=wp("authTokenSyncURL");if(r&&typeof isSecureContext=="boolean"&&isSecureContext){const i=new URL(r,location.origin);if(location.origin===i.origin){const a=vR(i.toString());ab(t,a,()=>a(t.currentUser)),ob(t,l=>a(l))}}const s=Ep("auth");return s&&HA(t,`http://${s}`),t}function TR(){var n,e;return(e=(n=document.getElementsByTagName("head"))===null||n===void 0?void 0:n[0])!==null&&e!==void 0?e:document}xA({loadJS(n){return new Promise((e,t)=>{const r=document.createElement("script");r.setAttribute("src",n),r.onload=e,r.onerror=s=>{const i=Gt("internal-error");i.customData=s,t(i)},r.type="text/javascript",r.charset="UTF-8",TR().appendChild(r)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});mR("Browser");const wR={apiKey:"AIzaSyBTn3Z_B1MYRJ-hOsL0I94QWBq2xh3EdFs",authDomain:"henryshus.firebaseapp.com",projectId:"henryshus",storageBucket:"henryshus.firebasestorage.app",messagingSenderId:"877597619520",appId:"1:877597619520:web:61e33ff74b9f03aa45f6a5",measurementId:"G-ESKWZ556XM"},Sm=bp(wR),Et=WI(Sm),gl=ER(Sm);function Pm(){const n=He([]),e=He([]),t=He(!1);let r=null,s=null;function i(){r||(r=jf(ks(Et,"workstations"),w=>{const k=[];w.forEach(R=>{k.push({id:R.id,...R.data()})}),k.sort((R,P)=>R.name.localeCompare(P.name,"nb")),n.value=k},w=>console.error("Workstations error:",w)))}function a(){if(s)return;const w=no(ks(Et,"borrowRecords"),ZI("returnedAt","==",null));s=jf(w,k=>{const R=[];k.forEach(P=>{R.push({id:P.id,...P.data()})}),R.sort((P,U)=>{var B,Q;return(((B=U.borrowedAt)==null?void 0:B.toMillis())??0)-(((Q=P.borrowedAt)==null?void 0:Q.toMillis())??0)}),e.value=R},k=>console.error("Active borrows error:",k))}Jo(()=>{r&&r(),s&&s()});async function l(w,k){const R=qf(Et),P=or(ks(Et,"borrowRecords")),U=or(Et,"workstations",w);R.update(U,{status:"borrowed",borrower:k,borrowedAt:fl(),currentBorrowRecord:P.id}),R.set(P,{workstation:w,borrower:k,borrowedAt:fl(),returnedAt:null}),await R.commit()}async function c(w){const k=or(Et,"workstations",w),R=await iA(k);if(!R.exists())return;const P=R.data().currentBorrowRecord,U=qf(Et);U.update(k,{status:"available",borrower:null,borrowedAt:null,currentBorrowRecord:null}),P&&U.update(or(Et,"borrowRecords",P),{returnedAt:fl()}),await U.commit()}async function h(w=20,k){let R=no(ks(Et,"borrowRecords"),eA("borrowedAt","desc"),Lf(w));k&&(R=no(R,tA(k)));const P=await Bf(R),U=[];let B=null;return P.forEach(Q=>{U.push({id:Q.id,...Q.data()}),B=Q}),{records:U,lastVisible:B}}async function d(){if(!(await Bf(no(ks(Et,"workstations"),Lf(1)))).empty)return;const k=[{name:"PC 1",keyboard:"Keyboard 1",mouse:"Mouse 1"},{name:"PC 2",keyboard:"Keyboard 2",mouse:"Mouse 2"},{name:"PC 3",keyboard:"Keyboard 3",mouse:"Mouse 3"}];for(const R of k)await $f(or(Et,"workstations",R.name),{...R,status:"available",borrower:null,borrowedAt:null,currentBorrowRecord:null})}async function g(w,k,R){await $f(or(Et,"workstations",w),{name:w,keyboard:k||"",mouse:R||"",status:"available",borrower:null,borrowedAt:null,currentBorrowRecord:null})}async function y(w){await oA(or(Et,"workstations",w))}return{workstations:n,activeBorrows:e,loading:t,subscribeWorkstations:i,subscribeActiveBorrows:a,borrowWorkstation:l,returnWorkstation:c,getHistory:h,seedDefaultWorkstations:d,addWorkstation:g,removeWorkstation:y}}const IR={class:"view active",style:{display:"flex","flex-direction":"column","min-height":"100dvh"}},AR={class:"header"},bR={class:"content"},RR={key:0,class:"empty-state"},SR={key:1,class:"workstations-grid"},PR=["tabindex","aria-label","onClick","onKeydown"],CR={class:"ws-box-name"},kR={key:0,class:"ws-box-details"},VR={key:1,class:"ws-box-borrower"},DR={class:"modal"},NR={class:"form-group"},OR={class:"modal-items"},MR={class:"modal-actions"},xR=["disabled"],LR=Qo({__name:"StudentView",setup(n){const e=It("currentView"),t=It("showToast"),r=It("loading"),{workstations:s,subscribeWorkstations:i,borrowWorkstation:a}=Pm(),l=He(!1),c=He(null),h=He(""),d=pp(()=>s.value.find(k=>k.id===c.value));function g(k){c.value=k,h.value="",l.value=!0}function y(){l.value=!1,c.value=null,h.value=""}async function w(){const k=h.value.trim();if(!(!k||!c.value)){r.value=!0;try{await a(c.value,k),l.value=!1,t(`Du låner ${c.value} — God bruk!`,"success"),c.value=null,h.value=""}catch(R){console.error(R),t("Kunne ikke fullføre lånet","error")}finally{r.value=!1}}}return pc(()=>i()),(k,R)=>(de(),Te("div",IR,[q("header",AR,[R[2]||(R[2]=q("div",null,[q("div",{class:"header-title"},"Lån utstyr"),q("div",{class:"header-subtitle"},"Trykk på en ledig enhet for å låne")],-1)),q("button",{class:"btn-admin-link",onClick:R[0]||(R[0]=P=>e.value="login")},"Admin")]),q("main",bR,[ur(s).length===0?(de(),Te("div",RR,"Laster enheter...")):(de(),Te("div",SR,[(de(!0),Te(lt,null,Ur(ur(s),P=>(de(),Te("div",{key:P.id,class:mn(["ws-box",P.status]),tabindex:P.status==="available"?0:-1,role:"button","aria-label":P.status==="available"?`Lån ${P.name}`:`${P.name} er utlånt`,onClick:U=>P.status==="available"&&g(P.id),onKeydown:Bh(U=>P.status==="available"&&g(P.id),["enter"])},[R[3]||(R[3]=q("div",{class:"ws-box-icon"},"💻",-1)),q("div",CR,We(P.name),1),P.keyboard||P.mouse?(de(),Te("div",kR,We([P.keyboard,P.mouse].filter(Boolean).join(" · ")),1)):Wt("",!0),P.status==="borrowed"&&P.borrower?(de(),Te("div",VR," Lånt av: "+We(P.borrower),1)):Wt("",!0),q("div",{class:mn(["ws-box-status",P.status])},We(P.status==="available"?"Ledig":"Utlånt"),3)],42,PR))),128))]))]),(de(),Gs(Y_,{to:"body"},[l.value&&d.value?(de(),Te("div",{key:0,class:"modal-overlay",onClick:yc(y,["self"])},[q("div",DR,[q("h3",null,"Lån "+We(d.value.name),1),q("div",NR,[R[4]||(R[4]=q("label",{for:"modal-name"},"Ditt navn",-1)),ln(q("input",{id:"modal-name","onUpdate:modelValue":R[1]||(R[1]=P=>h.value=P),class:"input",placeholder:"Skriv inn navnet ditt",autocomplete:"name",ref:"nameInput",onKeydown:Bh(w,["enter"])},null,544),[[$r,h.value]])]),q("ul",OR,[(de(!0),Te(lt,null,Ur([d.value.name,d.value.keyboard,d.value.mouse].filter(Boolean),P=>(de(),Te("li",{key:P},We(P),1))),128))]),q("div",MR,[q("button",{class:"btn btn-primary btn-full",disabled:!h.value.trim(),onClick:w}," Bekreft lån ",8,xR),q("button",{class:"btn btn-secondary btn-full",onClick:y},"Avbryt")])])])):Wt("",!0)]))]))}}),ml=He(null);let Vs=null;function Cm(){Vs||(Vs=lb(gl,r=>{ml.value=r})),Jo(()=>{Vs&&(Vs(),Vs=null)});async function n(r,s){await ib(gl,r,s)}async function e(){await cb(gl)}function t(){return ml.value!==null}return{currentUser:ml,login:n,logout:e,isAdmin:t}}const FR={class:"view active"},UR={class:"header"},BR={class:"header-top"},$R={class:"content"},jR={class:"card login-card"},qR={class:"form-group"},WR={class:"form-group"},HR={key:0,class:"error-message"},KR=Qo({__name:"LoginView",setup(n){const e=It("currentView");It("showToast");const t=It("loading"),{login:r}=Cm(),s=He(""),i=He(""),a=He("");async function l(){a.value="",t.value=!0;try{await r(s.value,i.value),e.value="admin"}catch(c){const h=c.code;h==="auth/user-not-found"?a.value="Bruker ikke funnet":h==="auth/wrong-password"?a.value="Feil passord":h==="auth/invalid-email"?a.value="Ugyldig e-post":h==="auth/too-many-requests"?a.value="For mange forsøk. Prøv igjen senere.":a.value="Feil e-post eller passord"}finally{t.value=!1}}return(c,h)=>(de(),Te("div",FR,[q("header",UR,[q("div",BR,[q("button",{class:"btn-text back-btn",onClick:h[0]||(h[0]=d=>e.value="student")}," ← Tilbake "),h[3]||(h[3]=q("h1",{class:"header-title"},"Admin",-1))])]),q("main",$R,[q("section",jR,[q("form",{onSubmit:yc(l,["prevent"])},[q("div",qR,[h[4]||(h[4]=q("label",{for:"login-email"},"E-post",-1)),ln(q("input",{id:"login-email","onUpdate:modelValue":h[1]||(h[1]=d=>s.value=d),class:"input",type:"email",placeholder:"admin@example.com",autocomplete:"email",required:""},null,512),[[$r,s.value]])]),q("div",WR,[h[5]||(h[5]=q("label",{for:"login-password"},"Passord",-1)),ln(q("input",{id:"login-password","onUpdate:modelValue":h[2]||(h[2]=d=>i.value=d),class:"input",type:"password",placeholder:"Passord",autocomplete:"current-password",required:""},null,512),[[$r,i.value]])]),h[6]||(h[6]=q("button",{type:"submit",class:"btn btn-primary btn-full"},"Logg inn",-1)),a.value?(de(),Te("p",HR,We(a.value),1)):Wt("",!0)],32)])])]))}}),zR={class:"view active"},GR={class:"content"},QR={class:"admin-tabs"},YR={key:0,class:"empty-state"},JR={key:1,class:"borrows-list"},XR={class:"borrow-card-info"},ZR={class:"borrow-card-time"},e0=["onClick"],t0={key:0,class:"empty-state"},n0={key:1,class:"borrows-list"},r0={class:"borrow-card-info"},s0={class:"borrow-card-time"},i0={key:0},o0={class:"workstations-manage-list"},a0={class:"ws-name"},l0={class:"ws-status"},c0=["onClick"],u0={key:0,class:"empty-state"},h0={class:"form-group"},f0={class:"form-group"},d0={class:"form-group"},p0=Qo({__name:"AdminView",setup(n){const e=It("currentView"),t=It("showToast"),r=It("loading"),{logout:s}=Cm(),{workstations:i,activeBorrows:a,subscribeWorkstations:l,subscribeActiveBorrows:c,returnWorkstation:h,getHistory:d,seedDefaultWorkstations:g,addWorkstation:y,removeWorkstation:w}=Pm(),k=He("borrows"),R=He([]),P=He(null),U=He(""),B=He(""),Q=He("");async function z(){await s(),e.value="student"}async function fe(_){if(confirm(`Returner ${_}?`)){r.value=!0;try{await h(_),t(`${_} er returnert`,"success")}catch(Y){console.error(Y),t("Kunne ikke returnere","error")}finally{r.value=!1}}}async function he(_=!1){r.value=!0;try{const Y=await d(20,_?P.value:null);P.value=Y.lastVisible,_?R.value.push(...Y.records):R.value=Y.records}catch(Y){console.error(Y),t("Kunne ikke laste historikk","error")}finally{r.value=!1}}async function T(){if(confirm("Sett inn standardenheter (PC 1, PC 2, PC 3)?")){r.value=!0;try{await g(),t("Standardenheter er lagt til","success")}catch(_){console.error(_),t("Kunne ikke sette inn enheter","error")}finally{r.value=!1}}}async function m(){if(U.value.trim()){r.value=!0;try{await y(U.value.trim(),B.value.trim(),Q.value.trim()),t(`${U.value} er lagt til`,"success"),U.value="",B.value="",Q.value=""}catch(_){console.error(_),t("Kunne ikke legge til enheten","error")}finally{r.value=!1}}}async function v(_){if(confirm(`Fjern ${_}?`)){r.value=!0;try{await w(_),t(`${_} er fjernet`,"success")}catch(Y){console.error(Y),t("Kunne ikke fjerne enheten","error")}finally{r.value=!1}}}function I(_){k.value=_,_==="history"&&(R.value=[],P.value=null,he())}function b(_){if(!_)return"—";const Y=_.toDate?_.toDate():new Date(_);return`${String(Y.getDate()).padStart(2,"0")}.${String(Y.getMonth()+1).padStart(2,"0")} ${String(Y.getHours()).padStart(2,"0")}:${String(Y.getMinutes()).padStart(2,"0")}`}function S(_){if(!_)return"—";const Y=_.toDate?_.toDate():new Date(_);return`${String(Y.getDate()).padStart(2,"0")}.${String(Y.getMonth()+1).padStart(2,"0")}.${Y.getFullYear()} ${String(Y.getHours()).padStart(2,"0")}:${String(Y.getMinutes()).padStart(2,"0")}`}return pc(()=>{l(),c()}),(_,Y)=>(de(),Te("div",zR,[q("header",{class:"header"},[q("div",{class:"header-row"},[Y[7]||(Y[7]=q("h1",{class:"header-title"},"Admin",-1)),q("button",{class:"btn-text",onClick:z},"Logg ut")])]),q("main",GR,[q("ul",QR,[q("li",null,[q("button",{class:mn(["tab-btn",{active:k.value==="borrows"}]),onClick:Y[0]||(Y[0]=ue=>I("borrows"))},"Utlån",2)]),q("li",null,[q("button",{class:mn(["tab-btn",{active:k.value==="history"}]),onClick:Y[1]||(Y[1]=ue=>I("history"))},"Historikk",2)]),q("li",null,[q("button",{class:mn(["tab-btn",{active:k.value==="manage"}]),onClick:Y[2]||(Y[2]=ue=>I("manage"))},"Enheter",2)])]),ln(q("section",null,[Y[8]||(Y[8]=q("h2",{class:"section-title"},"Utlånt utstyr",-1)),ur(a).length===0?(de(),Te("div",YR,"Ingen utlånt utstyr")):(de(),Te("div",JR,[(de(!0),Te(lt,null,Ur(ur(a),ue=>(de(),Te("div",{key:ue.id,class:"borrow-card"},[q("div",XR,[q("h4",null,We(ue.workstation),1),q("p",null,"Lånt av: "+We(ue.borrower),1),q("div",ZR,We(b(ue.borrowedAt)),1)]),q("button",{class:"btn btn-danger btn-sm",onClick:$e=>fe(ue.workstation)},"Returner",8,e0)]))),128))]))],512),[[Xa,k.value==="borrows"]]),ln(q("section",null,[Y[9]||(Y[9]=q("h2",{class:"section-title"},"Historikk",-1)),R.value.length===0?(de(),Te("div",t0,"Ingen historikk")):(de(),Te("div",n0,[(de(!0),Te(lt,null,Ur(R.value,ue=>(de(),Te("div",{key:ue.id,class:"borrow-card"},[q("div",r0,[q("h4",null,We(ue.workstation),1),q("p",null,"Lånt av: "+We(ue.borrower),1),q("div",s0,[hp(" Lånt: "+We(S(ue.borrowedAt))+" ",1),ue.returnedAt?(de(),Te("span",i0," | Returnert: "+We(S(ue.returnedAt)),1)):Wt("",!0)])]),q("span",{style:Ko([{"font-size":"0.8125rem","font-weight":"600"},{color:ue.returnedAt?"var(--green)":"var(--red)"}])},We(ue.returnedAt?"Returnert":"Aktiv"),5)]))),128)),R.value.length>=20?(de(),Te("button",{key:0,class:"btn btn-secondary btn-full",onClick:Y[3]||(Y[3]=ue=>he(!0))},"Last flere")):Wt("",!0)]))],512),[[Xa,k.value==="history"]]),ln(q("section",null,[Y[15]||(Y[15]=q("h2",{class:"section-title"},"Administrer enheter",-1)),q("div",o0,[(de(!0),Te(lt,null,Ur(ur(i),ue=>(de(),Te("div",{key:ue.id,class:"workstation-manage-item"},[q("div",null,[q("div",a0,We(ue.name),1),q("div",l0,We(ue.status==="available"?"Ledig":"Utlånt"),1)]),ue.status==="available"?(de(),Te("button",{key:0,class:"btn-text",onClick:$e=>v(ue.name)},"Fjern",8,c0)):Wt("",!0)]))),128)),ur(i).length===0?(de(),Te("div",u0,"Ingen enheter")):Wt("",!0)]),q("button",{class:"btn btn-secondary btn-full",style:{"margin-bottom":"16px"},onClick:T}," Sett inn standardenheter (PC 1-3) "),q("form",{class:"add-workstation-form card",onSubmit:yc(m,["prevent"])},[Y[13]||(Y[13]=q("h3",null,"Legg til ny enhet",-1)),q("div",h0,[Y[10]||(Y[10]=q("label",{for:"new-name"},"Navn",-1)),ln(q("input",{id:"new-name","onUpdate:modelValue":Y[4]||(Y[4]=ue=>U.value=ue),class:"input",placeholder:"F.eks. PC 4",required:""},null,512),[[$r,U.value]])]),q("div",f0,[Y[11]||(Y[11]=q("label",{for:"new-keyboard"},"Tastatur",-1)),ln(q("input",{id:"new-keyboard","onUpdate:modelValue":Y[5]||(Y[5]=ue=>B.value=ue),class:"input",placeholder:"F.eks. Tastatur 4"},null,512),[[$r,B.value]])]),q("div",d0,[Y[12]||(Y[12]=q("label",{for:"new-mouse"},"Mus",-1)),ln(q("input",{id:"new-mouse","onUpdate:modelValue":Y[6]||(Y[6]=ue=>Q.value=ue),class:"input",placeholder:"F.eks. Mus 4"},null,512),[[$r,Q.value]])]),Y[14]||(Y[14]=q("button",{type:"submit",class:"btn btn-primary"},"Legg til",-1))],32)],512),[[Xa,k.value==="manage"]])])]))}}),g0={id:"toast-container"},m0={key:0,id:"loading-overlay"},_0=Qo({__name:"App",setup(n){const e=He("student"),t=He([]);let r=0;function s(a,l="info"){const c=++r;t.value.push({id:c,message:a,type:l}),setTimeout(()=>{const h=t.value.findIndex(d=>d.id===c);h!==-1&&t.value.splice(h,1)},3e3)}io("showToast",s),io("currentView",e);const i=He(!1);return io("loading",i),(a,l)=>(de(),Te(lt,null,[q("div",g0,[(de(!0),Te(lt,null,Ur(t.value,c=>(de(),Te("div",{key:c.id,class:mn(["toast",c.type])},We(c.message),3))),128))]),i.value?(de(),Te("div",m0,[...l[0]||(l[0]=[q("div",{class:"spinner"},null,-1),q("p",null,"Laster...",-1)])])):Wt("",!0),e.value==="student"?(de(),Gs(LR,{key:1})):e.value==="login"?(de(),Gs(KR,{key:2})):e.value==="admin"?(de(),Gs(p0,{key:3})):Wt("",!0)],64))}});wv(_0).mount("#app");
